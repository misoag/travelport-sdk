...
/**
 * This class stands for typeProfileLevel EnumType
 * Meta information extracted from the WSDL
 * - documentation: The type of the profile or profile template.
 * @subpackage Enumerations
 */
class TypeProfileLevel extends AbstractStructEnumBase
{
    /**
