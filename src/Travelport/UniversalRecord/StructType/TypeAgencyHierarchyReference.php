...
class TypeAgencyHierarchyReference extends AbstractStructBase
{
     ...
     * Set ProfileID value
     * @param int $profileID
     * @return \Travelport\UniversalRecord\StructType\TypeAgencyHierarchyReference
     */
     ...
     * @uses \Travelport\UniversalRecord\EnumType\TypeAgencyProfileLevel::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeAgencyProfileLevel::getValidValues()
    ...
    public function setProfileType(string $profileType): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeAgencyProfileLevel::valueIsValid($profileType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeAgencyProfileLevel', is_array($profileType) ? implode(', ', $profileType) : var_export($profileType, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeAgencyProfileLevel::getValidValues())), __LINE__);
        }
