...
class MCOPriceData extends AbstractStructBase
{
     ...
     */
    public function __construct(string $mCOAmount, ?array $taxInfo = null, ?\Travelport\UniversalRecord\StructType\Commission $commission = null, ?string $mCOEquivalentFare = null, ?string $mCOTotalAmount = null)
    {
        $this
     ...
     * Set MCOAmount value
     * @param string $mCOAmount
     * @return \Travelport\UniversalRecord\StructType\MCOPriceData
     */
    ...
    public static function validateTaxInfoForArrayConstraintsFromSetTaxInfo(?array $values = []): string
    {
        ...
        foreach ($values as $mCOPriceDataTaxInfoItem) {
            ...
            if (!$mCOPriceDataTaxInfoItem instanceof \Travelport\UniversalRecord\StructType\TypeTaxInfo) {
