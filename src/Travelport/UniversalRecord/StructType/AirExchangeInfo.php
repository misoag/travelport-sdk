...
class AirExchangeInfo extends AbstractStructBase
{
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\TotalPenaltyTaxInfo $TotalPenaltyTaxInfo = null;
    /**
     * The PaidTax
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
    ...
    public static function validatePaidTaxForArrayConstraintFromSetPaidTax(?array $values = []): string
    {
        ...
        foreach ($values as $airExchangeInfoPaidTaxItem) {
            ...
            if (!$airExchangeInfoPaidTaxItem instanceof \Travelport\UniversalRecord\StructType\TypeTax) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PaidTax property can only contain items of type \Travelport\UniversalRecord\StructType\TypeTax, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    public function addToPaidTax(\Travelport\UniversalRecord\StructType\TypeTax $item): self
    {
        ...
        if (!$item instanceof \Travelport\UniversalRecord\StructType\TypeTax) {
            throw new InvalidArgumentException(sprintf('The PaidTax property can only contain items of type \Travelport\UniversalRecord\StructType\TypeTax, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateTicketFeeInfoForArrayConstraintFromSetTicketFeeInfo(?array $values = []): string
    {
        ...
        foreach ($values as $airExchangeInfoTicketFeeInfoItem) {
            // validation for constraint: itemType
            if (!$airExchangeInfoTicketFeeInfoItem instanceof \Travelport\UniversalRecord\StructType\TicketFeeInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TicketFeeInfo property can only contain items of type \Travelport\UniversalRecord\StructType\TicketFeeInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\TicketFeeInfo) {
            throw new InvalidArgumentException(sprintf('The TicketFeeInfo property can only contain items of type \Travelport\UniversalRecord\StructType\TicketFeeInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateFeeInfoForArrayConstraintFromSetFeeInfo(?array $values = []): string
    {
        ...
        foreach ($values as $airExchangeInfoFeeInfoItem) {
            // validation for constraint: itemType
            if (!$airExchangeInfoFeeInfoItem instanceof \Travelport\UniversalRecord\StructType\TypeFeeInfo) {
    ...
    public static function validateTaxInfoForArrayConstraintFromSetTaxInfo(?array $values = []): string
    {
        ...
        foreach ($values as $airExchangeInfoTaxInfoItem) {
            // validation for constraint: itemType
            if (!$airExchangeInfoTaxInfoItem instanceof \Travelport\UniversalRecord\StructType\TypeTaxInfo) {
    ...
    /**
     * Set FarePull value
     * @uses \Travelport\UniversalRecord\EnumType\TypeFarePull::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeFarePull::getValidValues()
     * @throws InvalidArgumentException
     * @param string $farePull
     * @return \Travelport\UniversalRecord\StructType\AirExchangeInfo
     */
    public function setFarePull(?string $farePull = null): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeFarePull::valueIsValid($farePull)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeFarePull', is_array($farePull) ? implode(', ', $farePull) : var_export($farePull, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeFarePull::getValidValues())), __LINE__);
        }
     ...
     * @uses \Travelport\UniversalRecord\EnumType\TypeFormOfRefund::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeFormOfRefund::getValidValues()
     * @throws InvalidArgumentException
     * @param string $formOfRefund
     * @return \Travelport\UniversalRecord\StructType\AirExchangeInfo
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Travelport\UniversalRecord\EnumType\TypeFormOfRefund::valueIsValid($formOfRefund)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeFormOfRefund', is_array($formOfRefund) ? implode(', ', $formOfRefund) : var_export($formOfRefund, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeFormOfRefund::getValidValues())), __LINE__);
        }
