...
class UniversalRecordCancelRsp extends BaseRsp
{
    ...
    /**
     * This method is responsible for validating the values passed to the setProviderReservationStatus method
     ...
     */
    public static function validateProviderReservationStatusForArrayConstraintsFromSetProviderReservationStatus(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
    ...
    public function setProviderReservationStatus(?array $providerReservationStatus = null): self
    {
        ...
        if ('' !== ($providerReservationStatusArrayErrorMessage = self::validateProviderReservationStatusForArrayConstraintsFromSetProviderReservationStatus($providerReservationStatus))) {
