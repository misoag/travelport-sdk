...
class PassiveInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(?array $ticketNumber = null, ?array $confirmationNumber = null, ?\Travelport\UniversalRecord\StructType\Commission $commission = null, ?string $providerCode = null, ?string $providerLocatorCode = null, ?string $supplierCode = null, ?string $supplierLocatorCode = null)
    {
        $this
     ...
     * @param string[] $ticketNumber
     * @return \Travelport\UniversalRecord\StructType\PassiveInfo
     */
