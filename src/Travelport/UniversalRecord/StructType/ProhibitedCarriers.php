...
class ProhibitedCarriers extends AbstractStructBase
{
    ...
    public static function validateCarrierForArrayConstraintFromSetCarrier(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $prohibitedCarriersCarrierItem) {
            // validation for constraint: itemType
            if (!$prohibitedCarriersCarrierItem instanceof \Travelport\UniversalRecord\StructType\Carrier) {
                $invalidValues[] = is_object($prohibitedCarriersCarrierItem) ? get_class($prohibitedCarriersCarrierItem) : sprintf('%s(%s)', gettype($prohibitedCarriersCarrierItem), var_export($prohibitedCarriersCarrierItem, true));
            }
        }
     ...
     * @param \Travelport\UniversalRecord\StructType\Carrier[] $carrier
     * @return \Travelport\UniversalRecord\StructType\ProhibitedCarriers
     */
