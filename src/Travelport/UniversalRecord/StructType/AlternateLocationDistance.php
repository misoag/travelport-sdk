...
class AlternateLocationDistance extends AbstractStructBase
{
     ...
     */
    public function __construct(\Travelport\UniversalRecord\StructType\Distance $distance, string $key, string $searchLocation, string $alternateLocation)
    {
        $this
    ...
    /**
     * Get Distance value
     * @return \Travelport\UniversalRecord\StructType\Distance
     */
     ...
     */
    public function setDistance(\Travelport\UniversalRecord\StructType\Distance $distance): self
    {
