...
class PreferredCarriers extends AbstractStructBase
{
    ...
    public static function validateCarrierForArrayConstraintsFromSetCarrier(?array $values = []): string
    {
        ...
        foreach ($values as $preferredCarriersCarrierItem) {
            ...
            if (!$preferredCarriersCarrierItem instanceof \Travelport\UniversalRecord\StructType\Carrier) {
     ...
     * @param \Travelport\UniversalRecord\StructType\Carrier[] $carrier
     * @return \Travelport\UniversalRecord\StructType\PreferredCarriers
     */
