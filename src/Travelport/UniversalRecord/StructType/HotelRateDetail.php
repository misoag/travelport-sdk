...
class HotelRateDetail extends AbstractStructBase
{
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\TaxDetails $TaxDetails = null;
    /**
     * The CancelInfo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\GuaranteeInfo $GuaranteeInfo = null;
    /**
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\RoomCapacity $RoomCapacity = null;
    /**
     * The ExtraCharges
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\ExtraCharges $ExtraCharges = null;
    /**
     * The Inclusions
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\Inclusions $Inclusions = null;
    /**
     * The ApproximateBase
     * Meta information extracted from the WSDL
    ...
    public static function validateRoomRateDescriptionForArrayConstraintFromSetRoomRateDescription(?array $values = []): string
    {
        ...
        foreach ($values as $hotelRateDetailRoomRateDescriptionItem) {
            ...
            if (!$hotelRateDetailRoomRateDescriptionItem instanceof \Travelport\UniversalRecord\StructType\TypeHotelRateDescription) {
    ...
    public static function validateHotelRateByDateForArrayConstraintFromSetHotelRateByDate(?array $values = []): string
    {
        ...
        foreach ($values as $hotelRateDetailHotelRateByDateItem) {
            // validation for constraint: itemType
            if (!$hotelRateDetailHotelRateByDateItem instanceof \Travelport\UniversalRecord\StructType\HotelRateByDate) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The HotelRateByDate property can only contain items of type \Travelport\UniversalRecord\StructType\HotelRateByDate, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\HotelRateByDate) {
            throw new InvalidArgumentException(sprintf('The HotelRateByDate property can only contain items of type \Travelport\UniversalRecord\StructType\HotelRateByDate, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateCorporateDiscountIDForArrayConstraintFromSetCorporateDiscountID(?array $values = []): string
    {
        ...
        foreach ($values as $hotelRateDetailCorporateDiscountIDItem) {
            // validation for constraint: itemType
            if (!$hotelRateDetailCorporateDiscountIDItem instanceof \Travelport\UniversalRecord\StructType\CorporateDiscountID) {
    ...
    public static function validateAcceptedPaymentForArrayConstraintFromSetAcceptedPayment(?array $values = []): string
    {
        ...
        foreach ($values as $hotelRateDetailAcceptedPaymentItem) {
            // validation for constraint: itemType
            if (!$hotelRateDetailAcceptedPaymentItem instanceof \Travelport\UniversalRecord\StructType\AcceptedPayment) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AcceptedPayment property can only contain items of type \Travelport\UniversalRecord\StructType\AcceptedPayment, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\AcceptedPayment) {
            throw new InvalidArgumentException(sprintf('The AcceptedPayment property can only contain items of type \Travelport\UniversalRecord\StructType\AcceptedPayment, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(99)
    ...
    public static function validateRateMatchIndicatorForArrayConstraintFromSetRateMatchIndicator(?array $values = []): string
    {
        ...
        foreach ($values as $hotelRateDetailRateMatchIndicatorItem) {
            // validation for constraint: itemType
            if (!$hotelRateDetailRateMatchIndicatorItem instanceof \Travelport\UniversalRecord\StructType\RateMatchIndicator) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The RateMatchIndicator property can only contain items of type \Travelport\UniversalRecord\StructType\RateMatchIndicator, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
    ...
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\RateMatchIndicator) {
            throw new InvalidArgumentException(sprintf('The RateMatchIndicator property can only contain items of type \Travelport\UniversalRecord\StructType\RateMatchIndicator, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public function setRateChangeIndicator(?string $rateChangeIndicator = null): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeTrinary::valueIsValid($rateChangeIndicator)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeTrinary', is_array($rateChangeIndicator) ? implode(', ', $rateChangeIndicator) : var_export($rateChangeIndicator, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeTrinary::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Travelport\UniversalRecord\EnumType\TypeTrinary::valueIsValid($extraFeesIncluded)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeTrinary', is_array($extraFeesIncluded) ? implode(', ', $extraFeesIncluded) : var_export($extraFeesIncluded, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeTrinary::getValidValues())), __LINE__);
        }
