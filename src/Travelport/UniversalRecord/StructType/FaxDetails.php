...
class FaxDetails extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TermConditions
     * @var \Travelport\UniversalRecord\StructType\TermConditions|null
     */
    protected ?\Travelport\UniversalRecord\StructType\TermConditions $TermConditions = null;
    /**
     * The Remark
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     ...
     * @param \Travelport\UniversalRecord\StructType\TermConditions $termConditions
     ...
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\PhoneNumber $phoneNumber = null, ?\Travelport\UniversalRecord\StructType\TermConditions $termConditions = null, ?array $remark = null, ?bool $includeCoverSheet = null, ?string $to = null, ?string $from = null, ?string $deptBillingCode = null, ?string $invoiceNumber = null)
    {
        $this
     ...
     * @param \Travelport\UniversalRecord\StructType\PhoneNumber $phoneNumber
     * @return \Travelport\UniversalRecord\StructType\FaxDetails
     */
     ...
     * @return \Travelport\UniversalRecord\StructType\TermConditions|null
     */
    public function getTermConditions(): ?\Travelport\UniversalRecord\StructType\TermConditions
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\FaxDetails
     */
    public function setTermConditions(?\Travelport\UniversalRecord\StructType\TermConditions $termConditions = null): self
    {
    ...
    public static function validateRemarkForArrayConstraintsFromSetRemark(?array $values = []): string
    {
        ...
        foreach ($values as $faxDetailsRemarkItem) {
            ...
            if (!$faxDetailsRemarkItem instanceof \Travelport\UniversalRecord\StructType\Remark) {
