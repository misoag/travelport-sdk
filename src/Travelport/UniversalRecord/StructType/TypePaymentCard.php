...
class TypePaymentCard extends AbstractStructBase
{
     ...
     */
    protected ?\Travelport\UniversalRecord\StructType\TypeStructuredAddress $BillingAddress = null;
    /**
     * The Type
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\UniversalRecord\StructType\TypeStructuredAddress $billingAddress
     * @param string $type
     * @param string $number
     ...
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\PhoneNumber $phoneNumber = null, ?\Travelport\UniversalRecord\StructType\TypeStructuredAddress $billingAddress = null, ?string $type = null, ?string $number = null, ?string $expDate = null, ?string $name = null, ?string $cVV = null, ?string $approvalCode = null)
    {
        $this
     ...
     * @param \Travelport\UniversalRecord\StructType\PhoneNumber $phoneNumber
     * @return \Travelport\UniversalRecord\StructType\TypePaymentCard
     */
     ...
     */
    public function getBillingAddress(): ?\Travelport\UniversalRecord\StructType\TypeStructuredAddress
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\TypePaymentCard
     */
    public function setBillingAddress(?\Travelport\UniversalRecord\StructType\TypeStructuredAddress $billingAddress = null): self
    {
