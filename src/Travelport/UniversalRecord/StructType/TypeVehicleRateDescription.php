...
/**
 * This class stands for typeVehicleRateDescription StructType
 * @subpackage Structs
 */
class TypeVehicleRateDescription extends AbstractStructBase
{
    /**
     * The Text
    ...
    /**
     * Constructor method for typeVehicleRateDescription
     * @uses TypeVehicleRateDescription::setText()
     * @uses TypeVehicleRateDescription::setName()
     * @param string[] $text
     * @param string $name
     */
    ...
    public static function validateTextForArrayConstraintsFromSetText(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $typeVehicleRateDescriptionTextItem) {
            // validation for constraint: itemType
            if (!is_string($typeVehicleRateDescriptionTextItem)) {
                $invalidValues[] = is_object($typeVehicleRateDescriptionTextItem) ? get_class($typeVehicleRateDescriptionTextItem) : sprintf('%s(%s)', gettype($typeVehicleRateDescriptionTextItem), var_export($typeVehicleRateDescriptionTextItem, true));
            }
        }
