...
class RuleAdvancedPurchase extends AbstractStructBase
{
     ...
     * @param string $reservationLatestPeriod
     * @return \Travelport\UniversalRecord\StructType\RuleAdvancedPurchase
     */
    ...
    public function setReservationLatestUnit(?string $reservationLatestUnit = null): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeStayUnit::valueIsValid($reservationLatestUnit)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeStayUnit', is_array($reservationLatestUnit) ? implode(', ', $reservationLatestUnit) : var_export($reservationLatestUnit, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeStayUnit::getValidValues())), __LINE__);
        }
