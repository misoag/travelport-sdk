...
class APIProvider extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TransactionType
     * @var \Travelport\UniversalRecord\StructType\TransactionType|null
     */
    protected ?\Travelport\UniversalRecord\StructType\TransactionType $TransactionType = null;
    /**
     * The AvailablePseudoCityCode
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode[]
     */
     ...
     * @param \Travelport\UniversalRecord\StructType\TransactionType $transactionType
     * @param \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode[] $availablePseudoCityCode
     * @param string $supplierCode
     * @param string $iATACode
     */
    public function __construct(string $providerCode, ?\Travelport\UniversalRecord\StructType\TransactionType $transactionType = null, ?array $availablePseudoCityCode = null, ?string $supplierCode = null, ?string $iATACode = null)
    {
        $this
     ...
     * @param string $providerCode
     * @return \Travelport\UniversalRecord\StructType\APIProvider
     */
     ...
     * @return \Travelport\UniversalRecord\StructType\TransactionType|null
     */
    public function getTransactionType(): ?\Travelport\UniversalRecord\StructType\TransactionType
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\APIProvider
     */
    public function setTransactionType(?\Travelport\UniversalRecord\StructType\TransactionType $transactionType = null): self
    {
    ...
    public static function validateAvailablePseudoCityCodeForArrayConstraintFromSetAvailablePseudoCityCode(?array $values = []): string
    {
        ...
        foreach ($values as $aPIProviderAvailablePseudoCityCodeItem) {
            ...
            if (!$aPIProviderAvailablePseudoCityCodeItem instanceof \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AvailablePseudoCityCode property can only contain items of type \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode $item
     * @return \Travelport\UniversalRecord\StructType\APIProvider
     */
    public function addToAvailablePseudoCityCode(\Travelport\UniversalRecord\StructType\AvailablePseudoCityCode $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode) {
            throw new InvalidArgumentException(sprintf('The AvailablePseudoCityCode property can only contain items of type \Travelport\UniversalRecord\StructType\AvailablePseudoCityCode, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
