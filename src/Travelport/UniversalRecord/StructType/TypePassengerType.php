...
class TypePassengerType extends AbstractStructBase
{
     ...
     * @var \Travelport\UniversalRecord\StructType\PersonalGeography|null
     */
    protected ?\Travelport\UniversalRecord\StructType\PersonalGeography $PersonalGeography = null;
    /**
     * The Age
     * Meta information extracted from the WSDL
     * - use: optional
     ...
     * @param \Travelport\UniversalRecord\StructType\PersonalGeography $personalGeography
     * @param int $age
     * @param string $dOB
     * @param string $gender
     ...
     */
    public function __construct(string $code, ?\Travelport\UniversalRecord\StructType\Name $name = null, ?array $loyaltyCard = null, ?array $discountCard = null, ?\Travelport\UniversalRecord\StructType\PersonalGeography $personalGeography = null, ?int $age = null, ?string $dOB = null, ?string $gender = null, ?bool $pricePTCOnly = null, ?string $bookingTravelerRef = null, ?bool $accompaniedPassenger = false, ?string $residencyType = null)
    {
        $this
            ->setCode($code)
            ->setName($name)
    ...
    public static function validateLoyaltyCardForArrayConstraintsFromSetLoyaltyCard(?array $values = []): string
    {
        ...
        foreach ($values as $typePassengerTypeLoyaltyCardItem) {
            ...
            if (!$typePassengerTypeLoyaltyCardItem instanceof \Travelport\UniversalRecord\StructType\LoyaltyCard) {
    ...
    public static function validateDiscountCardForArrayConstraintsFromSetDiscountCard(?array $values = []): string
    {
        ...
        foreach ($values as $typePassengerTypeDiscountCardItem) {
            // validation for constraint: itemType
            if (!$typePassengerTypeDiscountCardItem instanceof \Travelport\UniversalRecord\StructType\DiscountCard) {
     ...
     * @return \Travelport\UniversalRecord\StructType\PersonalGeography|null
     */
    public function getPersonalGeography(): ?\Travelport\UniversalRecord\StructType\PersonalGeography
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\TypePassengerType
     */
    public function setPersonalGeography(?\Travelport\UniversalRecord\StructType\PersonalGeography $personalGeography = null): self
    {
     ...
     * @uses \Travelport\UniversalRecord\EnumType\TypeResidency::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeResidency::getValidValues()
     * @throws InvalidArgumentException
     * @param string $residencyType
     * @return \Travelport\UniversalRecord\StructType\TypePassengerType
     */
    public function setResidencyType(?string $residencyType = null): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeResidency::valueIsValid($residencyType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeResidency', is_array($residencyType) ? implode(', ', $residencyType) : var_export($residencyType, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeResidency::getValidValues())), __LINE__);
        }
