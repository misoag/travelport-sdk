...
class HotelLocation extends AbstractStructBase
{
     ...
     * Set Location value
     * @param string $location
     * @return \Travelport\UniversalRecord\StructType\HotelLocation
     */
     ...
     * @uses \Travelport\UniversalRecord\EnumType\TypeHotelLocation::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeHotelLocation::getValidValues()
    ...
    public function setLocationType(?string $locationType = null): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeHotelLocation::valueIsValid($locationType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeHotelLocation', is_array($locationType) ? implode(', ', $locationType) : var_export($locationType, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeHotelLocation::getValidValues())), __LINE__);
        }
