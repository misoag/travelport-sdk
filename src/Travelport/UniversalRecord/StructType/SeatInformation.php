...
class SeatInformation extends AbstractStructBase
{
     ...
     * @param \Travelport\UniversalRecord\StructType\Rating $rating
     */
    public function __construct(string $key, ?string $power = null, ?string $video = null, ?string $type = null, ?string $description = null, ?\Travelport\UniversalRecord\StructType\Rating $rating = null)
    {
        $this
            ->setKey($key)
            ->setPower($power)
     ...
     * Set Key value
     * @param string $key
     * @return \Travelport\UniversalRecord\StructType\SeatInformation
     */
    ...
    /**
     * Get Rating value
     * @return \Travelport\UniversalRecord\StructType\Rating|null
     */
    public function getRating(): ?\Travelport\UniversalRecord\StructType\Rating
    {
        return $this->Rating;
    }
    /**
     ...
     * @return \Travelport\UniversalRecord\StructType\SeatInformation
     */
    public function setRating(?\Travelport\UniversalRecord\StructType\Rating $rating = null): self
    {
        $this->Rating = $rating;
