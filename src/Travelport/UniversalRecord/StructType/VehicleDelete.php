...
/**
 * This class stands for VehicleDelete StructType
 * @subpackage Structs
 */
class VehicleDelete extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for VehicleDelete
     * @uses VehicleDelete::setReservationLocatorCode()
     * @uses VehicleDelete::setElement()
     * @uses VehicleDelete::setKey()
     ...
     * @param string $reservationLocatorCode
     * @return \Travelport\UniversalRecord\StructType\VehicleDelete
     */
