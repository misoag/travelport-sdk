...
class MCO extends MCOInformation
{
     ...
     * @param \Travelport\UniversalRecord\StructType\MCOExchangeInfo $mCOExchangeInfo
     * @param \Travelport\UniversalRecord\StructType\MCOFeeInfo $mCOFeeInfo
     * @param \Travelport\UniversalRecord\StructType\MCORemark[] $mCORemark
     * @param \Travelport\UniversalRecord\StructType\MCOPriceData $mCOPriceData
     ...
     */
    public function __construct(bool $mCOIssued, ?array $formOfPayment = null, ?\Travelport\UniversalRecord\StructType\Endorsement $endorsement = null, ?\Travelport\UniversalRecord\StructType\MCOExchangeInfo $mCOExchangeInfo = null, ?\Travelport\UniversalRecord\StructType\MCOFeeInfo $mCOFeeInfo = null, ?array $mCORemark = null, ?\Travelport\UniversalRecord\StructType\MCOPriceData $mCOPriceData = null, ?array $stockControl = null, ?array $mCOText = null, ?string $ticketType = null, ?string $ticketNumber = null, ?string $mCOIssueDate = null, ?string $mCODocNum = null, ?string $issueReasonCode = null, ?string $platingCarrier = null, ?string $tourOperator = null, ?string $location = null, ?string $tourCode = null, ?string $providerCode = null, ?string $providerLocatorCode = null, ?string $pseudoCityCode = null, ?string $expiryDate = null)
    {
        $this
     ...
     * @return \Travelport\UniversalRecord\StructType\Endorsement|null
     */
    public function getEndorsement(): ?\Travelport\UniversalRecord\StructType\Endorsement
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
    public function setEndorsement(?\Travelport\UniversalRecord\StructType\Endorsement $endorsement = null): self
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\MCOExchangeInfo|null
     */
    public function getMCOExchangeInfo(): ?\Travelport\UniversalRecord\StructType\MCOExchangeInfo
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
    public function setMCOExchangeInfo(?\Travelport\UniversalRecord\StructType\MCOExchangeInfo $mCOExchangeInfo = null): self
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\MCOFeeInfo|null
     */
    public function getMCOFeeInfo(): ?\Travelport\UniversalRecord\StructType\MCOFeeInfo
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
    public function setMCOFeeInfo(?\Travelport\UniversalRecord\StructType\MCOFeeInfo $mCOFeeInfo = null): self
    {
    ...
    /**
     * Get MCORemark value
     * @return \Travelport\UniversalRecord\StructType\MCORemark[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\MCORemark $item
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
     ...
     * @return \Travelport\UniversalRecord\StructType\MCOPriceData|null
     */
    public function getMCOPriceData(): ?\Travelport\UniversalRecord\StructType\MCOPriceData
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
    public function setMCOPriceData(?\Travelport\UniversalRecord\StructType\MCOPriceData $mCOPriceData = null): self
    {
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\StockControl $item
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\MCOText $item
     * @return \Travelport\UniversalRecord\StructType\MCO
     */
