...
class DocumentOptions extends AbstractStructBase
{
     ...
     * @var \Travelport\UniversalRecord\StructType\PassengerReceiptOverride|null
     */
    protected ?\Travelport\UniversalRecord\StructType\PassengerReceiptOverride $PassengerReceiptOverride = null;
    /**
     * The OverrideOption
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\UniversalRecord\StructType\PassengerReceiptOverride $passengerReceiptOverride
     * @param string[] $overrideOption
     * @param bool $suppressItineraryRemarks
     * @param bool $generateItinNumbers
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\PassengerReceiptOverride $passengerReceiptOverride = null, ?array $overrideOption = null, ?bool $suppressItineraryRemarks = null, ?bool $generateItinNumbers = null)
    {
        $this
     ...
     * @return \Travelport\UniversalRecord\StructType\PassengerReceiptOverride|null
     */
    public function getPassengerReceiptOverride(): ?\Travelport\UniversalRecord\StructType\PassengerReceiptOverride
    {
     ...
     * @param \Travelport\UniversalRecord\StructType\PassengerReceiptOverride $passengerReceiptOverride
     * @return \Travelport\UniversalRecord\StructType\DocumentOptions
     */
    public function setPassengerReceiptOverride(?\Travelport\UniversalRecord\StructType\PassengerReceiptOverride $passengerReceiptOverride = null): self
    {
