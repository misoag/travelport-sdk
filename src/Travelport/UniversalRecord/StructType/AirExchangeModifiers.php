...
class AirExchangeModifiers extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\ContractCodes $contractCodes = null, ?string $bookingDate = null, ?string $ticketingDate = null, ?string $accountCode = null, ?string $ticketDesignator = null, ?bool $allowPenaltyFares = true, ?bool $privateFaresOnly = false, ?string $universalRecordLocatorCode = null, ?string $providerLocatorCode = null, ?string $providerCode = null)
    {
        $this
     ...
     * @param \Travelport\UniversalRecord\StructType\ContractCodes $contractCodes
     * @return \Travelport\UniversalRecord\StructType\AirExchangeModifiers
     */
