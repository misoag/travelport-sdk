...
/**
 * This class stands for VehicleCancelRsp StructType
 * Meta information extracted from the WSDL
 * - documentation: Response to a VehicleCancelReq. PNR returned reflects the requested modifications.
 * @subpackage Structs
 */
class VehicleCancelRsp extends BaseRsp
{
    ...
    /**
     * Constructor method for VehicleCancelRsp
     * @uses VehicleCancelRsp::setUniversalRecord()
     ...
     * @param \Travelport\UniversalRecord\StructType\UniversalRecord $universalRecord
     * @return \Travelport\UniversalRecord\StructType\VehicleCancelRsp
     */
