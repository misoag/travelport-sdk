...
class HotelRating extends AbstractStructBase
{
     ...
     * - choiceMinOccurs: 1
     * - ref: RatingRange
     * @var \Travelport\UniversalRecord\StructType\RatingRange|null
     */
    protected ?\Travelport\UniversalRecord\StructType\RatingRange $RatingRange = null;
    /**
     ...
     * @param int[] $rating
     * @param \Travelport\UniversalRecord\StructType\RatingRange $ratingRange
     */
    public function __construct(string $ratingProvider, ?array $rating = null, ?\Travelport\UniversalRecord\StructType\RatingRange $ratingRange = null)
    {
        $this
     ...
     * @return \Travelport\UniversalRecord\StructType\RatingRange|null
     */
    public function getRatingRange(): ?\Travelport\UniversalRecord\StructType\RatingRange
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\HotelRating
     */
    public function setRatingRange(?\Travelport\UniversalRecord\StructType\RatingRange $ratingRange = null): self
    {
        // validation for constraint: choice(Rating, RatingRange)
