...
class Guarantee extends AbstractStructBase
{
     ...
     * @var \Travelport\UniversalRecord\StructType\OtherGuaranteeInfo|null
     */
    protected ?\Travelport\UniversalRecord\StructType\OtherGuaranteeInfo $OtherGuaranteeInfo = null;
    /**
     * The Key
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\UniversalRecord\StructType\OtherGuaranteeInfo $otherGuaranteeInfo
     * @param string $key
     ...
     */
    public function __construct(string $type, ?\Travelport\UniversalRecord\StructType\CreditCard $creditCard = null, ?\Travelport\UniversalRecord\StructType\OtherGuaranteeInfo $otherGuaranteeInfo = null, ?string $key = null, ?string $reuseFOP = null, ?string $externalReference = null, ?bool $reusable = false, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setType($type)
     ...
     * Set Type value
     * @param string $type
     * @return \Travelport\UniversalRecord\StructType\Guarantee
     */
     ...
     * @return \Travelport\UniversalRecord\StructType\OtherGuaranteeInfo|null
     */
    public function getOtherGuaranteeInfo(): ?\Travelport\UniversalRecord\StructType\OtherGuaranteeInfo
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\Guarantee
     */
    public function setOtherGuaranteeInfo(?\Travelport\UniversalRecord\StructType\OtherGuaranteeInfo $otherGuaranteeInfo = null): self
    {
        // validation for constraint: choice(CreditCard, OtherGuaranteeInfo)
