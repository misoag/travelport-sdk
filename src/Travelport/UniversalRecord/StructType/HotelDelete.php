...
/**
 * This class stands for HotelDelete StructType
 * @subpackage Structs
 */
class HotelDelete extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for HotelDelete
     * @uses HotelDelete::setReservationLocatorCode()
     * @uses HotelDelete::setElement()
     * @uses HotelDelete::setKey()
     ...
     * @param string $reservationLocatorCode
     * @return \Travelport\UniversalRecord\StructType\HotelDelete
     */
