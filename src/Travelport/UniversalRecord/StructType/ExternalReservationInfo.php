...
/**
 * This class stands for ExternalReservationInfo StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the details of the External PNR from which current PNR has neen copied. External PNR may reside in other gds system.This is a specific JAL functionality. PROVIDER SUPPORTED: JAL.
 * @subpackage Structs
 */
class ExternalReservationInfo extends AbstractStructBase
{
    /**
     * The LocatorCode
     * Meta information extracted from the WSDL
     * - documentation: Locator Code of the External PNR. | A Locator Code that uniquely identifies a Record or searches for one.
     * - base: xs:string
     * - maxLength: 8
     * - minLength: 5
     * - use: required
     ...
     * The Carrier
     * Meta information extracted from the WSDL
     * - documentation: Carrier associated with the External PNR. | 2 Letter Carrier code
     * - base: xs:string
     * - length: 2
     * - use: optional
     * @var string|null
    ...
    /**
     * Constructor method for ExternalReservationInfo
     * @uses ExternalReservationInfo::setLocatorCode()
     * @uses ExternalReservationInfo::setCarrier()
     * @param string $locatorCode
     * @param string $carrier
     */
    public function __construct(string $locatorCode, ?string $carrier = null)
    {
        $this
     ...
     * @param string $locatorCode
     * @return \Travelport\UniversalRecord\StructType\ExternalReservationInfo
     */
