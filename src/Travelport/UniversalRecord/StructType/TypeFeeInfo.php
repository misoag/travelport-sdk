...
class TypeFeeInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(string $key, string $amount, string $code, ?array $taxInfoRef = null, ?\Travelport\UniversalRecord\StructType\IncludedInBase $includedInBase = null, ?string $baseAmount = null, ?string $description = null, ?string $subCode = null, ?string $feeToken = null, ?string $paymentRef = null, ?string $bookingTravelerRef = null, ?string $passengerTypeCode = null, ?string $text = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setKey($key)
            ->setAmount($amount)
     ...
     * @param \Travelport\UniversalRecord\StructType\TaxInfoRef $item
     * @return \Travelport\UniversalRecord\StructType\TypeFeeInfo
     */
