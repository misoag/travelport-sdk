...
class DisfavoredProviders extends AbstractStructBase
{
    ...
    public static function validateProviderForArrayConstraintFromSetProvider(?array $values = []): string
    {
        ...
        foreach ($values as $disfavoredProvidersProviderItem) {
            ...
            if (!$disfavoredProvidersProviderItem instanceof \Travelport\UniversalRecord\StructType\Provider) {
     ...
     * @param \Travelport\UniversalRecord\StructType\Provider[] $provider
     * @return \Travelport\UniversalRecord\StructType\DisfavoredProviders
     */
