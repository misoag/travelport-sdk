...
class AirItinerary extends AbstractStructBase
{
    ...
    public static function validateAirSegmentForArrayConstraintsFromSetAirSegment(?array $values = []): string
    {
        ...
        foreach ($values as $airItineraryAirSegmentItem) {
            ...
            if (!$airItineraryAirSegmentItem instanceof \Travelport\UniversalRecord\StructType\TypeBaseAirSegment) {
    ...
    public static function validateHostTokenForArrayConstraintsFromSetHostToken(?array $values = []): string
    {
        ...
        foreach ($values as $airItineraryHostTokenItem) {
            // validation for constraint: itemType
            if (!$airItineraryHostTokenItem instanceof \Travelport\UniversalRecord\StructType\HostToken) {
    ...
    public static function validateAPISRequirementsForArrayConstraintsFromSetAPISRequirements(?array $values = []): string
    {
        ...
        foreach ($values as $airItineraryAPISRequirementsItem) {
            // validation for constraint: itemType
            if (!$airItineraryAPISRequirementsItem instanceof \Travelport\UniversalRecord\StructType\APISRequirements) {
