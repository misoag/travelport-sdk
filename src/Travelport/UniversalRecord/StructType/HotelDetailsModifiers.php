...
class HotelDetailsModifiers extends AbstractStructBase
{
     ...
     * @param int $maxWait
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\PermittedProviders $permittedProviders = null, ?array $loyaltyCard = null, ?array $corporateDiscountID = null, ?\Travelport\UniversalRecord\StructType\HotelStay $hotelStay = null, ?\Travelport\UniversalRecord\StructType\NumberOfChildren $numberOfChildren = null, ?array $hotelBedding = null, ?array $rateCategory = null, ?\Travelport\UniversalRecord\StructType\BookingGuestInformation $bookingGuestInformation = null, ?int $numberOfAdults = null, ?string $rateRuleDetail = null, ?int $numberOfRooms = 1, ?string $key = null, ?string $preferredCurrency = null, ?int $totalOccupants = null, ?bool $processAllNegoRatesInd = false, ?int $maxWait = null)
    {
        $this
    ...
    public static function validateLoyaltyCardForArrayConstraintFromSetLoyaltyCard(?array $values = []): string
    {
        ...
        foreach ($values as $hotelDetailsModifiersLoyaltyCardItem) {
            ...
            if (!$hotelDetailsModifiersLoyaltyCardItem instanceof \Travelport\UniversalRecord\StructType\LoyaltyCard) {
    ...
    public static function validateCorporateDiscountIDForArrayConstraintFromSetCorporateDiscountID(?array $values = []): string
    {
        ...
        foreach ($values as $hotelDetailsModifiersCorporateDiscountIDItem) {
            // validation for constraint: itemType
            if (!$hotelDetailsModifiersCorporateDiscountIDItem instanceof \Travelport\UniversalRecord\StructType\CorporateDiscountID) {
    ...
    public static function validateHotelBeddingForArrayConstraintFromSetHotelBedding(?array $values = []): string
    {
        ...
        foreach ($values as $hotelDetailsModifiersHotelBeddingItem) {
            // validation for constraint: itemType
            if (!$hotelDetailsModifiersHotelBeddingItem instanceof \Travelport\UniversalRecord\StructType\HotelBedding) {
     ...
     * @uses \Travelport\UniversalRecord\EnumType\TypeRateRuleDetail::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeRateRuleDetail::getValidValues()
     * @throws InvalidArgumentException
     * @param string $rateRuleDetail
     * @return \Travelport\UniversalRecord\StructType\HotelDetailsModifiers
     */
    public function setRateRuleDetail(?string $rateRuleDetail = null): self
    {
        ...
        if (!\Travelport\UniversalRecord\EnumType\TypeRateRuleDetail::valueIsValid($rateRuleDetail)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeRateRuleDetail', is_array($rateRuleDetail) ? implode(', ', $rateRuleDetail) : var_export($rateRuleDetail, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeRateRuleDetail::getValidValues())), __LINE__);
        }
