...
class CommissionRemark extends AbstractStructBase
{
     ...
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * @var \Travelport\UniversalRecord\StructType\ProviderReservationLevel|null
     */
    protected ?\Travelport\UniversalRecord\StructType\ProviderReservationLevel $ProviderReservationLevel = null;
    /**
     ...
     * - choiceMinOccurs: 1
     * - maxOccurs: 4
     * @var \Travelport\UniversalRecord\StructType\PassengerTypeLevel[]
     */
     ...
     * @param \Travelport\UniversalRecord\StructType\ProviderReservationLevel $providerReservationLevel
     * @param \Travelport\UniversalRecord\StructType\PassengerTypeLevel[] $passengerTypeLevel
     * @param string $key
     ...
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\ProviderReservationLevel $providerReservationLevel = null, ?array $passengerTypeLevel = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?string $providerCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * @return \Travelport\UniversalRecord\StructType\ProviderReservationLevel|null
     */
    public function getProviderReservationLevel(): ?\Travelport\UniversalRecord\StructType\ProviderReservationLevel
    {
     ...
     */
    public function setProviderReservationLevel(?\Travelport\UniversalRecord\StructType\ProviderReservationLevel $providerReservationLevel = null): self
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\PassengerTypeLevel[]|null
     */
    ...
    public static function validatePassengerTypeLevelForArrayConstraintFromSetPassengerTypeLevel(?array $values = []): string
    {
        ...
        foreach ($values as $commissionRemarkPassengerTypeLevelItem) {
            ...
            if (!$commissionRemarkPassengerTypeLevelItem instanceof \Travelport\UniversalRecord\StructType\PassengerTypeLevel) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PassengerTypeLevel property can only contain items of type \Travelport\UniversalRecord\StructType\PassengerTypeLevel, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\PassengerTypeLevel $item
     * @return \Travelport\UniversalRecord\StructType\CommissionRemark
     */
    public function addToPassengerTypeLevel(\Travelport\UniversalRecord\StructType\PassengerTypeLevel $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\PassengerTypeLevel) {
            throw new InvalidArgumentException(sprintf('The PassengerTypeLevel property can only contain items of type \Travelport\UniversalRecord\StructType\PassengerTypeLevel, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(ProviderReservationLevel, PassengerTypeLevel)
