...
class AirPricingModifiers extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\UniversalRecord\StructType\ProhibitedRuleCategories|null
     */
    protected ?\Travelport\UniversalRecord\StructType\ProhibitedRuleCategories $ProhibitedRuleCategories = null;
    /**
     * The AccountCodes
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\UniversalRecord\StructType\AccountCodes|null
     */
    protected ?\Travelport\UniversalRecord\StructType\AccountCodes $AccountCodes = null;
    /**
     * The PermittedCabins
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * - minOccurs: 0
     * - ref: ExemptTaxes
     * @var \Travelport\UniversalRecord\StructType\ExemptTaxes|null
     */
    protected ?\Travelport\UniversalRecord\StructType\ExemptTaxes $ExemptTaxes = null;
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\UniversalRecord\StructType\PromoCodes|null
     */
    protected ?\Travelport\UniversalRecord\StructType\PromoCodes $PromoCodes = null;
    /**
     ...
     * @var \Travelport\UniversalRecord\StructType\ManualFareAdjustment[]
     */
     ...
     * - minOccurs: 0
     * - ref: BrandModifiers
     * @var \Travelport\UniversalRecord\StructType\BrandModifiers|null
     */
    protected ?\Travelport\UniversalRecord\StructType\BrandModifiers $BrandModifiers = null;
    /**
     ...
     * @var \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator[]
     */
     ...
     * - minOccurs: 0
     * - ref: PreferredCabins
     * @var \Travelport\UniversalRecord\StructType\PreferredCabins[]
     */
     ...
     * @param \Travelport\UniversalRecord\StructType\ProhibitedRuleCategories $prohibitedRuleCategories
     * @param \Travelport\UniversalRecord\StructType\AccountCodes $accountCodes
     * @param \Travelport\UniversalRecord\StructType\PermittedCabins $permittedCabins
     * @param \Travelport\UniversalRecord\StructType\ContractCodes $contractCodes
     * @param \Travelport\UniversalRecord\StructType\ExemptTaxes $exemptTaxes
     ...
     * @param \Travelport\UniversalRecord\StructType\PromoCodes $promoCodes
     * @param \Travelport\UniversalRecord\StructType\ManualFareAdjustment[] $manualFareAdjustment
     * @param \Travelport\UniversalRecord\StructType\PointOfSale $pointOfSale
     * @param \Travelport\UniversalRecord\StructType\BrandModifiers $brandModifiers
     * @param \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator[] $multiGDSSearchIndicator
     ...
     */
    public function __construct(?\Travelport\UniversalRecord\StructType\ProhibitedRuleCategories $prohibitedRuleCategories = null, ?\Travelport\UniversalRecord\StructType\AccountCodes $accountCodes = null, ?\Travelport\UniversalRecord\StructType\PermittedCabins $permittedCabins = null, ?\Travelport\UniversalRecord\StructType\ContractCodes $contractCodes = null, ?\Travelport\UniversalRecord\StructType\ExemptTaxes $exemptTaxes = null, ?\Travelport\UniversalRecord\StructType\PenaltyFareInformation $penaltyFareInformation = null, ?array $discountCard = null, ?\Travelport\UniversalRecord\StructType\PromoCodes $promoCodes = null, ?array $manualFareAdjustment = null, ?\Travelport\UniversalRecord\StructType\PointOfSale $pointOfSale = null, ?\Travelport\UniversalRecord\StructType\BrandModifiers $brandModifiers = null, ?array $multiGDSSearchIndicator = null, ?array $preferredCabins = null, ?bool $prohibitMinStayFares = false, ?bool $prohibitMaxStayFares = false, ?string $currencyType = null, ?bool $prohibitAdvancePurchaseFares = false, ?bool $prohibitNonRefundableFares = false, ?bool $prohibitRestrictedFares = false, ?string $faresIndicator = null, ?string $filedCurrency = null, ?string $platingCarrier = null, ?string $overrideCarrier = null, ?string $eTicketability = null, ?bool $accountCodeFaresOnly = null, ?string $key = null, ?bool $prohibitNonExchangeableFares = false, ?bool $forceSegmentSelect = false, ?string $inventoryRequestType = null, ?bool $oneWayShop = false, ?bool $prohibitUnbundledFareTypes = null, ?bool $returnServices = false, ?string $channelId = null, ?bool $returnFareAttributes = false, ?bool $sellCheck = false, ?bool $returnFailedSegments = false, ?string $sellCity = null, ?string $ticketingCity = null)
    {
        $this
     ...
     * @return \Travelport\UniversalRecord\StructType\ProhibitedRuleCategories|null
     */
    public function getProhibitedRuleCategories(): ?\Travelport\UniversalRecord\StructType\ProhibitedRuleCategories
    {
     ...
     */
    public function setProhibitedRuleCategories(?\Travelport\UniversalRecord\StructType\ProhibitedRuleCategories $prohibitedRuleCategories = null): self
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\AccountCodes|null
     */
    public function getAccountCodes(): ?\Travelport\UniversalRecord\StructType\AccountCodes
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function setAccountCodes(?\Travelport\UniversalRecord\StructType\AccountCodes $accountCodes = null): self
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\ContractCodes|null
     */
    public function getContractCodes(): ?\Travelport\UniversalRecord\StructType\ContractCodes
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function setContractCodes(?\Travelport\UniversalRecord\StructType\ContractCodes $contractCodes = null): self
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\ExemptTaxes|null
     */
    public function getExemptTaxes(): ?\Travelport\UniversalRecord\StructType\ExemptTaxes
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function setExemptTaxes(?\Travelport\UniversalRecord\StructType\ExemptTaxes $exemptTaxes = null): self
    {
    ...
    public static function validateDiscountCardForArrayConstraintsFromSetDiscountCard(?array $values = []): string
    {
        ...
        foreach ($values as $airPricingModifiersDiscountCardItem) {
            ...
            if (!$airPricingModifiersDiscountCardItem instanceof \Travelport\UniversalRecord\StructType\DiscountCard) {
     ...
     * @return \Travelport\UniversalRecord\StructType\PromoCodes|null
     */
    public function getPromoCodes(): ?\Travelport\UniversalRecord\StructType\PromoCodes
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function setPromoCodes(?\Travelport\UniversalRecord\StructType\PromoCodes $promoCodes = null): self
    {
    ...
    public static function validateManualFareAdjustmentForArrayConstraintsFromSetManualFareAdjustment(?array $values = []): string
    {
        ...
        foreach ($values as $airPricingModifiersManualFareAdjustmentItem) {
            // validation for constraint: itemType
            if (!$airPricingModifiersManualFareAdjustmentItem instanceof \Travelport\UniversalRecord\StructType\ManualFareAdjustment) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ManualFareAdjustment property can only contain items of type \Travelport\UniversalRecord\StructType\ManualFareAdjustment, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\ManualFareAdjustment $item
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function addToManualFareAdjustment(\Travelport\UniversalRecord\StructType\ManualFareAdjustment $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\ManualFareAdjustment) {
            throw new InvalidArgumentException(sprintf('The ManualFareAdjustment property can only contain items of type \Travelport\UniversalRecord\StructType\ManualFareAdjustment, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\UniversalRecord\StructType\BrandModifiers|null
     */
    public function getBrandModifiers(): ?\Travelport\UniversalRecord\StructType\BrandModifiers
    {
     ...
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function setBrandModifiers(?\Travelport\UniversalRecord\StructType\BrandModifiers $brandModifiers = null): self
    {
    ...
    public static function validateMultiGDSSearchIndicatorForArrayConstraintsFromSetMultiGDSSearchIndicator(?array $values = []): string
    {
        ...
        foreach ($values as $airPricingModifiersMultiGDSSearchIndicatorItem) {
            // validation for constraint: itemType
            if (!$airPricingModifiersMultiGDSSearchIndicatorItem instanceof \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MultiGDSSearchIndicator property can only contain items of type \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator $item
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function addToMultiGDSSearchIndicator(\Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator) {
            throw new InvalidArgumentException(sprintf('The MultiGDSSearchIndicator property can only contain items of type \Travelport\UniversalRecord\StructType\MultiGDSSearchIndicator, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validatePreferredCabinsForArrayConstraintsFromSetPreferredCabins(?array $values = []): string
    {
        ...
        foreach ($values as $airPricingModifiersPreferredCabinsItem) {
            // validation for constraint: itemType
            if (!$airPricingModifiersPreferredCabinsItem instanceof \Travelport\UniversalRecord\StructType\PreferredCabins) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PreferredCabins property can only contain items of type \Travelport\UniversalRecord\StructType\PreferredCabins, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\PreferredCabins $item
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    public function addToPreferredCabins(\Travelport\UniversalRecord\StructType\PreferredCabins $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\PreferredCabins) {
            throw new InvalidArgumentException(sprintf('The PreferredCabins property can only contain items of type \Travelport\UniversalRecord\StructType\PreferredCabins, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(99)
     ...
     * @uses \Travelport\UniversalRecord\EnumType\TypeInventoryRequest::valueIsValid()
     * @uses \Travelport\UniversalRecord\EnumType\TypeInventoryRequest::getValidValues()
     * @throws InvalidArgumentException
     * @param string $inventoryRequestType
     * @return \Travelport\UniversalRecord\StructType\AirPricingModifiers
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Travelport\UniversalRecord\EnumType\TypeInventoryRequest::valueIsValid($inventoryRequestType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\UniversalRecord\EnumType\TypeInventoryRequest', is_array($inventoryRequestType) ? implode(', ', $inventoryRequestType) : var_export($inventoryRequestType, true), implode(', ', \Travelport\UniversalRecord\EnumType\TypeInventoryRequest::getValidValues())), __LINE__);
        }
