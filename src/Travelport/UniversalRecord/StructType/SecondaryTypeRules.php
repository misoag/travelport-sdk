...
class SecondaryTypeRules extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * @var \Travelport\UniversalRecord\StructType\SecondaryTypeRule[]
     */
     ...
     * @param \Travelport\UniversalRecord\StructType\SecondaryTypeRule[] $secondaryTypeRule
     */
     ...
     * @return \Travelport\UniversalRecord\StructType\SecondaryTypeRule[]
     */
    ...
    public static function validateSecondaryTypeRuleForArrayConstraintFromSetSecondaryTypeRule(?array $values = []): string
    {
        ...
        foreach ($values as $secondaryTypeRulesSecondaryTypeRuleItem) {
            ...
            if (!$secondaryTypeRulesSecondaryTypeRuleItem instanceof \Travelport\UniversalRecord\StructType\SecondaryTypeRule) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SecondaryTypeRule property can only contain items of type \Travelport\UniversalRecord\StructType\SecondaryTypeRule, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Travelport\UniversalRecord\StructType\SecondaryTypeRule[] $secondaryTypeRule
     * @return \Travelport\UniversalRecord\StructType\SecondaryTypeRules
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\UniversalRecord\StructType\SecondaryTypeRule $item
     * @return \Travelport\UniversalRecord\StructType\SecondaryTypeRules
     */
    public function addToSecondaryTypeRule(\Travelport\UniversalRecord\StructType\SecondaryTypeRule $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\UniversalRecord\StructType\SecondaryTypeRule) {
            throw new InvalidArgumentException(sprintf('The SecondaryTypeRule property can only contain items of type \Travelport\UniversalRecord\StructType\SecondaryTypeRule, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
