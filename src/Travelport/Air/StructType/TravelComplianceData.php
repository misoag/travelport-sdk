...
class TravelComplianceData extends AbstractStructBase
{
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\PolicyCompliance[]
     */
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\ContractCompliance[]
     */
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\PreferredSupplier[]
     */
     ...
     * @param \Travelport\Air\StructType\PolicyCompliance[] $policyCompliance
     * @param \Travelport\Air\StructType\ContractCompliance[] $contractCompliance
     * @param \Travelport\Air\StructType\PreferredSupplier[] $preferredSupplier
     * @param string $key
     ...
     * @return \Travelport\Air\StructType\PolicyCompliance[]
     */
     ...
     * @param \Travelport\Air\StructType\PolicyCompliance[] $policyCompliance
     * @return \Travelport\Air\StructType\TravelComplianceData
     */
     ...
     * @param \Travelport\Air\StructType\PolicyCompliance $item
     * @return \Travelport\Air\StructType\TravelComplianceData
     */
    public function addToPolicyCompliance(\Travelport\Air\StructType\PolicyCompliance $item): self
    {
     ...
     * @return \Travelport\Air\StructType\ContractCompliance[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\ContractCompliance $item
     * @return \Travelport\Air\StructType\TravelComplianceData
     */
    public function addToContractCompliance(\Travelport\Air\StructType\ContractCompliance $item): self
    {
     ...
     * @return \Travelport\Air\StructType\PreferredSupplier[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\PreferredSupplier $item
     * @return \Travelport\Air\StructType\TravelComplianceData
     */
    public function addToPreferredSupplier(\Travelport\Air\StructType\PreferredSupplier $item): self
    {
