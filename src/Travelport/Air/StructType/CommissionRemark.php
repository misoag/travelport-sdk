...
class CommissionRemark extends AbstractStructBase
{
     ...
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * @var \Travelport\Air\StructType\ProviderReservationLevel|null
     */
    public ?\Travelport\Air\StructType\ProviderReservationLevel $ProviderReservationLevel = null;
    /**
     ...
     * - choiceMinOccurs: 1
     * - maxOccurs: 4
     * @var \Travelport\Air\StructType\PassengerTypeLevel[]
     */
     ...
     * @param \Travelport\Air\StructType\ProviderReservationLevel $providerReservationLevel
     * @param \Travelport\Air\StructType\PassengerTypeLevel[] $passengerTypeLevel
     * @param string $key
     ...
     */
    public function __construct(?\Travelport\Air\StructType\ProviderReservationLevel $providerReservationLevel = null, ?array $passengerTypeLevel = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?string $providerCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * @return \Travelport\Air\StructType\ProviderReservationLevel|null
     */
    public function getProviderReservationLevel(): ?\Travelport\Air\StructType\ProviderReservationLevel
    {
     ...
     * @param \Travelport\Air\StructType\ProviderReservationLevel $providerReservationLevel
     * @return \Travelport\Air\StructType\CommissionRemark
     */
    public function setProviderReservationLevel(?\Travelport\Air\StructType\ProviderReservationLevel $providerReservationLevel = null): self
    {
     ...
     * @return \Travelport\Air\StructType\PassengerTypeLevel[]|null
     */
     ...
     * @param \Travelport\Air\StructType\PassengerTypeLevel $item
     * @return \Travelport\Air\StructType\CommissionRemark
     */
    public function addToPassengerTypeLevel(\Travelport\Air\StructType\PassengerTypeLevel $item): self
    {
