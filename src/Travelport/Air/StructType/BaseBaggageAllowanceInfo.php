...
class BaseBaggageAllowanceInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: URLInfo
     * @var \Travelport\Air\StructType\URLInfo[]
     */
     ...
     * @param \Travelport\Air\StructType\URLInfo[] $uRLInfo
    ...
    /**
     * Get URLInfo value
     * @return \Travelport\Air\StructType\URLInfo[]
     */
     ...
     * @param \Travelport\Air\StructType\URLInfo $item
     * @return \Travelport\Air\StructType\BaseBaggageAllowanceInfo
     */
    public function addToURLInfo(\Travelport\Air\StructType\URLInfo $item): self
    {
        $this->URLInfo[] = $item;
