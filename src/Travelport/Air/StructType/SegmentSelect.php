...
class SegmentSelect extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TypeNonAirReservationRef[]
     */
     ...
     * @param \Travelport\Air\StructType\TypeSegmentRef[] $airSegmentRef
     * @return \Travelport\Air\StructType\SegmentSelect
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\TypeNonAirReservationRef $item
     * @return \Travelport\Air\StructType\SegmentSelect
     */
    public function addToHotelReservationRef(\Travelport\Air\StructType\TypeNonAirReservationRef $item): self
    {
     ...
     * @return \Travelport\Air\StructType\SegmentSelect
     */
    public function addToVehicleReservationRef(\Travelport\Air\StructType\TypeNonAirReservationRef $item): self
    {
     ...
     * @return \Travelport\Air\StructType\SegmentSelect
     */
    public function addToPassiveSegmentRef(\Travelport\Air\StructType\TypeSegmentRef $item): self
    {
