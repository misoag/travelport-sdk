...
class ExpertSolution extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - ref: LegPrice
     * @var \Travelport\Air\StructType\LegPrice[]
     */
     ...
     * @param \Travelport\Air\StructType\LegPrice[] $legPrice
    ...
    /**
     * Get LegPrice value
     * @return \Travelport\Air\StructType\LegPrice[]
     */
     ...
     * @param \Travelport\Air\StructType\LegPrice $item
     * @return \Travelport\Air\StructType\ExpertSolution
     */
    public function addToLegPrice(\Travelport\Air\StructType\LegPrice $item): self
    {
        $this->LegPrice[] = $item;
