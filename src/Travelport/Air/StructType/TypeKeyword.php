...
class TypeKeyword extends AbstractStructBase
{
     ...
     * - maxOccurs: 99
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TypeSubKey[]
     */
     ...
     * @param string $name
     * @param \Travelport\Air\StructType\TypeSubKey[] $subKey
     * @param string[] $text
     * @param string $number
     ...
     * Set Name value
     * @param string $name
     * @return \Travelport\Air\StructType\TypeKeyword
     */
     ...
     * @param \Travelport\Air\StructType\TypeSubKey $item
     * @return \Travelport\Air\StructType\TypeKeyword
     */
    public function addToSubKey(\Travelport\Air\StructType\TypeSubKey $item): self
    {
        $this->SubKey[] = $item;
