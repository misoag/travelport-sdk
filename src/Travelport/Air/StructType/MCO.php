...
class MCO extends MCOInformation
{
     ...
     * - minOccurs: 0
     * - ref: Endorsement
     * @var \Travelport\Air\StructType\Endorsement|null
     */
    public ?\Travelport\Air\StructType\Endorsement $Endorsement = null;
    /**
     * The MCOExchangeInfo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MCOExchangeInfo
     * @var \Travelport\Air\StructType\MCOExchangeInfo|null
     */
    public ?\Travelport\Air\StructType\MCOExchangeInfo $MCOExchangeInfo = null;
    /**
     * The MCOFeeInfo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MCOFeeInfo
     * @var \Travelport\Air\StructType\MCOFeeInfo|null
     */
    public ?\Travelport\Air\StructType\MCOFeeInfo $MCOFeeInfo = null;
    /**
     * The MCORemark
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * - ref: MCORemark
     * @var \Travelport\Air\StructType\MCORemark[]
     */
     ...
     * - minOccurs: 0
     * - ref: MCOPriceData
     * @var \Travelport\Air\StructType\MCOPriceData|null
     */
    public ?\Travelport\Air\StructType\MCOPriceData $MCOPriceData = null;
    /**
     * The StockControl
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * - ref: StockControl
     * @var \Travelport\Air\StructType\StockControl[]
     */
     ...
     * - minOccurs: 0
     * - ref: MCOText
     * @var \Travelport\Air\StructType\MCOText[]
     */
     ...
     * @param \Travelport\Air\StructType\MCOExchangeInfo $mCOExchangeInfo
     * @param \Travelport\Air\StructType\MCOFeeInfo $mCOFeeInfo
     * @param \Travelport\Air\StructType\MCORemark[] $mCORemark
     * @param \Travelport\Air\StructType\MCOPriceData $mCOPriceData
     * @param \Travelport\Air\StructType\StockControl[] $stockControl
     * @param \Travelport\Air\StructType\MCOText[] $mCOText
     ...
     */
    public function __construct(bool $mCOIssued, ?array $formOfPayment = null, ?\Travelport\Air\StructType\Endorsement $endorsement = null, ?\Travelport\Air\StructType\MCOExchangeInfo $mCOExchangeInfo = null, ?\Travelport\Air\StructType\MCOFeeInfo $mCOFeeInfo = null, ?array $mCORemark = null, ?\Travelport\Air\StructType\MCOPriceData $mCOPriceData = null, ?array $stockControl = null, ?array $mCOText = null, ?string $ticketType = null, ?string $ticketNumber = null, ?string $mCOIssueDate = null, ?string $mCODocNum = null, ?string $issueReasonCode = null, ?string $platingCarrier = null, ?string $tourOperator = null, ?string $location = null, ?string $tourCode = null, ?string $providerCode = null, ?string $providerLocatorCode = null, ?string $pseudoCityCode = null, ?string $expiryDate = null)
    {
        $this
     ...
     * @return \Travelport\Air\StructType\Endorsement|null
     */
    public function getEndorsement(): ?\Travelport\Air\StructType\Endorsement
    {
     ...
     * @return \Travelport\Air\StructType\MCO
     */
    public function setEndorsement(?\Travelport\Air\StructType\Endorsement $endorsement = null): self
    {
     ...
     * @return \Travelport\Air\StructType\MCOExchangeInfo|null
     */
    public function getMCOExchangeInfo(): ?\Travelport\Air\StructType\MCOExchangeInfo
    {
     ...
     * @return \Travelport\Air\StructType\MCO
     */
    public function setMCOExchangeInfo(?\Travelport\Air\StructType\MCOExchangeInfo $mCOExchangeInfo = null): self
    {
     ...
     * @return \Travelport\Air\StructType\MCOFeeInfo|null
     */
    public function getMCOFeeInfo(): ?\Travelport\Air\StructType\MCOFeeInfo
    {
     ...
     * @return \Travelport\Air\StructType\MCO
     */
    public function setMCOFeeInfo(?\Travelport\Air\StructType\MCOFeeInfo $mCOFeeInfo = null): self
    {
    ...
    /**
     * Get MCORemark value
     * @return \Travelport\Air\StructType\MCORemark[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\MCORemark $item
     * @return \Travelport\Air\StructType\MCO
     */
    public function addToMCORemark(\Travelport\Air\StructType\MCORemark $item): self
    {
        $this->MCORemark[] = $item;
     ...
     * @return \Travelport\Air\StructType\MCOPriceData|null
     */
    public function getMCOPriceData(): ?\Travelport\Air\StructType\MCOPriceData
    {
     ...
     * @return \Travelport\Air\StructType\MCO
     */
    public function setMCOPriceData(?\Travelport\Air\StructType\MCOPriceData $mCOPriceData = null): self
    {
     ...
     * @return \Travelport\Air\StructType\StockControl[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\StockControl $item
     * @return \Travelport\Air\StructType\MCO
     */
    public function addToStockControl(\Travelport\Air\StructType\StockControl $item): self
    {
    ...
    /**
     * Get MCOText value
     * @return \Travelport\Air\StructType\MCOText[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\MCOText $item
     * @return \Travelport\Air\StructType\MCO
     */
    public function addToMCOText(\Travelport\Air\StructType\MCOText $item): self
    {
        $this->MCOText[] = $item;
