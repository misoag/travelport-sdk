...
class ServiceInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: MediaItem
     * @var \Travelport\Air\StructType\MediaItem[]
     */
     ...
     * @param \Travelport\Air\StructType\MediaItem[] $mediaItem
     */
     ...
     * @param string[] $description
     * @return \Travelport\Air\StructType\ServiceInfo
     */
    ...
    /**
     * Get MediaItem value
     * @return \Travelport\Air\StructType\MediaItem[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\MediaItem $item
     * @return \Travelport\Air\StructType\ServiceInfo
     */
    public function addToMediaItem(\Travelport\Air\StructType\MediaItem $item): self
    {
        $this->MediaItem[] = $item;
