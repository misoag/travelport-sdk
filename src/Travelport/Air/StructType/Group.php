...
class Group extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\SSRRef[]
     */
     ...
     * @param \Travelport\Air\StructType\SSRRef[] $sSRRef
     ...
     */
    public function __construct(int $groupSize, ?\Travelport\Air\StructType\Name $name = null, ?\Travelport\Air\StructType\DeliveryInfo $deliveryInfo = null, ?array $phoneNumber = null, ?array $sSRRef = null, ?\Travelport\Air\StructType\TypeStructuredAddress $address = null, ?array $bookingTravelerRef = null, ?string $key = null, ?string $travelerType = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * Set GroupSize value
     * @param int $groupSize
     * @return \Travelport\Air\StructType\Group
     */
    ...
    /**
     * Get SSRRef value
     * @return \Travelport\Air\StructType\SSRRef[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\SSRRef $item
     * @return \Travelport\Air\StructType\Group
     */
    public function addToSSRRef(\Travelport\Air\StructType\SSRRef $item): self
    {
        $this->SSRRef[] = $item;
