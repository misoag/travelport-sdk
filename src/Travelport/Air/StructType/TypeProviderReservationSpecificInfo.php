...
class TypeProviderReservationSpecificInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: OperatedBy
     * @var \Travelport\Air\StructType\OperatedBy[]
     */
     ...
     * @var \Travelport\Air\StructType\ProviderReservationInfoRef|null
     */
    public ?\Travelport\Air\StructType\ProviderReservationInfoRef $ProviderReservationInfoRef = null;
    /**
     ...
     * @param \Travelport\Air\StructType\OperatedBy[] $operatedBy
     ...
     */
    public function __construct(?array $operatedBy = null, ?\Travelport\Air\StructType\ProviderReservationInfoRef $providerReservationInfoRef = null, ?bool $providerReservationLevel = null, ?bool $reservationLevel = null)
    {
        $this
     ...
     * @return \Travelport\Air\StructType\OperatedBy[]
     */
     ...
     * @param \Travelport\Air\StructType\OperatedBy[] $operatedBy
     * @return \Travelport\Air\StructType\TypeProviderReservationSpecificInfo
     */
     ...
     * @param \Travelport\Air\StructType\OperatedBy $item
     * @return \Travelport\Air\StructType\TypeProviderReservationSpecificInfo
     */
    public function addToOperatedBy(\Travelport\Air\StructType\OperatedBy $item): self
    {
     ...
     * @return \Travelport\Air\StructType\ProviderReservationInfoRef|null
     */
    public function getProviderReservationInfoRef(): ?\Travelport\Air\StructType\ProviderReservationInfoRef
    {
     ...
     * @return \Travelport\Air\StructType\TypeProviderReservationSpecificInfo
     */
    public function setProviderReservationInfoRef(?\Travelport\Air\StructType\ProviderReservationInfoRef $providerReservationInfoRef = null): self
    {
