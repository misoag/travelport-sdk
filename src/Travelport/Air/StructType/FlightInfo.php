...
class FlightInfo extends AbstractStructBase
{
     ...
     * @var \Travelport\Air\StructType\FlightInfoDetail[]
     */
     ...
     * @param \Travelport\Air\StructType\FlightInfoDetail[] $flightInfoDetail
     * @param \Travelport\Air\StructType\TypeResultMessage[] $flightInfoErrorMessage
     * @param string $origin
     ...
     * @param \Travelport\Air\StructType\FlightInfoDetail $item
     * @return \Travelport\Air\StructType\FlightInfo
     */
    public function addToFlightInfoDetail(\Travelport\Air\StructType\FlightInfoDetail $item): self
    {
     ...
     * @return \Travelport\Air\StructType\FlightInfo
     */
    public function addToFlightInfoErrorMessage(\Travelport\Air\StructType\TypeResultMessage $item): self
    {
