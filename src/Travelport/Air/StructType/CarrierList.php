...
class CarrierList extends AbstractStructBase
{
     ...
     * - maxOccurs: 6
     * - ref: CarrierCode
     * @var \Travelport\Air\StructType\CarrierCode[]
     */
     ...
     * @param \Travelport\Air\StructType\CarrierCode[] $carrierCode
     */
     ...
     * @param bool $includeCarrier
     * @return \Travelport\Air\StructType\CarrierList
     */
     ...
     * @param \Travelport\Air\StructType\CarrierCode $item
     * @return \Travelport\Air\StructType\CarrierList
     */
    public function addToCarrierCode(\Travelport\Air\StructType\CarrierCode $item): self
    {
