...
class BaggageAllowanceInfo extends BaseBaggageAllowanceInfo
{
     ...
     * - minOccurs: 0
     * - ref: BagDetails
     * @var \Travelport\Air\StructType\BagDetails[]
     */
     ...
     * @param \Travelport\Air\StructType\BagDetails[] $bagDetails
     ...
     * @param \Travelport\Air\StructType\BagDetails $item
     * @return \Travelport\Air\StructType\BaggageAllowanceInfo
     */
    public function addToBagDetails(\Travelport\Air\StructType\BagDetails $item): self
    {
