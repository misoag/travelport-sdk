...
class TypeStructuredAddress extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: State
     * @var \Travelport\Air\StructType\State|null
     */
    public ?\Travelport\Air\StructType\State $State = null;
    /**
     * The PostalCode
     * Meta information extracted from the WSDL
     ...
     * @param string[] $street
     * @param string $city
     * @param \Travelport\Air\StructType\State $state
     ...
     */
    public function __construct(?string $addressName = null, ?array $street = null, ?string $city = null, ?\Travelport\Air\StructType\State $state = null, ?string $postalCode = null, ?string $country = null, ?array $providerReservationInfoRef = null, ?string $key = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
    ...
    /**
     * Get State value
     * @return \Travelport\Air\StructType\State|null
     */
    public function getState(): ?\Travelport\Air\StructType\State
    {
        return $this->State;
    }
    /**
     ...
     * @return \Travelport\Air\StructType\TypeStructuredAddress
     */
    public function setState(?\Travelport\Air\StructType\State $state = null): self
    {
        $this->State = $state;
