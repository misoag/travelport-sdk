...
class AirPriceResult extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TypeResultMessage|null
     */
    public ?\Travelport\Air\StructType\TypeResultMessage $AirPriceError = null;
    /**
     * The CommandKey
     * Meta information extracted from the WSDL
     * - base: xs:string
     ...
     * @param \Travelport\Air\StructType\TypeResultMessage $airPriceError
     * @param string $commandKey
     */
    public function __construct(?array $airPricingSolution = null, ?array $fareRule = null, ?\Travelport\Air\StructType\TypeResultMessage $airPriceError = null, ?string $commandKey = null)
    {
        $this
     ...
     * @return \Travelport\Air\StructType\TypeResultMessage|null
     */
    public function getAirPriceError(): ?\Travelport\Air\StructType\TypeResultMessage
    {
     ...
     * @return \Travelport\Air\StructType\AirPriceResult
     */
    public function setAirPriceError(?\Travelport\Air\StructType\TypeResultMessage $airPriceError = null): self
    {
