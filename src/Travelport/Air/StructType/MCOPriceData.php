...
class MCOPriceData extends AbstractStructBase
{
     ...
     */
    public function __construct(string $mCOAmount, ?array $taxInfo = null, ?\Travelport\Air\StructType\Commission $commission = null, ?string $mCOEquivalentFare = null, ?string $mCOTotalAmount = null)
    {
        $this
     ...
     * Set MCOAmount value
     * @param string $mCOAmount
     * @return \Travelport\Air\StructType\MCOPriceData
     */
