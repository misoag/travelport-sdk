...
class FareRuleLookup extends AbstractStructBase
{
     ...
     */
    public function __construct(string $origin, string $destination, string $carrier, string $fareBasis, string $providerCode, ?\Travelport\Air\StructType\AccountCode $accountCode = null, ?\Travelport\Air\StructType\PointOfSale $pointOfSale = null, ?string $departureDate = null, ?string $ticketingDate = null)
    {
        $this
            ->setOrigin($origin)
     ...
     * Set Origin value
     * @param string $origin
     * @return \Travelport\Air\StructType\FareRuleLookup
     */
