...
class AirExchangeInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TotalPenaltyTaxInfo|null
     */
    public ?\Travelport\Air\StructType\TotalPenaltyTaxInfo $TotalPenaltyTaxInfo = null;
    /**
     * The PaidTax
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TypeTax[]
     */
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TicketFeeInfo[]
     */
     ...
     * @param \Travelport\Air\StructType\TotalPenaltyTaxInfo $totalPenaltyTaxInfo
     * @param \Travelport\Air\StructType\TypeTax[] $paidTax
     * @param \Travelport\Air\StructType\TicketFeeInfo[] $ticketFeeInfo
     * @param string[] $reason
     ...
     * @param string $exchangeAmount
     * @return \Travelport\Air\StructType\AirExchangeInfo
     */
     ...
     * @return \Travelport\Air\StructType\TotalPenaltyTaxInfo|null
     */
    public function getTotalPenaltyTaxInfo(): ?\Travelport\Air\StructType\TotalPenaltyTaxInfo
    {
     ...
     * @return \Travelport\Air\StructType\AirExchangeInfo
     */
    public function setTotalPenaltyTaxInfo(?\Travelport\Air\StructType\TotalPenaltyTaxInfo $totalPenaltyTaxInfo = null): self
    {
    ...
    /**
     * Get PaidTax value
     * @return \Travelport\Air\StructType\TypeTax[]
     */
     ...
     * @param \Travelport\Air\StructType\TypeTax $item
     * @return \Travelport\Air\StructType\AirExchangeInfo
     */
    public function addToPaidTax(\Travelport\Air\StructType\TypeTax $item): self
    {
        $this->PaidTax[] = $item;
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\TicketFeeInfo $item
     * @return \Travelport\Air\StructType\AirExchangeInfo
     */
    public function addToTicketFeeInfo(\Travelport\Air\StructType\TicketFeeInfo $item): self
    {
