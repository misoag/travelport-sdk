...
class MCOInformation extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: PassengerInfo
     * @var \Travelport\Air\StructType\PassengerInfo[]
     */
     ...
     * @param \Travelport\Air\StructType\PassengerInfo[] $passengerInfo
     ...
     * @param \Travelport\Air\StructType\PassengerInfo $item
     * @return \Travelport\Air\StructType\MCOInformation
     */
    public function addToPassengerInfo(\Travelport\Air\StructType\PassengerInfo $item): self
    {
