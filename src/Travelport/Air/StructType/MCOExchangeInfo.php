...
class MCOExchangeInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: ExchangedCoupon
     * @var \Travelport\Air\StructType\ExchangedCoupon[]
     */
     ...
     * @param \Travelport\Air\StructType\ExchangedCoupon[] $exchangedCoupon
     * @param string $originalTicketNumber
     * @param string $originalCityCode
     * @param string $originalTicketDate
     * @param string $iATACode
     */
    public function __construct(?\Travelport\Air\StructType\FormOfPayment $formOfPayment = null, ?array $exchangedCoupon = null, ?string $originalTicketNumber = null, ?string $originalCityCode = null, ?string $originalTicketDate = null, ?string $iATACode = null)
    {
        $this
     ...
     * @param \Travelport\Air\StructType\FormOfPayment $formOfPayment
     * @return \Travelport\Air\StructType\MCOExchangeInfo
     */
     ...
     * @return \Travelport\Air\StructType\ExchangedCoupon[]
     */
     ...
     * @param \Travelport\Air\StructType\ExchangedCoupon $item
     * @return \Travelport\Air\StructType\MCOExchangeInfo
     */
    public function addToExchangedCoupon(\Travelport\Air\StructType\ExchangedCoupon $item): self
    {
