...
class RouteList extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - ref: Route
     * @var \Travelport\Air\StructType\Route[]
     */
    public ?array $Route = null;
    /**
     * Constructor method for RouteList
     * @uses RouteList::setRoute()
     * @param \Travelport\Air\StructType\Route[] $route
     */
    ...
    /**
     * Get Route value
     * @return \Travelport\Air\StructType\Route[]
     */
     ...
     * Set Route value
     * @param \Travelport\Air\StructType\Route[] $route
     * @return \Travelport\Air\StructType\RouteList
     */
     ...
     * @param \Travelport\Air\StructType\Route $item
     * @return \Travelport\Air\StructType\RouteList
     */
    public function addToRoute(\Travelport\Air\StructType\Route $item): self
    {
        $this->Route[] = $item;
