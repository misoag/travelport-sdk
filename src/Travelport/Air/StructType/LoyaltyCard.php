...
class LoyaltyCard extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\TypeProviderReservationSpecificInfo[]
     */
     ...
     * @param \Travelport\Air\StructType\TypeProviderReservationSpecificInfo[] $providerReservationSpecificInfo
     * @param string $status
     ...
     * @param \Travelport\Air\StructType\TypeProviderReservationSpecificInfo $item
     * @return \Travelport\Air\StructType\LoyaltyCard
     */
    public function addToProviderReservationSpecificInfo(\Travelport\Air\StructType\TypeProviderReservationSpecificInfo $item): self
    {
