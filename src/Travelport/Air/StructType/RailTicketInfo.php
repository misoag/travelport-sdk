...
class RailTicketInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TicketAdvisory
     * @var \Travelport\Air\StructType\TicketAdvisory[]
     */
     ...
     * @param \Travelport\Air\StructType\TicketAdvisory[] $ticketAdvisory
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\TicketAdvisory $item
     * @return \Travelport\Air\StructType\RailTicketInfo
     */
    public function addToTicketAdvisory(\Travelport\Air\StructType\TicketAdvisory $item): self
    {
