...
class AirAvailInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: BookingCodeInfo
     * @var \Travelport\Air\StructType\BookingCodeInfo[]
     */
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\FareTokenInfo[]
     */
     ...
     * @param \Travelport\Air\StructType\BookingCodeInfo[] $bookingCodeInfo
     * @param \Travelport\Air\StructType\FareTokenInfo[] $fareTokenInfo
     ...
     * @param \Travelport\Air\StructType\BookingCodeInfo $item
     * @return \Travelport\Air\StructType\AirAvailInfo
     */
    public function addToBookingCodeInfo(\Travelport\Air\StructType\BookingCodeInfo $item): self
    {
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\FareTokenInfo $item
     * @return \Travelport\Air\StructType\AirAvailInfo
     */
    public function addToFareTokenInfo(\Travelport\Air\StructType\FareTokenInfo $item): self
    {
