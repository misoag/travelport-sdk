...
class TypeTaxInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TaxDetail
     * @var \Travelport\Air\StructType\TaxDetail[]
     */
     ...
     * @param string $amount
     * @param \Travelport\Air\StructType\TaxDetail[] $taxDetail
     ...
     */
    public function __construct(string $category, string $amount, ?array $taxDetail = null, ?\Travelport\Air\StructType\IncludedInBase $includedInBase = null, ?string $key = null, ?string $carrierDefinedCategory = null, ?string $segmentRef = null, ?string $flightDetailsRef = null, ?string $couponRef = null, ?bool $taxExempted = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $text = null, ?string $originAirport = null, ?string $destinationAirport = null, ?string $countryCode = null, ?string $fareInfoRef = null)
    {
        $this
     ...
     * @param \Travelport\Air\StructType\TaxDetail $item
     * @return \Travelport\Air\StructType\TypeTaxInfo
     */
    public function addToTaxDetail(\Travelport\Air\StructType\TaxDetail $item): self
    {
        $this->TaxDetail[] = $item;
