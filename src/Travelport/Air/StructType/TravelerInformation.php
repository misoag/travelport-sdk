...
class TravelerInformation extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\Air\StructType\EmergencyContact|null
     */
    public ?\Travelport\Air\StructType\EmergencyContact $EmergencyContact = null;
    /**
     * The HomeAirport
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\Air\StructType\EmergencyContact $emergencyContact
     * @param string $homeAirport
     * @param string $visaExpirationDate
     */
    public function __construct(string $bookingTravelerRef, ?\Travelport\Air\StructType\EmergencyContact $emergencyContact = null, ?string $homeAirport = null, ?string $visaExpirationDate = null)
    {
        $this
     ...
     * @return \Travelport\Air\StructType\EmergencyContact|null
     */
    public function getEmergencyContact(): ?\Travelport\Air\StructType\EmergencyContact
    {
     ...
     * @return \Travelport\Air\StructType\TravelerInformation
     */
    public function setEmergencyContact(?\Travelport\Air\StructType\EmergencyContact $emergencyContact = null): self
    {
