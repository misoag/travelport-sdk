...
class SSRInfo extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - ref: SSR
     * @var \Travelport\Air\StructType\SSR|null
     */
    public ?\Travelport\Air\StructType\SSR $SSR = null;
    /**
     ...
     */
    public function __construct(?\Travelport\Air\StructType\SSR $sSR = null, ?array $bookingTravelerRef = null)
    {
        $this
            ->setSSR($sSR)
    ...
    /**
     * Get SSR value
     * @return \Travelport\Air\StructType\SSR|null
     */
    public function getSSR(): ?\Travelport\Air\StructType\SSR
    {
        return $this->SSR;
    }
    /**
     ...
     */
    public function setSSR(?\Travelport\Air\StructType\SSR $sSR = null): self
    {
        $this->SSR = $sSR;
