...
class FlightOption extends AbstractStructBase
{
     ...
     * - minOccurs: 1
     * - ref: Option
     * @var \Travelport\Air\StructType\Option[]
     */
    public array $Option;
    /**
     * The Origin
     ...
     * @param \Travelport\Air\StructType\Option[] $option
     * @param string $origin
     ...
     * @param \Travelport\Air\StructType\Option $item
     * @return \Travelport\Air\StructType\FlightOption
     */
    public function addToOption(\Travelport\Air\StructType\Option $item): self
    {
        $this->Option[] = $item;
