...
class AirFareDisplayModifiers extends AbstractStructBase
{
     ...
     * Set TripType value
     * @param string[] $tripType
     * @return \Travelport\Air\StructType\AirFareDisplayModifiers
     */
     ...
     * @uses \Travelport\Air\EnumType\TypeFareTripType::valueIsValid()
     * @uses \Travelport\Air\EnumType\TypeFareTripType::getValidValues()
     ...
     * @uses \Travelport\Air\EnumType\TypeFareSearchOption::valueIsValid()
     * @uses \Travelport\Air\EnumType\TypeFareSearchOption::getValidValues()
     * @throws InvalidArgumentException
     * @param string $item
     * @return \Travelport\Air\StructType\AirFareDisplayModifiers
     */
