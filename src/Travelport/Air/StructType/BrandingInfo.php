...
class BrandingInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: ServiceGroup
     * @var \Travelport\Air\StructType\ServiceGroup|null
     */
    public ?\Travelport\Air\StructType\ServiceGroup $ServiceGroup = null;
    /**
     * The AirSegmentRef
     * Meta information extracted from the WSDL
     * - documentation: Specifies the AirSegment the branding information is for. Providers: ACH, 1G, 1V, 1P
     * - maxOccurs: 99
     * @var \Travelport\Air\StructType\TypeSegmentRef[]
     */
     ...
     * @param \Travelport\Air\StructType\ServiceGroup $serviceGroup
     ...
     */
    public function __construct(string $commercialName, ?array $priceRange = null, ?array $text = null, ?array $title = null, ?array $imageLocation = null, ?\Travelport\Air\StructType\ServiceGroup $serviceGroup = null, ?array $airSegmentRef = null, ?string $key = null, ?string $serviceSubCode = null, ?string $externalServiceName = null, ?string $serviceType = null, ?string $chargeable = null)
    {
        $this
     ...
     * @param string $commercialName
     * @return \Travelport\Air\StructType\BrandingInfo
     */
     ...
     * @return \Travelport\Air\StructType\ServiceGroup|null
     */
    public function getServiceGroup(): ?\Travelport\Air\StructType\ServiceGroup
    {
     ...
     * @return \Travelport\Air\StructType\BrandingInfo
     */
    public function setServiceGroup(?\Travelport\Air\StructType\ServiceGroup $serviceGroup = null): self
    {
     ...
     * @return \Travelport\Air\StructType\TypeSegmentRef[]
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Air\StructType\TypeSegmentRef $item
     * @return \Travelport\Air\StructType\BrandingInfo
     */
    public function addToAirSegmentRef(\Travelport\Air\StructType\TypeSegmentRef $item): self
    {
