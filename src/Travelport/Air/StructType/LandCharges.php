...
class LandCharges extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: Tax
     * @var \Travelport\Air\StructType\Tax[]
     */
     ...
     * @param \Travelport\Air\StructType\Tax[] $tax
     * @param string $base
     * @param string $total
     ...
     * Set Tax value
     * @param \Travelport\Air\StructType\Tax[] $tax
     * @return \Travelport\Air\StructType\LandCharges
     */
     ...
     * @param \Travelport\Air\StructType\Tax $item
     * @return \Travelport\Air\StructType\LandCharges
     */
    public function addToTax(\Travelport\Air\StructType\Tax $item): self
    {
        $this->Tax[] = $item;
