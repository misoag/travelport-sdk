...
class CancelInfo extends AbstractStructBase
{
     ...
     * @param string $cancellationPolicy
     * @return \Travelport\Hotel\StructType\CancelInfo
     */
    ...
    public function setNonRefundableStayIndicator(?string $nonRefundableStayIndicator = null): self
    {
        ...
        if (!\Travelport\Hotel\EnumType\TypeTrinary::valueIsValid($nonRefundableStayIndicator)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Hotel\EnumType\TypeTrinary', is_array($nonRefundableStayIndicator) ? implode(', ', $nonRefundableStayIndicator) : var_export($nonRefundableStayIndicator, true), implode(', ', \Travelport\Hotel\EnumType\TypeTrinary::getValidValues())), __LINE__);
        }
