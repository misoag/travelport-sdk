...
class TravelerInformation extends AbstractStructBase
{
     ...
     * @param \Travelport\Hotel\StructType\EmergencyContact $emergencyContact
     * @param string $homeAirport
     * @param string $visaExpirationDate
     */
    public function __construct(string $bookingTravelerRef, ?\Travelport\Hotel\StructType\EmergencyContact $emergencyContact = null, ?string $homeAirport = null, ?string $visaExpirationDate = null)
    {
        $this
     ...
     * @return \Travelport\Hotel\StructType\EmergencyContact|null
     */
    public function getEmergencyContact(): ?\Travelport\Hotel\StructType\EmergencyContact
    {
     ...
     * @return \Travelport\Hotel\StructType\TravelerInformation
     */
    public function setEmergencyContact(?\Travelport\Hotel\StructType\EmergencyContact $emergencyContact = null): self
    {
