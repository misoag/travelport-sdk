...
class Guarantee extends AbstractStructBase
{
     ...
     */
    public function __construct(string $type, ?\Travelport\Hotel\StructType\CreditCard $creditCard = null, ?\Travelport\Hotel\StructType\OtherGuaranteeInfo $otherGuaranteeInfo = null, ?string $key = null, ?string $reuseFOP = null, ?string $externalReference = null, ?bool $reusable = false, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setType($type)
     ...
     * @return \Travelport\Hotel\StructType\OtherGuaranteeInfo|null
     */
