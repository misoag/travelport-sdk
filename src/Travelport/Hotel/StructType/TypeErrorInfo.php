...
class TypeErrorInfo extends AbstractStructBase
{
     ...
     * @param \Travelport\Hotel\StructType\Auxdata $auxdata
     * @param string $stackTrace
     */
    public function __construct(?string $code = null, ?string $service = null, ?string $type = null, ?string $description = null, ?string $transactionId = null, ?string $traceId = null, ?string $commandHistory = null, ?\Travelport\Hotel\StructType\Auxdata $auxdata = null, ?string $stackTrace = null)
    {
        $this
            ->setCode($code)
            ->setService($service)
     ...
     * Set Code value
     * @param string $code
     * @return \Travelport\Hotel\StructType\TypeErrorInfo
     */
    ...
    /**
     * Get Auxdata value
     * @return \Travelport\Hotel\StructType\Auxdata|null
     */
    public function getAuxdata(): ?\Travelport\Hotel\StructType\Auxdata
    {
        return $this->Auxdata;
    }
    /**
     ...
     * @return \Travelport\Hotel\StructType\TypeErrorInfo
     */
    public function setAuxdata(?\Travelport\Hotel\StructType\Auxdata $auxdata = null): self
    {
