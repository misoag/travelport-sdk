...
class AccountCode extends AbstractStructBase
{
     ...
     * Set Code value
     * @param string $code
     * @return \Travelport\Hotel\StructType\AccountCode
     */
    public function setCode(?string $code = null): self
    {
        ...
        if (!is_null($code) && mb_strlen((string) $code) > 36) {
            throw new InvalidArgumentException(sprintf('Invalid length of %s, the number of characters/octets contained by the literal must be less than or equal to 36', mb_strlen((string) $code)), __LINE__);
        }
        $this->Code = $code;
