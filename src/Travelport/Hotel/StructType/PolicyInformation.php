...
class PolicyInformation extends AbstractStructBase
{
     ...
     * @param string $type
     * @param \Travelport\Hotel\StructType\ReasonCode $reasonCode
     * @param string $name
     * @param bool $outOfPolicy
     * @param string $segmentRef
     */
    public function __construct(string $type, ?\Travelport\Hotel\StructType\ReasonCode $reasonCode = null, ?string $name = null, ?bool $outOfPolicy = null, ?string $segmentRef = null)
    {
        $this
            ->setType($type)
     ...
     * @return \Travelport\Hotel\StructType\ReasonCode|null
     */
    public function getReasonCode(): ?\Travelport\Hotel\StructType\ReasonCode
    {
     ...
     * @return \Travelport\Hotel\StructType\PolicyInformation
     */
    public function setReasonCode(?\Travelport\Hotel\StructType\ReasonCode $reasonCode = null): self
    {
