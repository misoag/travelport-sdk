...
class ActionStatus extends AbstractStructBase
{
     ...
     * @param string $type
     * @param \Travelport\Hotel\StructType\Remark $remark
     ...
     */
    public function __construct(string $type, ?\Travelport\Hotel\StructType\Remark $remark = null, ?string $ticketDate = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?string $queueCategory = null, ?string $airportCode = null, ?string $pseudoCityCode = null, ?string $accountCode = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setType($type)
            ->setRemark($remark)
     ...
     * Set Type value
     * @param string $type
     * @return \Travelport\Hotel\StructType\ActionStatus
     */
    ...
    /**
     * Get Remark value
     * @return \Travelport\Hotel\StructType\Remark|null
     */
    public function getRemark(): ?\Travelport\Hotel\StructType\Remark
    {
        return $this->Remark;
    }
    /**
     ...
     * @return \Travelport\Hotel\StructType\ActionStatus
     */
    public function setRemark(?\Travelport\Hotel\StructType\Remark $remark = null): self
    {
        $this->Remark = $remark;
