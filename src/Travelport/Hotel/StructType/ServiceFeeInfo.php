...
class ServiceFeeInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: FormOfPayment
     * @var \Travelport\Hotel\StructType\FormOfPayment|null
     */
    protected ?\Travelport\Hotel\StructType\FormOfPayment $FormOfPayment = null;
    /**
     ...
     * @var \Travelport\Hotel\StructType\ServiceFeeTaxInfo[]
     */
     ...
     * - minOccurs: 0
     * - ref: CreditCardAuth
     * @var \Travelport\Hotel\StructType\CreditCardAuth|null
     */
    protected ?\Travelport\Hotel\StructType\CreditCardAuth $CreditCardAuth = null;
    /**
     * The Payment
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: Payment
     * @var \Travelport\Hotel\StructType\Payment|null
     */
    protected ?\Travelport\Hotel\StructType\Payment $Payment = null;
    /**
     * The Status
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\Hotel\StructType\ServiceFeeTaxInfo[] $serviceFeeTaxInfo
     * @param \Travelport\Hotel\StructType\CreditCardAuth $creditCardAuth
     * @param \Travelport\Hotel\StructType\Payment $payment
     * @param string $status
     ...
     */
    public function __construct(?\Travelport\Hotel\StructType\FormOfPayment $formOfPayment = null, ?array $serviceFeeTaxInfo = null, ?\Travelport\Hotel\StructType\CreditCardAuth $creditCardAuth = null, ?\Travelport\Hotel\StructType\Payment $payment = null, ?string $status = null, ?string $description = null, ?string $key = null, ?string $confirmation = null, ?string $ticketNumber = null, ?string $bookingTravelerRef = null, ?string $providerReservationInfoRef = null, ?string $passiveProviderReservationInfoRef = null, ?string $totalAmount = null, ?string $baseAmount = null, ?string $taxes = null, ?string $bookingTravelerName = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * @return \Travelport\Hotel\StructType\FormOfPayment|null
     */
    public function getFormOfPayment(): ?\Travelport\Hotel\StructType\FormOfPayment
    {
     ...
     * @param \Travelport\Hotel\StructType\FormOfPayment $formOfPayment
     * @return \Travelport\Hotel\StructType\ServiceFeeInfo
     */
    public function setFormOfPayment(?\Travelport\Hotel\StructType\FormOfPayment $formOfPayment = null): self
    {
     ...
     * @return \Travelport\Hotel\StructType\ServiceFeeTaxInfo[]
     */
    ...
    public static function validateServiceFeeTaxInfoForArrayConstraintFromSetServiceFeeTaxInfo(?array $values = []): string
    {
        ...
        foreach ($values as $serviceFeeInfoServiceFeeTaxInfoItem) {
            ...
            if (!$serviceFeeInfoServiceFeeTaxInfoItem instanceof \Travelport\Hotel\StructType\ServiceFeeTaxInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ServiceFeeTaxInfo property can only contain items of type \Travelport\Hotel\StructType\ServiceFeeTaxInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Hotel\StructType\ServiceFeeTaxInfo $item
     * @return \Travelport\Hotel\StructType\ServiceFeeInfo
     */
    public function addToServiceFeeTaxInfo(\Travelport\Hotel\StructType\ServiceFeeTaxInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Hotel\StructType\ServiceFeeTaxInfo) {
            throw new InvalidArgumentException(sprintf('The ServiceFeeTaxInfo property can only contain items of type \Travelport\Hotel\StructType\ServiceFeeTaxInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Hotel\StructType\CreditCardAuth|null
     */
    public function getCreditCardAuth(): ?\Travelport\Hotel\StructType\CreditCardAuth
    {
     ...
     * @return \Travelport\Hotel\StructType\ServiceFeeInfo
     */
    public function setCreditCardAuth(?\Travelport\Hotel\StructType\CreditCardAuth $creditCardAuth = null): self
    {
    ...
    /**
     * Get Payment value
     * @return \Travelport\Hotel\StructType\Payment|null
     */
    public function getPayment(): ?\Travelport\Hotel\StructType\Payment
    {
        return $this->Payment;
    }
    /**
     ...
     * @return \Travelport\Hotel\StructType\ServiceFeeInfo
     */
    public function setPayment(?\Travelport\Hotel\StructType\Payment $payment = null): self
    {
    ...
    /**
     * Set Status value
     * @uses \Travelport\Hotel\EnumType\TypeStatus::valueIsValid()
     * @uses \Travelport\Hotel\EnumType\TypeStatus::getValidValues()
     * @throws InvalidArgumentException
     * @param string $status
     * @return \Travelport\Hotel\StructType\ServiceFeeInfo
     */
    public function setStatus(?string $status = null): self
    {
        ...
        if (!\Travelport\Hotel\EnumType\TypeStatus::valueIsValid($status)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Hotel\EnumType\TypeStatus', is_array($status) ? implode(', ', $status) : var_export($status, true), implode(', ', \Travelport\Hotel\EnumType\TypeStatus::getValidValues())), __LINE__);
        }
        $this->Status = $status;
