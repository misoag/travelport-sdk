...
class TypePassengerType extends AbstractStructBase
{
     ...
     * @param \Travelport\Hotel\StructType\PersonalGeography $personalGeography
     * @param int $age
     * @param string $dOB
     * @param string $gender
     ...
     */
    public function __construct(string $code, ?\Travelport\Hotel\StructType\Name $name = null, ?array $loyaltyCard = null, ?array $discountCard = null, ?\Travelport\Hotel\StructType\PersonalGeography $personalGeography = null, ?int $age = null, ?string $dOB = null, ?string $gender = null, ?bool $pricePTCOnly = null, ?string $bookingTravelerRef = null, ?bool $accompaniedPassenger = false, ?string $residencyType = null)
    {
        $this
            ->setCode($code)
            ->setName($name)
     ...
     * @return \Travelport\Hotel\StructType\PersonalGeography|null
     */
    public function getPersonalGeography(): ?\Travelport\Hotel\StructType\PersonalGeography
    {
     ...
     * @return \Travelport\Hotel\StructType\TypePassengerType
     */
    public function setPersonalGeography(?\Travelport\Hotel\StructType\PersonalGeography $personalGeography = null): self
    {
