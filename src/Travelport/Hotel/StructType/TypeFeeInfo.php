...
class TypeFeeInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Hotel\StructType\TaxInfoRef[]
     */
     ...
     * @param string $amount
     * @param string $code
     * @param \Travelport\Hotel\StructType\TaxInfoRef[] $taxInfoRef
     ...
     */
    public function __construct(string $key, string $amount, string $code, ?array $taxInfoRef = null, ?\Travelport\Hotel\StructType\IncludedInBase $includedInBase = null, ?string $baseAmount = null, ?string $description = null, ?string $subCode = null, ?string $feeToken = null, ?string $paymentRef = null, ?string $bookingTravelerRef = null, ?string $passengerTypeCode = null, ?string $text = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setKey($key)
            ->setAmount($amount)
     ...
     * @return \Travelport\Hotel\StructType\TaxInfoRef[]
     */
    ...
    public static function validateTaxInfoRefForArrayConstraintFromSetTaxInfoRef(?array $values = []): string
    {
        ...
        foreach ($values as $typeFeeInfoTaxInfoRefItem) {
            ...
            if (!$typeFeeInfoTaxInfoRefItem instanceof \Travelport\Hotel\StructType\TaxInfoRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TaxInfoRef property can only contain items of type \Travelport\Hotel\StructType\TaxInfoRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Hotel\StructType\TaxInfoRef $item
     * @return \Travelport\Hotel\StructType\TypeFeeInfo
     */
    public function addToTaxInfoRef(\Travelport\Hotel\StructType\TaxInfoRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Hotel\StructType\TaxInfoRef) {
            throw new InvalidArgumentException(sprintf('The TaxInfoRef property can only contain items of type \Travelport\Hotel\StructType\TaxInfoRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
