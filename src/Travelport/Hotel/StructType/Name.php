 ...
 * - documentation: Name of the group in group booking. | The keyword name. | Name of Emergency Contact Person | Policy Name | Agent's role name | Complete name fields | The name as it appears on the card. | At least one character data in Next Result
 * Reference
 * - base: xs:string
 * - minLength: 1
 * - type: xs:string
...
class Name extends AbstractStructBase
{
     ...
     * Set First value
     * @param string $first
     * @return \Travelport\Hotel\StructType\Name
     */
