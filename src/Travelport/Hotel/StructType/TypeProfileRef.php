...
class TypeProfileRef extends AbstractStructBase
{
     ...
     * @param string $profileEntityID
     * @return \Travelport\Hotel\StructType\TypeProfileRef
     */
     ...
     * @uses \Travelport\Hotel\EnumType\TypeProfileLevel::valueIsValid()
     * @uses \Travelport\Hotel\EnumType\TypeProfileLevel::getValidValues()
    ...
    public function setProfileLevel(string $profileLevel): self
    {
        ...
        if (!\Travelport\Hotel\EnumType\TypeProfileLevel::valueIsValid($profileLevel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Hotel\EnumType\TypeProfileLevel', is_array($profileLevel) ? implode(', ', $profileLevel) : var_export($profileLevel, true), implode(', ', \Travelport\Hotel\EnumType\TypeProfileLevel::getValidValues())), __LINE__);
        }
