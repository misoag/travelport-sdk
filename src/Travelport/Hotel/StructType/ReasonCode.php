...
class ReasonCode extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $outOfPolicy = null, ?string $purposeOfTrip = null, ?\Travelport\Hotel\StructType\Remark $remark = null)
    {
        $this
     ...
     * @param string $outOfPolicy
     * @return \Travelport\Hotel\StructType\ReasonCode
     */
