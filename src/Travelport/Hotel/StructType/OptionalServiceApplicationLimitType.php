...
class OptionalServiceApplicationLimitType extends AbstractStructBase
{
    ...
    public function setApplicableLevel(string $applicableLevel): self
    {
        ...
        if (!\Travelport\Hotel\EnumType\OptionalServiceApplicabilityType::valueIsValid($applicableLevel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Hotel\EnumType\OptionalServiceApplicabilityType', is_array($applicableLevel) ? implode(', ', $applicableLevel) : var_export($applicableLevel, true), implode(', ', \Travelport\Hotel\EnumType\OptionalServiceApplicabilityType::getValidValues())), __LINE__);
        }
