...
class AirAvailInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: BookingCodeInfo
     * @var \Travelport\Util\StructType\BookingCodeInfo[]
     */
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\FareTokenInfo[]
     */
     ...
     * @param \Travelport\Util\StructType\BookingCodeInfo[] $bookingCodeInfo
     * @param \Travelport\Util\StructType\FareTokenInfo[] $fareTokenInfo
     ...
     * @return \Travelport\Util\StructType\BookingCodeInfo[]
     */
    ...
    public static function validateBookingCodeInfoForArrayConstraintsFromSetBookingCodeInfo(?array $values = []): string
    {
        ...
        foreach ($values as $airAvailInfoBookingCodeInfoItem) {
            ...
            if (!$airAvailInfoBookingCodeInfoItem instanceof \Travelport\Util\StructType\BookingCodeInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The BookingCodeInfo property can only contain items of type \Travelport\Util\StructType\BookingCodeInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\BookingCodeInfo $item
     * @return \Travelport\Util\StructType\AirAvailInfo
     */
    public function addToBookingCodeInfo(\Travelport\Util\StructType\BookingCodeInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\BookingCodeInfo) {
            throw new InvalidArgumentException(sprintf('The BookingCodeInfo property can only contain items of type \Travelport\Util\StructType\BookingCodeInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\FareTokenInfo[]
     */
    ...
    public static function validateFareTokenInfoForArrayConstraintsFromSetFareTokenInfo(?array $values = []): string
    {
        ...
        foreach ($values as $airAvailInfoFareTokenInfoItem) {
            // validation for constraint: itemType
            if (!$airAvailInfoFareTokenInfoItem instanceof \Travelport\Util\StructType\FareTokenInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FareTokenInfo property can only contain items of type \Travelport\Util\StructType\FareTokenInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\FareTokenInfo $item
     * @return \Travelport\Util\StructType\AirAvailInfo
     */
    public function addToFareTokenInfo(\Travelport\Util\StructType\FareTokenInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\FareTokenInfo) {
            throw new InvalidArgumentException(sprintf('The FareTokenInfo property can only contain items of type \Travelport\Util\StructType\FareTokenInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
