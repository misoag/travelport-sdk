...
class TypeProfileRef extends AbstractStructBase
{
     ...
     * @param string $profileEntityID
     * @return \Travelport\Util\StructType\TypeProfileRef
     */
     ...
     * @uses \Travelport\Util\EnumType\TypeProfileLevel::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypeProfileLevel::getValidValues()
    ...
    public function setProfileLevel(string $profileLevel): self
    {
        ...
        if (!\Travelport\Util\EnumType\TypeProfileLevel::valueIsValid($profileLevel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeProfileLevel', is_array($profileLevel) ? implode(', ', $profileLevel) : var_export($profileLevel, true), implode(', ', \Travelport\Util\EnumType\TypeProfileLevel::getValidValues())), __LINE__);
        }
