...
class TravelerInformation extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\EmergencyContact|null
     */
    protected ?\Travelport\Util\StructType\EmergencyContact $EmergencyContact = null;
    /**
     * The HomeAirport
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\Util\StructType\EmergencyContact $emergencyContact
     * @param string $homeAirport
     * @param string $visaExpirationDate
     */
    public function __construct(string $bookingTravelerRef, ?\Travelport\Util\StructType\EmergencyContact $emergencyContact = null, ?string $homeAirport = null, ?string $visaExpirationDate = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\EmergencyContact|null
     */
    public function getEmergencyContact(): ?\Travelport\Util\StructType\EmergencyContact
    {
     ...
     * @return \Travelport\Util\StructType\TravelerInformation
     */
    public function setEmergencyContact(?\Travelport\Util\StructType\EmergencyContact $emergencyContact = null): self
    {
