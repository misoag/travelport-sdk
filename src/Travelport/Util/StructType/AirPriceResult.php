...
class AirPriceResult extends AbstractStructBase
{
     ...
     * @var \Travelport\Util\StructType\AirPricingSolution[]
     */
     ...
     * - minOccurs: 0
     * - ref: FareRule
     * @var \Travelport\Util\StructType\FareRule[]
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\TypeResultMessage|null
     */
    protected ?\Travelport\Util\StructType\TypeResultMessage $AirPriceError = null;
    /**
     * The CommandKey
     * Meta information extracted from the WSDL
     * - base: xs:string
     ...
     * @param \Travelport\Util\StructType\FareRule[] $fareRule
     * @param \Travelport\Util\StructType\TypeResultMessage $airPriceError
     * @param string $commandKey
     */
    public function __construct(?array $airPricingSolution = null, ?array $fareRule = null, ?\Travelport\Util\StructType\TypeResultMessage $airPriceError = null, ?string $commandKey = null)
    {
        $this
    ...
    public static function validateAirPricingSolutionForArrayConstraintFromSetAirPricingSolution(?array $values = []): string
    {
        ...
        foreach ($values as $airPriceResultAirPricingSolutionItem) {
            ...
            if (!$airPriceResultAirPricingSolutionItem instanceof \Travelport\Util\StructType\AirPricingSolution) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AirPricingSolution property can only contain items of type \Travelport\Util\StructType\AirPricingSolution, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Travelport\Util\StructType\AirPricingSolution[] $airPricingSolution
     * @return \Travelport\Util\StructType\AirPriceResult
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\AirPricingSolution $item
     * @return \Travelport\Util\StructType\AirPriceResult
     */
    public function addToAirPricingSolution(\Travelport\Util\StructType\AirPricingSolution $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\AirPricingSolution) {
            throw new InvalidArgumentException(sprintf('The AirPricingSolution property can only contain items of type \Travelport\Util\StructType\AirPricingSolution, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(99)
    ...
    public static function validateFareRuleForArrayConstraintFromSetFareRule(?array $values = []): string
    {
        ...
        foreach ($values as $airPriceResultFareRuleItem) {
            // validation for constraint: itemType
            if (!$airPriceResultFareRuleItem instanceof \Travelport\Util\StructType\FareRule) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FareRule property can only contain items of type \Travelport\Util\StructType\FareRule, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\FareRule $item
     * @return \Travelport\Util\StructType\AirPriceResult
     */
    public function addToFareRule(\Travelport\Util\StructType\FareRule $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\FareRule) {
            throw new InvalidArgumentException(sprintf('The FareRule property can only contain items of type \Travelport\Util\StructType\FareRule, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\TypeResultMessage|null
     */
    public function getAirPriceError(): ?\Travelport\Util\StructType\TypeResultMessage
    {
     ...
     * @return \Travelport\Util\StructType\AirPriceResult
     */
    public function setAirPriceError(?\Travelport\Util\StructType\TypeResultMessage $airPriceError = null): self
    {
