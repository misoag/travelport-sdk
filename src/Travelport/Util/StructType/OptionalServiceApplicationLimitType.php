...
class OptionalServiceApplicationLimitType extends AbstractStructBase
{
    ...
    public function setApplicableLevel(string $applicableLevel): self
    {
        ...
        if (!\Travelport\Util\EnumType\OptionalServiceApplicabilityType::valueIsValid($applicableLevel)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\OptionalServiceApplicabilityType', is_array($applicableLevel) ? implode(', ', $applicableLevel) : var_export($applicableLevel, true), implode(', ', \Travelport\Util\EnumType\OptionalServiceApplicabilityType::getValidValues())), __LINE__);
        }
