 ...
 * - documentation: This is the container to specify all permitted connection points. Applicable for 1G/1V/1P/1J.
 * @subpackage Structs
 */
class PermittedConnectionPoints extends AbstractStructBase
{
    ...
    public static function validateConnectionPointForArrayConstraintsFromSetConnectionPoint(?array $values = []): string
    {
        ...
        foreach ($values as $permittedConnectionPointsConnectionPointItem) {
            ...
            if (!$permittedConnectionPointsConnectionPointItem instanceof \Travelport\Util\StructType\TypeLocation) {
     ...
     * @param \Travelport\Util\StructType\TypeLocation[] $connectionPoint
     * @return \Travelport\Util\StructType\PermittedConnectionPoints
     */
