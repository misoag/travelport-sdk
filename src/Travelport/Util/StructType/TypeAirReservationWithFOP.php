...
class TypeAirReservationWithFOP extends TypeBaseAirReservation
{
    ...
    public static function validateFormOfPaymentForArrayConstraintFromSetFormOfPayment(?array $values = []): string
    {
        ...
        foreach ($values as $typeAirReservationWithFOPFormOfPaymentItem) {
            ...
            if (!$typeAirReservationWithFOPFormOfPaymentItem instanceof \Travelport\Util\StructType\FormOfPayment) {
     ...
     * @param \Travelport\Util\StructType\FormOfPayment[] $formOfPayment
     * @return \Travelport\Util\StructType\TypeAirReservationWithFOP
     */
