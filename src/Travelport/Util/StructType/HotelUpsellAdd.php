...
/**
 * This class stands for HotelUpsellAdd StructType
 * Meta information extracted from the WSDL
 * - documentation: Add command for adding HotelUpsellQualify,HotelUpsellOffer
 * @subpackage Structs
 */
class HotelUpsellAdd extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for HotelUpsellAdd
     * @uses HotelUpsellAdd::setHotelUpsellQualify()
     * @uses HotelUpsellAdd::setHotelUpsellOffer()
