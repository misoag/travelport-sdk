...
/**
 * This class stands for HotelUpsellUpdate StructType
 * Meta information extracted from the WSDL
 * - documentation: Update command for updating HotelUpsellQualify,HotelUpsellOffer
 * @subpackage Structs
 */
class HotelUpsellUpdate extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for HotelUpsellUpdate
     * @uses HotelUpsellUpdate::setHotelUpsellQualify()
     * @uses HotelUpsellUpdate::setHotelUpsellOffer()
