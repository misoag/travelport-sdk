...
class AccountInformation extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Travelport\Util\StructType\TypeStructuredAddress $address = null, ?array $phoneNumber = null, ?string $accountName = null)
    {
        $this
            ->setAddress($address)
     ...
     * Set Address value
     * @param \Travelport\Util\StructType\TypeStructuredAddress $address
     * @return \Travelport\Util\StructType\AccountInformation
     */
    ...
    public static function validatePhoneNumberForArrayConstraintFromSetPhoneNumber(?array $values = []): string
    {
        ...
        foreach ($values as $accountInformationPhoneNumberItem) {
            ...
            if (!$accountInformationPhoneNumberItem instanceof \Travelport\Util\StructType\PhoneNumber) {
