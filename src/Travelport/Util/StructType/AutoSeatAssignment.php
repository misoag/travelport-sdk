...
class AutoSeatAssignment extends AbstractStructBase
{
    ...
    /**
     * Set SeatType value
     * @uses \Travelport\Util\EnumType\TypeReqSeat::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypeReqSeat::getValidValues()
     * @throws InvalidArgumentException
     * @param string $seatType
     * @return \Travelport\Util\StructType\AutoSeatAssignment
     */
    public function setSeatType(string $seatType): self
    {
        // validation for constraint: enumeration
        if (!\Travelport\Util\EnumType\TypeReqSeat::valueIsValid($seatType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeReqSeat', is_array($seatType) ? implode(', ', $seatType) : var_export($seatType, true), implode(', ', \Travelport\Util\EnumType\TypeReqSeat::getValidValues())), __LINE__);
        }
