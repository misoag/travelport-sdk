...
class TravelComplianceData extends AbstractStructBase
{
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\PolicyCompliance[]
     */
     ...
     * - maxOccurs: 2
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\ContractCompliance[]
     */
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\PreferredSupplier[]
     */
     ...
     * @param \Travelport\Util\StructType\PolicyCompliance[] $policyCompliance
     * @param \Travelport\Util\StructType\ContractCompliance[] $contractCompliance
     * @param \Travelport\Util\StructType\PreferredSupplier[] $preferredSupplier
     * @param string $key
    ...
    public static function validatePolicyComplianceForArrayConstraintsFromSetPolicyCompliance(?array $values = []): string
    {
        ...
        foreach ($values as $travelComplianceDataPolicyComplianceItem) {
            ...
            if (!$travelComplianceDataPolicyComplianceItem instanceof \Travelport\Util\StructType\PolicyCompliance) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PolicyCompliance property can only contain items of type \Travelport\Util\StructType\PolicyCompliance, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Travelport\Util\StructType\PolicyCompliance[] $policyCompliance
     * @return \Travelport\Util\StructType\TravelComplianceData
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\PolicyCompliance $item
     * @return \Travelport\Util\StructType\TravelComplianceData
     */
    public function addToPolicyCompliance(\Travelport\Util\StructType\PolicyCompliance $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\PolicyCompliance) {
            throw new InvalidArgumentException(sprintf('The PolicyCompliance property can only contain items of type \Travelport\Util\StructType\PolicyCompliance, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(2)
     ...
     * @return \Travelport\Util\StructType\ContractCompliance[]
     */
    ...
    public static function validateContractComplianceForArrayConstraintsFromSetContractCompliance(?array $values = []): string
    {
        ...
        foreach ($values as $travelComplianceDataContractComplianceItem) {
            // validation for constraint: itemType
            if (!$travelComplianceDataContractComplianceItem instanceof \Travelport\Util\StructType\ContractCompliance) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ContractCompliance property can only contain items of type \Travelport\Util\StructType\ContractCompliance, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\ContractCompliance $item
     * @return \Travelport\Util\StructType\TravelComplianceData
     */
    public function addToContractCompliance(\Travelport\Util\StructType\ContractCompliance $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\ContractCompliance) {
            throw new InvalidArgumentException(sprintf('The ContractCompliance property can only contain items of type \Travelport\Util\StructType\ContractCompliance, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(2)
     ...
     * @return \Travelport\Util\StructType\PreferredSupplier[]
     */
    ...
    public static function validatePreferredSupplierForArrayConstraintsFromSetPreferredSupplier(?array $values = []): string
    {
        ...
        foreach ($values as $travelComplianceDataPreferredSupplierItem) {
            // validation for constraint: itemType
            if (!$travelComplianceDataPreferredSupplierItem instanceof \Travelport\Util\StructType\PreferredSupplier) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PreferredSupplier property can only contain items of type \Travelport\Util\StructType\PreferredSupplier, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\PreferredSupplier $item
     * @return \Travelport\Util\StructType\TravelComplianceData
     */
    public function addToPreferredSupplier(\Travelport\Util\StructType\PreferredSupplier $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\PreferredSupplier) {
            throw new InvalidArgumentException(sprintf('The PreferredSupplier property can only contain items of type \Travelport\Util\StructType\PreferredSupplier, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
