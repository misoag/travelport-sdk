...
class FareInfo extends AbstractStructBase
{
     ...
     * @var \Travelport\Util\StructType\FareTicketDesignator[]
     */
     ...
     * - minOccurs: 0
     * - ref: TicketingCode
     * @var \Travelport\Util\StructType\TicketingCode[]
     */
     ...
     * - minOccurs: 0
     * - ref: FareSurcharge
     * @var \Travelport\Util\StructType\FareSurcharge[]
     */
     ...
     * @var \Travelport\Util\StructType\BaggageAllowance|null
     */
    protected ?\Travelport\Util\StructType\BaggageAllowance $BaggageAllowance = null;
    /**
     * The FareRuleKey
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: FareRuleKey
     * @var \Travelport\Util\StructType\FareRuleKey|null
     */
    protected ?\Travelport\Util\StructType\FareRuleKey $FareRuleKey = null;
    /**
     ...
     * - minOccurs: 0
     * - ref: FareRemarkRef
     * @var \Travelport\Util\StructType\FareRemarkRef[]
     */
     ...
     * - minOccurs: 0
     * - ref: Brand
     * @var \Travelport\Util\StructType\Brand|null
     */
    protected ?\Travelport\Util\StructType\Brand $Brand = null;
    /**
     * The Commission
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     */
    protected ?\Travelport\Util\StructType\TypeFarePenalty $ChangePenalty = null;
    /**
     * The CancelPenalty
     * Meta information extracted from the WSDL
     ...
     * @var \Travelport\Util\StructType\TypeFarePenalty|null
     */
    protected ?\Travelport\Util\StructType\TypeFarePenalty $CancelPenalty = null;
    /**
     * The FareRulesFilter
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \Travelport\Util\StructType\TicketingCode[] $ticketingCode
     * @param \Travelport\Util\StructType\FareSurcharge[] $fareSurcharge
     ...
     * @param \Travelport\Util\StructType\BaggageAllowance $baggageAllowance
     * @param \Travelport\Util\StructType\FareRuleKey $fareRuleKey
     * @param \Travelport\Util\StructType\FareRuleFailureInfo $fareRuleFailureInfo
     * @param \Travelport\Util\StructType\FareRemarkRef[] $fareRemarkRef
     * @param \Travelport\Util\StructType\Brand $brand
     ...
     */
    public function __construct(string $key, string $fareBasis, string $passengerTypeCode, string $origin, string $destination, string $effectiveDate, ?array $fareTicketDesignator = null, ?array $ticketingCode = null, ?array $fareSurcharge = null, ?array $accountCode = null, ?array $contractCode = null, ?array $endorsement = null, ?\Travelport\Util\StructType\BaggageAllowance $baggageAllowance = null, ?\Travelport\Util\StructType\FareRuleKey $fareRuleKey = null, ?\Travelport\Util\StructType\FareRuleFailureInfo $fareRuleFailureInfo = null, ?array $fareRemarkRef = null, ?\Travelport\Util\StructType\Brand $brand = null, ?\Travelport\Util\StructType\Commission $commission = null, ?string $fareAttributes = null, ?\Travelport\Util\StructType\TypeFarePenalty $changePenalty = null, ?\Travelport\Util\StructType\TypeFarePenalty $cancelPenalty = null, ?\Travelport\Util\StructType\FareRulesFilter $fareRulesFilter = null, ?string $travelDate = null, ?string $departureDate = null, ?string $amount = null, ?string $privateFare = null, ?bool $negotiatedFare = null, ?string $tourCode = null, ?string $waiverCode = null, ?string $notValidBefore = null, ?string $notValidAfter = null, ?string $pseudoCityCode = null, ?string $fareFamily = null, ?bool $promotionalFare = null, ?string $carCode = null, ?string $valueCode = null, ?bool $bulkTicket = null, ?bool $inclusiveTour = null, ?string $value = null, ?string $supplierCode = null, ?string $taxAmount = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setKey($key)
    ...
    public static function validateFareTicketDesignatorForArrayConstraintFromSetFareTicketDesignator(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoFareTicketDesignatorItem) {
            ...
            if (!$fareInfoFareTicketDesignatorItem instanceof \Travelport\Util\StructType\FareTicketDesignator) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FareTicketDesignator property can only contain items of type \Travelport\Util\StructType\FareTicketDesignator, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\FareTicketDesignator $item
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function addToFareTicketDesignator(\Travelport\Util\StructType\FareTicketDesignator $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\FareTicketDesignator) {
            throw new InvalidArgumentException(sprintf('The FareTicketDesignator property can only contain items of type \Travelport\Util\StructType\FareTicketDesignator, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateTicketingCodeForArrayConstraintFromSetTicketingCode(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoTicketingCodeItem) {
            // validation for constraint: itemType
            if (!$fareInfoTicketingCodeItem instanceof \Travelport\Util\StructType\TicketingCode) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TicketingCode property can only contain items of type \Travelport\Util\StructType\TicketingCode, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\TicketingCode $item
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function addToTicketingCode(\Travelport\Util\StructType\TicketingCode $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\TicketingCode) {
            throw new InvalidArgumentException(sprintf('The TicketingCode property can only contain items of type \Travelport\Util\StructType\TicketingCode, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateFareSurchargeForArrayConstraintFromSetFareSurcharge(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoFareSurchargeItem) {
            // validation for constraint: itemType
            if (!$fareInfoFareSurchargeItem instanceof \Travelport\Util\StructType\FareSurcharge) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FareSurcharge property can only contain items of type \Travelport\Util\StructType\FareSurcharge, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\FareSurcharge $item
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function addToFareSurcharge(\Travelport\Util\StructType\FareSurcharge $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\FareSurcharge) {
            throw new InvalidArgumentException(sprintf('The FareSurcharge property can only contain items of type \Travelport\Util\StructType\FareSurcharge, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateAccountCodeForArrayConstraintFromSetAccountCode(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoAccountCodeItem) {
            // validation for constraint: itemType
            if (!$fareInfoAccountCodeItem instanceof \Travelport\Util\StructType\AccountCode) {
    ...
    public static function validateContractCodeForArrayConstraintFromSetContractCode(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoContractCodeItem) {
            // validation for constraint: itemType
            if (!$fareInfoContractCodeItem instanceof \Travelport\Util\StructType\ContractCode) {
    ...
    public static function validateEndorsementForArrayConstraintFromSetEndorsement(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoEndorsementItem) {
            // validation for constraint: itemType
            if (!$fareInfoEndorsementItem instanceof \Travelport\Util\StructType\Endorsement) {
     ...
     * @return \Travelport\Util\StructType\BaggageAllowance|null
     */
    public function getBaggageAllowance(): ?\Travelport\Util\StructType\BaggageAllowance
    {
     ...
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function setBaggageAllowance(?\Travelport\Util\StructType\BaggageAllowance $baggageAllowance = null): self
    {
     ...
     * @return \Travelport\Util\StructType\FareRuleKey|null
     */
    public function getFareRuleKey(): ?\Travelport\Util\StructType\FareRuleKey
    {
     ...
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function setFareRuleKey(?\Travelport\Util\StructType\FareRuleKey $fareRuleKey = null): self
    {
     ...
     * @return \Travelport\Util\StructType\FareRemarkRef[]
     */
    ...
    public static function validateFareRemarkRefForArrayConstraintFromSetFareRemarkRef(?array $values = []): string
    {
        ...
        foreach ($values as $fareInfoFareRemarkRefItem) {
            // validation for constraint: itemType
            if (!$fareInfoFareRemarkRefItem instanceof \Travelport\Util\StructType\FareRemarkRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FareRemarkRef property can only contain items of type \Travelport\Util\StructType\FareRemarkRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\FareRemarkRef $item
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function addToFareRemarkRef(\Travelport\Util\StructType\FareRemarkRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\FareRemarkRef) {
            throw new InvalidArgumentException(sprintf('The FareRemarkRef property can only contain items of type \Travelport\Util\StructType\FareRemarkRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    /**
     * Get Brand value
     * @return \Travelport\Util\StructType\Brand|null
     */
    public function getBrand(): ?\Travelport\Util\StructType\Brand
    {
        return $this->Brand;
    }
    /**
     ...
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function setBrand(?\Travelport\Util\StructType\Brand $brand = null): self
    {
        $this->Brand = $brand;
     ...
     */
    public function getChangePenalty(): ?\Travelport\Util\StructType\TypeFarePenalty
    {
     ...
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function setChangePenalty(?\Travelport\Util\StructType\TypeFarePenalty $changePenalty = null): self
    {
     ...
     * @return \Travelport\Util\StructType\TypeFarePenalty|null
     */
    public function getCancelPenalty(): ?\Travelport\Util\StructType\TypeFarePenalty
    {
     ...
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function setCancelPenalty(?\Travelport\Util\StructType\TypeFarePenalty $cancelPenalty = null): self
    {
     ...
     * @uses \Travelport\Util\EnumType\TypePrivateFare::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypePrivateFare::getValidValues()
     * @throws InvalidArgumentException
     * @param string $privateFare
     * @return \Travelport\Util\StructType\FareInfo
     */
    public function setPrivateFare(?string $privateFare = null): self
    {
        ...
        if (!\Travelport\Util\EnumType\TypePrivateFare::valueIsValid($privateFare)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypePrivateFare', is_array($privateFare) ? implode(', ', $privateFare) : var_export($privateFare, true), implode(', ', \Travelport\Util\EnumType\TypePrivateFare::getValidValues())), __LINE__);
        }
