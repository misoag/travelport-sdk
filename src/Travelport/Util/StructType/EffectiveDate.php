...
/**
 * This class stands for EffectiveDate StructType
 * Meta information extracted from the WSDL
 * - documentation: Effective Date range. For specific date usage set both limits to same value.
 * @subpackage Structs
 */
class EffectiveDate extends AbstractStructBase
{
    /**
     * The EarliestDate
     * Meta information extracted from the WSDL
     * - documentation: Earliest date of the Effective date | Date without time zones YYYY-MM-DD
     * - base: xs:date
     * - pattern: [^:Z].*
     * - use: required
     * @var string
     ...
     * The LatestDate
     * Meta information extracted from the WSDL
     * - documentation: Latest date of the Effective date | Date without time zones YYYY-MM-DD
     * - base: xs:date
     * - default: 9999-12-31
     * - pattern: [^:Z].*
     * @var string|null
    ...
    /**
     * Constructor method for EffectiveDate
     * @uses EffectiveDate::setEarliestDate()
     * @uses EffectiveDate::setLatestDate()
     ...
     * @param string $earliestDate
     * @return \Travelport\Util\StructType\EffectiveDate
     */
