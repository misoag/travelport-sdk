...
class APISRequirementsList extends AbstractStructBase
{
    ...
    public static function validateAPISRequirementsForArrayConstraintFromSetAPISRequirements(?array $values = []): string
    {
        ...
        foreach ($values as $aPISRequirementsListAPISRequirementsItem) {
            ...
            if (!$aPISRequirementsListAPISRequirementsItem instanceof \Travelport\Util\StructType\APISRequirements) {
     ...
     * @param \Travelport\Util\StructType\APISRequirements[] $aPISRequirements
     * @return \Travelport\Util\StructType\APISRequirementsList
     */
