...
class BookingTravelerRef extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: LoyaltyCardRef
     * @var \Travelport\Util\StructType\LoyaltyCardRef[]
     */
     ...
     * @var \Travelport\Util\StructType\DriversLicenseRef|null
     */
    protected ?\Travelport\Util\StructType\DriversLicenseRef $DriversLicenseRef = null;
    /**
     * The DiscountCardRef
     * Meta information extracted from the WSDL
     * - maxOccurs: 9
     * - minOccurs: 0
     * - ref: DiscountCardRef
     * @var \Travelport\Util\StructType\DiscountCardRef[]
     */
     ...
     * @param \Travelport\Util\StructType\LoyaltyCardRef[] $loyaltyCardRef
     * @param \Travelport\Util\StructType\DriversLicenseRef $driversLicenseRef
     * @param \Travelport\Util\StructType\DiscountCardRef[] $discountCardRef
     * @param \Travelport\Util\StructType\PaymentRef[] $paymentRef
     * @param string $key
     */
    public function __construct(?array $loyaltyCardRef = null, ?\Travelport\Util\StructType\DriversLicenseRef $driversLicenseRef = null, ?array $discountCardRef = null, ?array $paymentRef = null, ?string $key = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\LoyaltyCardRef[]
     */
    ...
    public static function validateLoyaltyCardRefForArrayConstraintFromSetLoyaltyCardRef(?array $values = []): string
    {
        ...
        foreach ($values as $bookingTravelerRefLoyaltyCardRefItem) {
            ...
            if (!$bookingTravelerRefLoyaltyCardRefItem instanceof \Travelport\Util\StructType\LoyaltyCardRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The LoyaltyCardRef property can only contain items of type \Travelport\Util\StructType\LoyaltyCardRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\LoyaltyCardRef $item
     * @return \Travelport\Util\StructType\BookingTravelerRef
     */
    public function addToLoyaltyCardRef(\Travelport\Util\StructType\LoyaltyCardRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\LoyaltyCardRef) {
            throw new InvalidArgumentException(sprintf('The LoyaltyCardRef property can only contain items of type \Travelport\Util\StructType\LoyaltyCardRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\DriversLicenseRef|null
     */
    public function getDriversLicenseRef(): ?\Travelport\Util\StructType\DriversLicenseRef
    {
     ...
     * @return \Travelport\Util\StructType\BookingTravelerRef
     */
    public function setDriversLicenseRef(?\Travelport\Util\StructType\DriversLicenseRef $driversLicenseRef = null): self
    {
     ...
     * @return \Travelport\Util\StructType\DiscountCardRef[]
     */
    ...
    public static function validateDiscountCardRefForArrayConstraintFromSetDiscountCardRef(?array $values = []): string
    {
        ...
        foreach ($values as $bookingTravelerRefDiscountCardRefItem) {
            // validation for constraint: itemType
            if (!$bookingTravelerRefDiscountCardRefItem instanceof \Travelport\Util\StructType\DiscountCardRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The DiscountCardRef property can only contain items of type \Travelport\Util\StructType\DiscountCardRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\DiscountCardRef $item
     * @return \Travelport\Util\StructType\BookingTravelerRef
     */
    public function addToDiscountCardRef(\Travelport\Util\StructType\DiscountCardRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\DiscountCardRef) {
            throw new InvalidArgumentException(sprintf('The DiscountCardRef property can only contain items of type \Travelport\Util\StructType\DiscountCardRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(9)
    ...
    public static function validatePaymentRefForArrayConstraintFromSetPaymentRef(?array $values = []): string
    {
        ...
        foreach ($values as $bookingTravelerRefPaymentRefItem) {
            // validation for constraint: itemType
            if (!$bookingTravelerRefPaymentRefItem instanceof \Travelport\Util\StructType\PaymentRef) {
