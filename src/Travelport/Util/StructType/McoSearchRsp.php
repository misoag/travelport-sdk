...
class McoSearchRsp extends BaseRsp
{
    ...
    /**
     * This method is responsible for validating the value(s) passed to the setMcoSearchResult method
     ...
     */
    public static function validateMcoSearchResultForArrayConstraintFromSetMcoSearchResult(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
    ...
    public function setMcoSearchResult(?array $mcoSearchResult = null): self
    {
        ...
        if ('' !== ($mcoSearchResultArrayErrorMessage = self::validateMcoSearchResultForArrayConstraintFromSetMcoSearchResult($mcoSearchResult))) {
