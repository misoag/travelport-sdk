...
class TypeStructuredAddress extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: State
     * @var \Travelport\Util\StructType\State|null
     */
    protected ?\Travelport\Util\StructType\State $State = null;
    /**
     * The PostalCode
     * Meta information extracted from the WSDL
     ...
     */
    public function __construct(?string $addressName = null, ?array $street = null, ?string $city = null, ?\Travelport\Util\StructType\State $state = null, ?string $postalCode = null, ?string $country = null, ?array $providerReservationInfoRef = null, ?string $key = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     */
    public function getState(): ?\Travelport\Util\StructType\State
    {
        return $this->State;
    }
    /**
     ...
     * @return \Travelport\Util\StructType\TypeStructuredAddress
     */
    public function setState(?\Travelport\Util\StructType\State $state = null): self
    {
        $this->State = $state;
    ...
    public static function validateProviderReservationInfoRefForArrayConstraintsFromSetProviderReservationInfoRef(?array $values = []): string
    {
        ...
        foreach ($values as $typeStructuredAddressProviderReservationInfoRefItem) {
            // validation for constraint: itemType
            if (!$typeStructuredAddressProviderReservationInfoRefItem instanceof \Travelport\Util\StructType\ProviderReservationInfoRef) {
