...
class TypeRateDescription extends AbstractStructBase
{
     ...
     * - documentation: Type of Text, Eg-'Upsell','Marketing Agent','Marketing Consumer','Strapline','Rule'.
     * - base: xs:string
     * - maxOccurs: 999
     * - type: typeTextElement
     * @var string[]
     */
     ...
     * @param string[] $text
     * @return \Travelport\Util\StructType\TypeRateDescription
     */
