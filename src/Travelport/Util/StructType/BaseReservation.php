...
class BaseReservation extends AbstractStructBase
{
     ...
     */
    public function __construct(string $locatorCode, string $createDate, string $modifiedDate, ?array $accountingRemark = null, ?array $generalRemark = null, ?array $restriction = null, ?\Travelport\Util\StructType\PassiveInfo $passiveInfo = null, ?string $customerNumber = null)
    {
        $this
     ...
     * @param string $locatorCode
     * @return \Travelport\Util\StructType\BaseReservation
     */
    ...
    public static function validateAccountingRemarkForArrayConstraintFromSetAccountingRemark(?array $values = []): string
    {
        ...
        foreach ($values as $baseReservationAccountingRemarkItem) {
            ...
            if (!$baseReservationAccountingRemarkItem instanceof \Travelport\Util\StructType\AccountingRemark) {
    ...
    public static function validateGeneralRemarkForArrayConstraintFromSetGeneralRemark(?array $values = []): string
    {
        ...
        foreach ($values as $baseReservationGeneralRemarkItem) {
            // validation for constraint: itemType
            if (!$baseReservationGeneralRemarkItem instanceof \Travelport\Util\StructType\GeneralRemark) {
    ...
    public static function validateRestrictionForArrayConstraintFromSetRestriction(?array $values = []): string
    {
        ...
        foreach ($values as $baseReservationRestrictionItem) {
            // validation for constraint: itemType
            if (!$baseReservationRestrictionItem instanceof \Travelport\Util\StructType\Restriction) {
