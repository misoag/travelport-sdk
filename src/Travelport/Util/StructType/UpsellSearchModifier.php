...
/**
 * This class stands for UpsellSearchModifier StructType
 * Meta information extracted from the WSDL
 * - documentation: Upsell search modifier to hold values for start and max results
 * @subpackage Structs
 */
class UpsellSearchModifier extends AbstractStructBase
{
    /**
     * The MaxResults
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for UpsellSearchModifier
     * @uses UpsellSearchModifier::setMaxResults()
     * @uses UpsellSearchModifier::setStartFromResult()
     ...
     * @param int $maxResults
     * @return \Travelport\Util\StructType\UpsellSearchModifier
     */
