...
class SegmentModifiers extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - ref: AirSegmentRef
     * @var \Travelport\Util\StructType\AirSegmentRef|null
     */
    protected ?\Travelport\Util\StructType\AirSegmentRef $AirSegmentRef = null;
    /**
     * The TicketValidity
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: TicketValidity
     * @var \Travelport\Util\StructType\TicketValidity|null
     */
    protected ?\Travelport\Util\StructType\TicketValidity $TicketValidity = null;
    /**
     ...
     * @param \Travelport\Util\StructType\TicketValidity $ticketValidity
     * @param \Travelport\Util\StructType\BaggageAllowance $baggageAllowance
     * @param string $ticketDesignator
     */
    public function __construct(?\Travelport\Util\StructType\AirSegmentRef $airSegmentRef = null, ?\Travelport\Util\StructType\TicketValidity $ticketValidity = null, ?\Travelport\Util\StructType\BaggageAllowance $baggageAllowance = null, ?string $ticketDesignator = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\AirSegmentRef|null
     */
    public function getAirSegmentRef(): ?\Travelport\Util\StructType\AirSegmentRef
    {
     ...
     */
    public function setAirSegmentRef(?\Travelport\Util\StructType\AirSegmentRef $airSegmentRef = null): self
    {
     ...
     * @return \Travelport\Util\StructType\TicketValidity|null
     */
    public function getTicketValidity(): ?\Travelport\Util\StructType\TicketValidity
    {
     ...
     * @return \Travelport\Util\StructType\SegmentModifiers
     */
    public function setTicketValidity(?\Travelport\Util\StructType\TicketValidity $ticketValidity = null): self
    {
