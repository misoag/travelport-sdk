...
class TypeFeeInfo extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\TaxInfoRef[]
     */
     ...
     * @param string $amount
     * @param string $code
     * @param \Travelport\Util\StructType\TaxInfoRef[] $taxInfoRef
     ...
     */
    public function __construct(string $key, string $amount, string $code, ?array $taxInfoRef = null, ?\Travelport\Util\StructType\IncludedInBase $includedInBase = null, ?string $baseAmount = null, ?string $description = null, ?string $subCode = null, ?string $feeToken = null, ?string $paymentRef = null, ?string $bookingTravelerRef = null, ?string $passengerTypeCode = null, ?string $text = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setKey($key)
            ->setAmount($amount)
     ...
     * @return \Travelport\Util\StructType\TaxInfoRef[]
     */
    ...
    public static function validateTaxInfoRefForArrayConstraintFromSetTaxInfoRef(?array $values = []): string
    {
        ...
        foreach ($values as $typeFeeInfoTaxInfoRefItem) {
            ...
            if (!$typeFeeInfoTaxInfoRefItem instanceof \Travelport\Util\StructType\TaxInfoRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TaxInfoRef property can only contain items of type \Travelport\Util\StructType\TaxInfoRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\TaxInfoRef $item
     * @return \Travelport\Util\StructType\TypeFeeInfo
     */
    public function addToTaxInfoRef(\Travelport\Util\StructType\TaxInfoRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\TaxInfoRef) {
            throw new InvalidArgumentException(sprintf('The TaxInfoRef property can only contain items of type \Travelport\Util\StructType\TaxInfoRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
