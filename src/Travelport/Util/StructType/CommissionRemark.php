...
class CommissionRemark extends AbstractStructBase
{
     ...
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * @var \Travelport\Util\StructType\ProviderReservationLevel|null
     */
    protected ?\Travelport\Util\StructType\ProviderReservationLevel $ProviderReservationLevel = null;
    /**
     ...
     * - choiceMinOccurs: 1
     * - maxOccurs: 4
     * @var \Travelport\Util\StructType\PassengerTypeLevel[]
     */
     ...
     * @param \Travelport\Util\StructType\ProviderReservationLevel $providerReservationLevel
     * @param \Travelport\Util\StructType\PassengerTypeLevel[] $passengerTypeLevel
     * @param string $key
     ...
     */
    public function __construct(?\Travelport\Util\StructType\ProviderReservationLevel $providerReservationLevel = null, ?array $passengerTypeLevel = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?string $providerCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\ProviderReservationLevel|null
     */
     ...
     * @param \Travelport\Util\StructType\ProviderReservationLevel $providerReservationLevel
     * @return \Travelport\Util\StructType\CommissionRemark
     */
    ...
    public static function validatePassengerTypeLevelForArrayConstraintFromSetPassengerTypeLevel(?array $values = []): string
    {
        ...
        foreach ($values as $commissionRemarkPassengerTypeLevelItem) {
            ...
            if (!$commissionRemarkPassengerTypeLevelItem instanceof \Travelport\Util\StructType\PassengerTypeLevel) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PassengerTypeLevel property can only contain items of type \Travelport\Util\StructType\PassengerTypeLevel, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\PassengerTypeLevel $item
     * @return \Travelport\Util\StructType\CommissionRemark
     */
    public function addToPassengerTypeLevel(\Travelport\Util\StructType\PassengerTypeLevel $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\PassengerTypeLevel) {
