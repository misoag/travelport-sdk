...
class HostTokenList extends AbstractStructBase
{
     ...
     * - maxOccurs: 999
     * - minOccurs: 1
     * - ref: HostToken | common:HostToken
    ...
    public static function validateHostTokenForArrayConstraintFromSetHostToken(?array $values = []): string
    {
        ...
        foreach ($values as $hostTokenListHostTokenItem) {
            ...
            if (!$hostTokenListHostTokenItem instanceof \Travelport\Util\StructType\HostToken) {
     ...
     * @param \Travelport\Util\StructType\HostToken[] $hostToken
     * @return \Travelport\Util\StructType\HostTokenList
     */
