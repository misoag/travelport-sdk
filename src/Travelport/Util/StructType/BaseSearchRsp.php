...
class BaseSearchRsp extends BaseRsp
{
    ...
    public static function validateNextResultReferenceForArrayConstraintFromSetNextResultReference(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $baseSearchRspNextResultReferenceItem) {
            // validation for constraint: itemType
            if (!$baseSearchRspNextResultReferenceItem instanceof \Travelport\Util\StructType\NextResultReference) {
                $invalidValues[] = is_object($baseSearchRspNextResultReferenceItem) ? get_class($baseSearchRspNextResultReferenceItem) : sprintf('%s(%s)', gettype($baseSearchRspNextResultReferenceItem), var_export($baseSearchRspNextResultReferenceItem, true));
            }
        }
     ...
     * @param \Travelport\Util\StructType\NextResultReference[] $nextResultReference
     * @return \Travelport\Util\StructType\BaseSearchRsp
     */
