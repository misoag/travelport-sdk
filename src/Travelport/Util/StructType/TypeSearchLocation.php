...
class TypeSearchLocation extends AbstractStructBase
{
     ...
     * @var \Travelport\Util\StructType\CoordinateLocation|null
     */
    protected ?\Travelport\Util\StructType\CoordinateLocation $CoordinateLocation = null;
    /**
     * The RailLocation
     * Meta information extracted from the WSDL
     * - choice: Airport | City | CityOrAirport | CoordinateLocation | RailLocation
     ...
     * - minOccurs: 0
     * - ref: Distance
     * @var \Travelport\Util\StructType\Distance|null
     */
    protected ?\Travelport\Util\StructType\Distance $Distance = null;
    /**
     ...
     * @param \Travelport\Util\StructType\CoordinateLocation $coordinateLocation
     * @param \Travelport\Util\StructType\RailLocation $railLocation
     * @param \Travelport\Util\StructType\Distance $distance
     */
    public function __construct(?\Travelport\Util\StructType\Airport $airport = null, ?\Travelport\Util\StructType\City $city = null, ?\Travelport\Util\StructType\CityOrAirport $cityOrAirport = null, ?\Travelport\Util\StructType\CoordinateLocation $coordinateLocation = null, ?\Travelport\Util\StructType\RailLocation $railLocation = null, ?\Travelport\Util\StructType\Distance $distance = null)
    {
        $this
            ->setAirport($airport)
            ->setCity($city)
     ...
     * @return \Travelport\Util\StructType\CoordinateLocation|null
     */
    ...
    /**
     * Get Distance value
     * @return \Travelport\Util\StructType\Distance|null
     */
     ...
     * @return \Travelport\Util\StructType\TypeSearchLocation
     */
    public function setDistance(?\Travelport\Util\StructType\Distance $distance = null): self
    {
