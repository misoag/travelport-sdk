...
class DocumentInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TicketInfo
     * @var \Travelport\Util\StructType\TicketInfo[]
     */
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\MCOInformation[]
     */
     ...
     * - minOccurs: 0
     * - ref: TCRInfo
     * @var \Travelport\Util\StructType\TCRInfo[]
     */
     ...
     * @param \Travelport\Util\StructType\TicketInfo[] $ticketInfo
     * @param \Travelport\Util\StructType\MCOInformation[] $mCOInfo
     * @param \Travelport\Util\StructType\TCRInfo[] $tCRInfo
     */
    ...
    public static function validateTicketInfoForArrayConstraintsFromSetTicketInfo(?array $values = []): string
    {
        ...
        foreach ($values as $documentInfoTicketInfoItem) {
            ...
            if (!$documentInfoTicketInfoItem instanceof \Travelport\Util\StructType\TicketInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TicketInfo property can only contain items of type \Travelport\Util\StructType\TicketInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \Travelport\Util\StructType\TicketInfo[] $ticketInfo
     * @return \Travelport\Util\StructType\DocumentInfo
     */
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\TicketInfo $item
     * @return \Travelport\Util\StructType\DocumentInfo
     */
    public function addToTicketInfo(\Travelport\Util\StructType\TicketInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\TicketInfo) {
            throw new InvalidArgumentException(sprintf('The TicketInfo property can only contain items of type \Travelport\Util\StructType\TicketInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    /**
     * Get MCOInfo value
     * @return \Travelport\Util\StructType\MCOInformation[]
     */
    ...
    public static function validateMCOInfoForArrayConstraintsFromSetMCOInfo(?array $values = []): string
    {
        ...
        foreach ($values as $documentInfoMCOInfoItem) {
            // validation for constraint: itemType
            if (!$documentInfoMCOInfoItem instanceof \Travelport\Util\StructType\MCOInformation) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MCOInfo property can only contain items of type \Travelport\Util\StructType\MCOInformation, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\MCOInformation $item
     * @return \Travelport\Util\StructType\DocumentInfo
     */
    public function addToMCOInfo(\Travelport\Util\StructType\MCOInformation $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\MCOInformation) {
            throw new InvalidArgumentException(sprintf('The MCOInfo property can only contain items of type \Travelport\Util\StructType\MCOInformation, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    /**
     * Get TCRInfo value
     * @return \Travelport\Util\StructType\TCRInfo[]
     */
    ...
    public static function validateTCRInfoForArrayConstraintsFromSetTCRInfo(?array $values = []): string
    {
        ...
        foreach ($values as $documentInfoTCRInfoItem) {
            // validation for constraint: itemType
            if (!$documentInfoTCRInfoItem instanceof \Travelport\Util\StructType\TCRInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TCRInfo property can only contain items of type \Travelport\Util\StructType\TCRInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\TCRInfo $item
     * @return \Travelport\Util\StructType\DocumentInfo
     */
    public function addToTCRInfo(\Travelport\Util\StructType\TCRInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\TCRInfo) {
            throw new InvalidArgumentException(sprintf('The TCRInfo property can only contain items of type \Travelport\Util\StructType\TCRInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
