...
class TypeBaseAirSegment extends Segment
{
     ...
     * @var \Travelport\Util\StructType\SponsoredFltInfo|null
     */
    protected ?\Travelport\Util\StructType\SponsoredFltInfo $SponsoredFltInfo = null;
    /**
     * The CodeshareInfo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * - minOccurs: 0
     * - ref: AirAvailInfo
     * @var \Travelport\Util\StructType\AirAvailInfo[]
     */
     ...
     * @var \Travelport\Util\StructType\FlightDetailsRef[]
     */
     ...
     * @var \Travelport\Util\StructType\AlternateLocationDistanceRef[]
     */
     ...
     * @var \Travelport\Util\StructType\RailCoachDetails[]
     */
     ...
     * @param int $group
     * @param \Travelport\Util\StructType\SponsoredFltInfo $sponsoredFltInfo
     * @param \Travelport\Util\StructType\CodeshareInfo $codeshareInfo
     * @param \Travelport\Util\StructType\AirAvailInfo[] $airAvailInfo
     * @param \Travelport\Util\StructType\FlightDetails[] $flightDetails
     * @param \Travelport\Util\StructType\FlightDetailsRef[] $flightDetailsRef
     * @param \Travelport\Util\StructType\AlternateLocationDistanceRef[] $alternateLocationDistanceRef
     * @param \Travelport\Util\StructType\Connection $connection
     * @param string[] $sellMessage
     * @param \Travelport\Util\StructType\RailCoachDetails[] $railCoachDetails
     ...
     * @return \Travelport\Util\StructType\SponsoredFltInfo|null
     */
    public function getSponsoredFltInfo(): ?\Travelport\Util\StructType\SponsoredFltInfo
    {
     ...
     * @return \Travelport\Util\StructType\TypeBaseAirSegment
     */
    public function setSponsoredFltInfo(?\Travelport\Util\StructType\SponsoredFltInfo $sponsoredFltInfo = null): self
    {
     ...
     * @return \Travelport\Util\StructType\AirAvailInfo[]
     */
    ...
    public static function validateAirAvailInfoForArrayConstraintFromSetAirAvailInfo(?array $values = []): string
    {
        ...
        foreach ($values as $typeBaseAirSegmentAirAvailInfoItem) {
            ...
            if (!$typeBaseAirSegmentAirAvailInfoItem instanceof \Travelport\Util\StructType\AirAvailInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AirAvailInfo property can only contain items of type \Travelport\Util\StructType\AirAvailInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\AirAvailInfo $item
     * @return \Travelport\Util\StructType\TypeBaseAirSegment
     */
    public function addToAirAvailInfo(\Travelport\Util\StructType\AirAvailInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\AirAvailInfo) {
            throw new InvalidArgumentException(sprintf('The AirAvailInfo property can only contain items of type \Travelport\Util\StructType\AirAvailInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateFlightDetailsForArrayConstraintFromSetFlightDetails(?array $values = []): string
    {
        ...
        foreach ($values as $typeBaseAirSegmentFlightDetailsItem) {
            // validation for constraint: itemType
            if (!$typeBaseAirSegmentFlightDetailsItem instanceof \Travelport\Util\StructType\FlightDetails) {
     ...
     * @return \Travelport\Util\StructType\FlightDetailsRef[]
     */
    ...
    public static function validateFlightDetailsRefForArrayConstraintFromSetFlightDetailsRef(?array $values = []): string
    {
        ...
        foreach ($values as $typeBaseAirSegmentFlightDetailsRefItem) {
            // validation for constraint: itemType
            if (!$typeBaseAirSegmentFlightDetailsRefItem instanceof \Travelport\Util\StructType\FlightDetailsRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The FlightDetailsRef property can only contain items of type \Travelport\Util\StructType\FlightDetailsRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\FlightDetailsRef $item
     * @return \Travelport\Util\StructType\TypeBaseAirSegment
     */
    public function addToFlightDetailsRef(\Travelport\Util\StructType\FlightDetailsRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\FlightDetailsRef) {
            throw new InvalidArgumentException(sprintf('The FlightDetailsRef property can only contain items of type \Travelport\Util\StructType\FlightDetailsRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\AlternateLocationDistanceRef[]
     */
    ...
    public static function validateAlternateLocationDistanceRefForArrayConstraintFromSetAlternateLocationDistanceRef(?array $values = []): string
    {
        ...
        foreach ($values as $typeBaseAirSegmentAlternateLocationDistanceRefItem) {
            // validation for constraint: itemType
            if (!$typeBaseAirSegmentAlternateLocationDistanceRefItem instanceof \Travelport\Util\StructType\AlternateLocationDistanceRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AlternateLocationDistanceRef property can only contain items of type \Travelport\Util\StructType\AlternateLocationDistanceRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\AlternateLocationDistanceRef $item
     * @return \Travelport\Util\StructType\TypeBaseAirSegment
     */
    public function addToAlternateLocationDistanceRef(\Travelport\Util\StructType\AlternateLocationDistanceRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\AlternateLocationDistanceRef) {
            throw new InvalidArgumentException(sprintf('The AlternateLocationDistanceRef property can only contain items of type \Travelport\Util\StructType\AlternateLocationDistanceRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\RailCoachDetails[]
     */
    ...
    public static function validateRailCoachDetailsForArrayConstraintFromSetRailCoachDetails(?array $values = []): string
    {
        ...
        foreach ($values as $typeBaseAirSegmentRailCoachDetailsItem) {
            // validation for constraint: itemType
            if (!$typeBaseAirSegmentRailCoachDetailsItem instanceof \Travelport\Util\StructType\RailCoachDetails) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The RailCoachDetails property can only contain items of type \Travelport\Util\StructType\RailCoachDetails, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\RailCoachDetails $item
     * @return \Travelport\Util\StructType\TypeBaseAirSegment
     */
    public function addToRailCoachDetails(\Travelport\Util\StructType\RailCoachDetails $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\RailCoachDetails) {
            throw new InvalidArgumentException(sprintf('The RailCoachDetails property can only contain items of type \Travelport\Util\StructType\RailCoachDetails, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
