...
class TypeVoucherInformation extends AbstractStructBase
{
     ...
     * @uses \Travelport\Util\EnumType\TypeVoucherType::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypeVoucherType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $voucherType
     * @return \Travelport\Util\StructType\TypeVoucherInformation
     */
    public function setVoucherType(string $voucherType): self
    {
        // validation for constraint: enumeration
        if (!\Travelport\Util\EnumType\TypeVoucherType::valueIsValid($voucherType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeVoucherType', is_array($voucherType) ? implode(', ', $voucherType) : var_export($voucherType, true), implode(', ', \Travelport\Util\EnumType\TypeVoucherType::getValidValues())), __LINE__);
        }
