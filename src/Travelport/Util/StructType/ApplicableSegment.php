...
class ApplicableSegment extends AbstractStructBase
{
     ...
     * @var \Travelport\Util\StructType\ResponseMessage|null
     */
    protected ?\Travelport\Util\StructType\ResponseMessage $ResponseMessage = null;
    /**
     ...
     * @param string $key
     */
    public function __construct(?\Travelport\Util\StructType\ResponseMessage $responseMessage = null, ?string $optionalServiceRef = null, ?string $key = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\ResponseMessage|null
     */
