...
class GeneralRemark extends AbstractStructBase
{
    ...
    /**
     * Set Direction value
     * @uses \Travelport\Util\EnumType\TypeDirection::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypeDirection::getValidValues()
     * @throws InvalidArgumentException
     * @param string $direction
     * @return \Travelport\Util\StructType\GeneralRemark
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\Travelport\Util\EnumType\TypeDirection::valueIsValid($direction)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeDirection', is_array($direction) ? implode(', ', $direction) : var_export($direction, true), implode(', ', \Travelport\Util\EnumType\TypeDirection::getValidValues())), __LINE__);
        }
