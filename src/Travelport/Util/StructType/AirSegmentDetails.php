...
class AirSegmentDetails extends AbstractStructBase
{
     ...
     * @var \Travelport\Util\StructType\PassengerDetailsRef[]
     */
     ...
     * - minOccurs: 0
     * - ref: BrandID
     * @var \Travelport\Util\StructType\BrandID[]
     */
     ...
     * @param \Travelport\Util\StructType\PassengerDetailsRef[] $passengerDetailsRef
     * @param string $key
     ...
     * @param \Travelport\Util\StructType\BrandID[] $brandID
     ...
     * @return \Travelport\Util\StructType\PassengerDetailsRef[]
     */
    ...
    public static function validatePassengerDetailsRefForArrayConstraintFromSetPassengerDetailsRef(?array $values = []): string
    {
        ...
        foreach ($values as $airSegmentDetailsPassengerDetailsRefItem) {
            ...
            if (!$airSegmentDetailsPassengerDetailsRefItem instanceof \Travelport\Util\StructType\PassengerDetailsRef) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PassengerDetailsRef property can only contain items of type \Travelport\Util\StructType\PassengerDetailsRef, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\PassengerDetailsRef $item
     * @return \Travelport\Util\StructType\AirSegmentDetails
     */
    public function addToPassengerDetailsRef(\Travelport\Util\StructType\PassengerDetailsRef $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\PassengerDetailsRef) {
            throw new InvalidArgumentException(sprintf('The PassengerDetailsRef property can only contain items of type \Travelport\Util\StructType\PassengerDetailsRef, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    public static function validateBrandIDForArrayConstraintFromSetBrandID(?array $values = []): string
    {
        ...
        foreach ($values as $airSegmentDetailsBrandIDItem) {
            // validation for constraint: itemType
            if (!$airSegmentDetailsBrandIDItem instanceof \Travelport\Util\StructType\BrandID) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The BrandID property can only contain items of type \Travelport\Util\StructType\BrandID, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\BrandID $item
     * @return \Travelport\Util\StructType\AirSegmentDetails
     */
    public function addToBrandID(\Travelport\Util\StructType\BrandID $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\BrandID) {
            throw new InvalidArgumentException(sprintf('The BrandID property can only contain items of type \Travelport\Util\StructType\BrandID, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(99)
