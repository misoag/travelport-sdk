...
class AirExchangeBundleTotal extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Travelport\Util\StructType\AirExchangeInfo $airExchangeInfo = null, ?array $penalty = null)
    {
        $this
     ...
     * @param \Travelport\Util\StructType\AirExchangeInfo $airExchangeInfo
     * @return \Travelport\Util\StructType\AirExchangeBundleTotal
     */
    ...
    public static function validatePenaltyForArrayConstraintFromSetPenalty(?array $values = []): string
    {
        ...
        foreach ($values as $airExchangeBundleTotalPenaltyItem) {
            ...
            if (!$airExchangeBundleTotalPenaltyItem instanceof \Travelport\Util\StructType\Penalty) {
