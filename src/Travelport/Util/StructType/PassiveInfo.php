...
class PassiveInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(?array $ticketNumber = null, ?array $confirmationNumber = null, ?\Travelport\Util\StructType\Commission $commission = null, ?string $providerCode = null, ?string $providerLocatorCode = null, ?string $supplierCode = null, ?string $supplierLocatorCode = null)
    {
        $this
     ...
     * @param string[] $ticketNumber
     * @return \Travelport\Util\StructType\PassiveInfo
     */
