...
class ReasonCode extends AbstractStructBase
{
     ...
     */
    public function __construct(?string $outOfPolicy = null, ?string $purposeOfTrip = null, ?\Travelport\Util\StructType\Remark $remark = null)
    {
        $this
     ...
     * @param string $outOfPolicy
     * @return \Travelport\Util\StructType\ReasonCode
     */
