...
class ActionStatus extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: Remark
     * @var \Travelport\Util\StructType\Remark|null
     */
    protected ?\Travelport\Util\StructType\Remark $Remark = null;
    /**
     * The TicketDate
     * Meta information extracted from the WSDL
     ...
     */
    public function __construct(string $type, ?\Travelport\Util\StructType\Remark $remark = null, ?string $ticketDate = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?string $queueCategory = null, ?string $airportCode = null, ?string $pseudoCityCode = null, ?string $accountCode = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setType($type)
            ->setRemark($remark)
     ...
     * Set Type value
     * @param string $type
     * @return \Travelport\Util\StructType\ActionStatus
     */
    ...
    /**
     * Get Remark value
     * @return \Travelport\Util\StructType\Remark|null
     */
    public function getRemark(): ?\Travelport\Util\StructType\Remark
    {
        return $this->Remark;
    }
    /**
     ...
     * @return \Travelport\Util\StructType\ActionStatus
     */
    public function setRemark(?\Travelport\Util\StructType\Remark $remark = null): self
    {
        $this->Remark = $remark;
