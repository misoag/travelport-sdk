...
class ProhibitedBookingCodes extends AbstractStructBase
{
    ...
    public static function validateBookingCodeForArrayConstraintsFromSetBookingCode(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $prohibitedBookingCodesBookingCodeItem) {
            // validation for constraint: itemType
            if (!$prohibitedBookingCodesBookingCodeItem instanceof \Travelport\Util\StructType\BookingCode) {
                $invalidValues[] = is_object($prohibitedBookingCodesBookingCodeItem) ? get_class($prohibitedBookingCodesBookingCodeItem) : sprintf('%s(%s)', gettype($prohibitedBookingCodesBookingCodeItem), var_export($prohibitedBookingCodesBookingCodeItem, true));
            }
        }
     ...
     * @param \Travelport\Util\StructType\BookingCode[] $bookingCode
     * @return \Travelport\Util\StructType\ProhibitedBookingCodes
     */
