...
class ManualFareAdjustment extends AbstractStructBase
{
    ...
    /**
     * Set AppliedOn value
     * @uses \Travelport\Util\EnumType\TypeAdjustmentTarget::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypeAdjustmentTarget::getValidValues()
    ...
    public function setAppliedOn(string $appliedOn): self
    {
        ...
        if (!\Travelport\Util\EnumType\TypeAdjustmentTarget::valueIsValid($appliedOn)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeAdjustmentTarget', is_array($appliedOn) ? implode(', ', $appliedOn) : var_export($appliedOn, true), implode(', ', \Travelport\Util\EnumType\TypeAdjustmentTarget::getValidValues())), __LINE__);
        }
    ...
    {
        // validation for constraint: enumeration
        if (!\Travelport\Util\EnumType\TypeAdjustmentType::valueIsValid($adjustmentType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeAdjustmentType', is_array($adjustmentType) ? implode(', ', $adjustmentType) : var_export($adjustmentType, true), implode(', ', \Travelport\Util\EnumType\TypeAdjustmentType::getValidValues())), __LINE__);
        }
