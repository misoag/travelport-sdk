...
class ServiceData extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: SeatAttributes
     * @var \Travelport\Util\StructType\SeatAttributes|null
     */
    protected ?\Travelport\Util\StructType\SeatAttributes $SeatAttributes = null;
    /**
     * The CabinClass
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \Travelport\Util\StructType\SeatAttributes $seatAttributes
     * @param \Travelport\Util\StructType\CabinClass $cabinClass
     * @param \Travelport\Util\StructType\TypeKeyBasedReference[] $sSRRef
     * @param string $data
     ...
     */
    public function __construct(?\Travelport\Util\StructType\SeatAttributes $seatAttributes = null, ?\Travelport\Util\StructType\CabinClass $cabinClass = null, ?array $sSRRef = null, ?string $data = null, ?string $airSegmentRef = null, ?string $bookingTravelerRef = null, ?bool $stopOver = false, ?string $travelerType = null, ?string $eMDSummaryRef = null, ?string $eMDCouponRef = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\SeatAttributes|null
     */
    public function getSeatAttributes(): ?\Travelport\Util\StructType\SeatAttributes
    {
     ...
     */
    public function setSeatAttributes(?\Travelport\Util\StructType\SeatAttributes $seatAttributes = null): self
    {
    ...
    /**
     * Get SSRRef value
     * @return \Travelport\Util\StructType\TypeKeyBasedReference[]
     */
    ...
    public static function validateSSRRefForArrayConstraintsFromSetSSRRef(?array $values = []): string
    {
        ...
        foreach ($values as $serviceDataSSRRefItem) {
            ...
            if (!$serviceDataSSRRefItem instanceof \Travelport\Util\StructType\TypeKeyBasedReference) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SSRRef property can only contain items of type \Travelport\Util\StructType\TypeKeyBasedReference, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\TypeKeyBasedReference $item
     * @return \Travelport\Util\StructType\ServiceData
     */
    public function addToSSRRef(\Travelport\Util\StructType\TypeKeyBasedReference $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\TypeKeyBasedReference) {
            throw new InvalidArgumentException(sprintf('The SSRRef property can only contain items of type \Travelport\Util\StructType\TypeKeyBasedReference, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
