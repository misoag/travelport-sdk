...
class DeliveryInfo extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\ShippingAddress|null
     */
    protected ?\Travelport\Util\StructType\ShippingAddress $ShippingAddress = null;
    /**
     * The PhoneNumber
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \Travelport\Util\StructType\ShippingAddress $shippingAddress
     ...
     */
    public function __construct(?\Travelport\Util\StructType\ShippingAddress $shippingAddress = null, ?\Travelport\Util\StructType\PhoneNumber $phoneNumber = null, ?\Travelport\Util\StructType\Email $email = null, ?array $generalRemark = null, ?array $providerReservationInfoRef = null, ?string $type = null, ?string $signatureRequired = null, ?string $trackingNumber = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\ShippingAddress|null
     */
    public function getShippingAddress(): ?\Travelport\Util\StructType\ShippingAddress
    {
     ...
     * @param \Travelport\Util\StructType\ShippingAddress $shippingAddress
     * @return \Travelport\Util\StructType\DeliveryInfo
     */
    public function setShippingAddress(?\Travelport\Util\StructType\ShippingAddress $shippingAddress = null): self
    {
    ...
    public static function validateGeneralRemarkForArrayConstraintsFromSetGeneralRemark(?array $values = []): string
    {
        ...
        foreach ($values as $deliveryInfoGeneralRemarkItem) {
            ...
            if (!$deliveryInfoGeneralRemarkItem instanceof \Travelport\Util\StructType\GeneralRemark) {
    ...
    public static function validateProviderReservationInfoRefForArrayConstraintsFromSetProviderReservationInfoRef(?array $values = []): string
    {
        ...
        foreach ($values as $deliveryInfoProviderReservationInfoRefItem) {
            // validation for constraint: itemType
            if (!$deliveryInfoProviderReservationInfoRefItem instanceof \Travelport\Util\StructType\ProviderReservationInfoRef) {
