...
class TypeTaxInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: TaxDetail
     * @var \Travelport\Util\StructType\TaxDetail[]
     */
     ...
     * - minOccurs: 0
     * - ref: IncludedInBase
     * @var \Travelport\Util\StructType\IncludedInBase|null
     */
    protected ?\Travelport\Util\StructType\IncludedInBase $IncludedInBase = null;
    /**
     * The Key
     * Meta information extracted from the WSDL
     ...
     * @param string $amount
     * @param \Travelport\Util\StructType\TaxDetail[] $taxDetail
     * @param \Travelport\Util\StructType\IncludedInBase $includedInBase
     * @param string $key
     ...
     */
    public function __construct(string $category, string $amount, ?array $taxDetail = null, ?\Travelport\Util\StructType\IncludedInBase $includedInBase = null, ?string $key = null, ?string $carrierDefinedCategory = null, ?string $segmentRef = null, ?string $flightDetailsRef = null, ?string $couponRef = null, ?bool $taxExempted = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $text = null, ?string $originAirport = null, ?string $destinationAirport = null, ?string $countryCode = null, ?string $fareInfoRef = null)
    {
        $this
    ...
    /**
     * Get TaxDetail value
     * @return \Travelport\Util\StructType\TaxDetail[]
     */
    ...
    public static function validateTaxDetailForArrayConstraintsFromSetTaxDetail(?array $values = []): string
    {
        ...
        foreach ($values as $typeTaxInfoTaxDetailItem) {
            ...
            if (!$typeTaxInfoTaxDetailItem instanceof \Travelport\Util\StructType\TaxDetail) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The TaxDetail property can only contain items of type \Travelport\Util\StructType\TaxDetail, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\TaxDetail $item
     * @return \Travelport\Util\StructType\TypeTaxInfo
     */
    public function addToTaxDetail(\Travelport\Util\StructType\TaxDetail $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\TaxDetail) {
            throw new InvalidArgumentException(sprintf('The TaxDetail property can only contain items of type \Travelport\Util\StructType\TaxDetail, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\IncludedInBase|null
     */
    public function getIncludedInBase(): ?\Travelport\Util\StructType\IncludedInBase
    {
     ...
     * @return \Travelport\Util\StructType\TypeTaxInfo
     */
    public function setIncludedInBase(?\Travelport\Util\StructType\IncludedInBase $includedInBase = null): self
    {
