...
class MCO extends MCOInformation
{
     ...
     * - minOccurs: 0
     * - ref: Endorsement
     * @var \Travelport\Util\StructType\Endorsement|null
     */
    protected ?\Travelport\Util\StructType\Endorsement $Endorsement = null;
    /**
     * The MCOExchangeInfo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MCOExchangeInfo
     * @var \Travelport\Util\StructType\MCOExchangeInfo|null
     */
    protected ?\Travelport\Util\StructType\MCOExchangeInfo $MCOExchangeInfo = null;
    /**
     * The MCOFeeInfo
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: MCOFeeInfo
     * @var \Travelport\Util\StructType\MCOFeeInfo|null
     */
    protected ?\Travelport\Util\StructType\MCOFeeInfo $MCOFeeInfo = null;
    /**
     * The MCORemark
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * - ref: MCORemark
     * @var \Travelport\Util\StructType\MCORemark[]
     */
     ...
     * - minOccurs: 0
     * - ref: MCOPriceData
     * @var \Travelport\Util\StructType\MCOPriceData|null
     */
    protected ?\Travelport\Util\StructType\MCOPriceData $MCOPriceData = null;
    /**
     * The StockControl
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * - ref: StockControl
     * @var \Travelport\Util\StructType\StockControl[]
     */
     ...
     * - minOccurs: 0
     * - ref: MCOText
     * @var \Travelport\Util\StructType\MCOText[]
     */
     ...
     * @param \Travelport\Util\StructType\MCOExchangeInfo $mCOExchangeInfo
     * @param \Travelport\Util\StructType\MCOFeeInfo $mCOFeeInfo
     * @param \Travelport\Util\StructType\MCORemark[] $mCORemark
     * @param \Travelport\Util\StructType\MCOPriceData $mCOPriceData
     * @param \Travelport\Util\StructType\StockControl[] $stockControl
     * @param \Travelport\Util\StructType\MCOText[] $mCOText
     ...
     */
    public function __construct(bool $mCOIssued, ?array $formOfPayment = null, ?\Travelport\Util\StructType\Endorsement $endorsement = null, ?\Travelport\Util\StructType\MCOExchangeInfo $mCOExchangeInfo = null, ?\Travelport\Util\StructType\MCOFeeInfo $mCOFeeInfo = null, ?array $mCORemark = null, ?\Travelport\Util\StructType\MCOPriceData $mCOPriceData = null, ?array $stockControl = null, ?array $mCOText = null, ?string $ticketType = null, ?string $ticketNumber = null, ?string $mCOIssueDate = null, ?string $mCODocNum = null, ?string $issueReasonCode = null, ?string $platingCarrier = null, ?string $tourOperator = null, ?string $location = null, ?string $tourCode = null, ?string $providerCode = null, ?string $providerLocatorCode = null, ?string $pseudoCityCode = null, ?string $expiryDate = null)
    {
        $this
     ...
     * Set MCOIssued value
     * @param bool $mCOIssued
     * @return \Travelport\Util\StructType\MCO
     */
    ...
    public static function validateFormOfPaymentForArrayConstraintsFromSetFormOfPayment(?array $values = []): string
    {
        ...
        foreach ($values as $mCOFormOfPaymentItem) {
            ...
            if (!$mCOFormOfPaymentItem instanceof \Travelport\Util\StructType\FormOfPayment) {
     ...
     * @return \Travelport\Util\StructType\Endorsement|null
     */
    public function getEndorsement(): ?\Travelport\Util\StructType\Endorsement
    {
     ...
     * @return \Travelport\Util\StructType\MCO
     */
    public function setEndorsement(?\Travelport\Util\StructType\Endorsement $endorsement = null): self
    {
     ...
     * @return \Travelport\Util\StructType\MCOExchangeInfo|null
     */
    public function getMCOExchangeInfo(): ?\Travelport\Util\StructType\MCOExchangeInfo
    {
     ...
     * @return \Travelport\Util\StructType\MCO
     */
    public function setMCOExchangeInfo(?\Travelport\Util\StructType\MCOExchangeInfo $mCOExchangeInfo = null): self
    {
     ...
     * @return \Travelport\Util\StructType\MCOFeeInfo|null
     */
    public function getMCOFeeInfo(): ?\Travelport\Util\StructType\MCOFeeInfo
    {
     ...
     * @return \Travelport\Util\StructType\MCO
     */
    public function setMCOFeeInfo(?\Travelport\Util\StructType\MCOFeeInfo $mCOFeeInfo = null): self
    {
    ...
    /**
     * Get MCORemark value
     * @return \Travelport\Util\StructType\MCORemark[]
     */
    ...
    public static function validateMCORemarkForArrayConstraintsFromSetMCORemark(?array $values = []): string
    {
        ...
        foreach ($values as $mCOMCORemarkItem) {
            // validation for constraint: itemType
            if (!$mCOMCORemarkItem instanceof \Travelport\Util\StructType\MCORemark) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MCORemark property can only contain items of type \Travelport\Util\StructType\MCORemark, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\MCORemark $item
     * @return \Travelport\Util\StructType\MCO
     */
    public function addToMCORemark(\Travelport\Util\StructType\MCORemark $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\MCORemark) {
            throw new InvalidArgumentException(sprintf('The MCORemark property can only contain items of type \Travelport\Util\StructType\MCORemark, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \Travelport\Util\StructType\MCOPriceData|null
     */
    public function getMCOPriceData(): ?\Travelport\Util\StructType\MCOPriceData
    {
     ...
     * @return \Travelport\Util\StructType\MCO
     */
    public function setMCOPriceData(?\Travelport\Util\StructType\MCOPriceData $mCOPriceData = null): self
    {
     ...
     * @return \Travelport\Util\StructType\StockControl[]
     */
    ...
    public static function validateStockControlForArrayConstraintsFromSetStockControl(?array $values = []): string
    {
        ...
        foreach ($values as $mCOStockControlItem) {
            // validation for constraint: itemType
            if (!$mCOStockControlItem instanceof \Travelport\Util\StructType\StockControl) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The StockControl property can only contain items of type \Travelport\Util\StructType\StockControl, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\StockControl $item
     * @return \Travelport\Util\StructType\MCO
     */
    public function addToStockControl(\Travelport\Util\StructType\StockControl $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\StockControl) {
            throw new InvalidArgumentException(sprintf('The StockControl property can only contain items of type \Travelport\Util\StructType\StockControl, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
    ...
    /**
     * Get MCOText value
     * @return \Travelport\Util\StructType\MCOText[]
     */
    ...
    public static function validateMCOTextForArrayConstraintsFromSetMCOText(?array $values = []): string
    {
        ...
        foreach ($values as $mCOMCOTextItem) {
            // validation for constraint: itemType
            if (!$mCOMCOTextItem instanceof \Travelport\Util\StructType\MCOText) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The MCOText property can only contain items of type \Travelport\Util\StructType\MCOText, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \Travelport\Util\StructType\MCOText $item
     * @return \Travelport\Util\StructType\MCO
     */
    public function addToMCOText(\Travelport\Util\StructType\MCOText $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \Travelport\Util\StructType\MCOText) {
            throw new InvalidArgumentException(sprintf('The MCOText property can only contain items of type \Travelport\Util\StructType\MCOText, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
