...
/**
 * This class stands for AirUpsellRule StructType
 * @subpackage Structs
 */
class AirUpsellRule extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for AirUpsellRule
     * @uses AirUpsellRule::setAirUpsellQualify()
     * @uses AirUpsellRule::setAirUpsellOffer()
