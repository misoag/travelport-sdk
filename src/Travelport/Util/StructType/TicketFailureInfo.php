...
class TicketFailureInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(array $airPricingInfoRef, int $code, string $bookingTravelerRef, ?\Travelport\Util\StructType\Name $name = null, ?string $message = null)
    {
        $this
    ...
    public static function validateAirPricingInfoRefForArrayConstraintsFromSetAirPricingInfoRef(?array $values = []): string
    {
        ...
        foreach ($values as $ticketFailureInfoAirPricingInfoRefItem) {
            ...
            if (!$ticketFailureInfoAirPricingInfoRefItem instanceof \Travelport\Util\StructType\AirPricingInfoRef) {
     ...
     * @param \Travelport\Util\StructType\AirPricingInfoRef[] $airPricingInfoRef
     * @return \Travelport\Util\StructType\TicketFailureInfo
     */
