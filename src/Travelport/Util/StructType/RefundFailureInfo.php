...
class RefundFailureInfo extends AbstractStructBase
{
     ...
     * Set Code value
     * @param int $code
     * @return \Travelport\Util\StructType\RefundFailureInfo
     */
    ...
    public static function validateBookingTravelerRefForArrayConstraintsFromSetBookingTravelerRef(?array $values = []): string
    {
        ...
        $message = '';
        $invalidValues = [];
        foreach ($values as $refundFailureInfoBookingTravelerRefItem) {
            // validation for constraint: itemType
            if (!is_string($refundFailureInfoBookingTravelerRefItem)) {
                $invalidValues[] = is_object($refundFailureInfoBookingTravelerRefItem) ? get_class($refundFailureInfoBookingTravelerRefItem) : sprintf('%s(%s)', gettype($refundFailureInfoBookingTravelerRefItem), var_export($refundFailureInfoBookingTravelerRefItem, true));
            }
        }
