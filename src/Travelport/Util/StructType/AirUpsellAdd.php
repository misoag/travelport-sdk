...
/**
 * This class stands for AirUpsellAdd StructType
 * @subpackage Structs
 */
class AirUpsellAdd extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for AirUpsellAdd
     * @uses AirUpsellAdd::setAirUpsellQualify()
     * @uses AirUpsellAdd::setAirUpsellOffer()
