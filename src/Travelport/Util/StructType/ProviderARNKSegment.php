...
class ProviderARNKSegment extends AbstractStructBase
{
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\PreviousSegment|null
     */
    protected ?\Travelport\Util\StructType\PreviousSegment $PreviousSegment = null;
    /**
     * The NextSegment
     * Meta information extracted from the WSDL
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \Travelport\Util\StructType\NextSegment|null
     */
    protected ?\Travelport\Util\StructType\NextSegment $NextSegment = null;
    /**
     * The Key
     * Meta information extracted from the WSDL
     ...
     * @param \Travelport\Util\StructType\PreviousSegment $previousSegment
     * @param \Travelport\Util\StructType\NextSegment $nextSegment
     * @param string $key
     * @param string $providerReservationInfoRef
     * @param int $providerSegmentOrder
     */
    public function __construct(?\Travelport\Util\StructType\PreviousSegment $previousSegment = null, ?\Travelport\Util\StructType\NextSegment $nextSegment = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?int $providerSegmentOrder = null)
    {
        $this
     ...
     * @return \Travelport\Util\StructType\PreviousSegment|null
     */
    public function getPreviousSegment(): ?\Travelport\Util\StructType\PreviousSegment
    {
     ...
     * @param \Travelport\Util\StructType\PreviousSegment $previousSegment
     * @return \Travelport\Util\StructType\ProviderARNKSegment
     */
    public function setPreviousSegment(?\Travelport\Util\StructType\PreviousSegment $previousSegment = null): self
    {
     ...
     * @return \Travelport\Util\StructType\NextSegment|null
     */
    public function getNextSegment(): ?\Travelport\Util\StructType\NextSegment
    {
     ...
     * @return \Travelport\Util\StructType\ProviderARNKSegment
     */
    public function setNextSegment(?\Travelport\Util\StructType\NextSegment $nextSegment = null): self
    {
