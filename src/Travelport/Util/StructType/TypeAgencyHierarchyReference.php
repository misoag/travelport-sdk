...
class TypeAgencyHierarchyReference extends AbstractStructBase
{
     ...
     * Set ProfileID value
     * @param int $profileID
     * @return \Travelport\Util\StructType\TypeAgencyHierarchyReference
     */
     ...
     * @uses \Travelport\Util\EnumType\TypeAgencyProfileLevel::valueIsValid()
     * @uses \Travelport\Util\EnumType\TypeAgencyProfileLevel::getValidValues()
    ...
    public function setProfileType(string $profileType): self
    {
        ...
        if (!\Travelport\Util\EnumType\TypeAgencyProfileLevel::valueIsValid($profileType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \Travelport\Util\EnumType\TypeAgencyProfileLevel', is_array($profileType) ? implode(', ', $profileType) : var_export($profileType, true), implode(', ', \Travelport\Util\EnumType\TypeAgencyProfileLevel::getValidValues())), __LINE__);
        }
