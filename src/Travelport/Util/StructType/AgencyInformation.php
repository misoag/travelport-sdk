...
class AgencyInformation extends AbstractStructBase
{
     ...
     */
    public function __construct(?\Travelport\Util\StructType\TypeStructuredAddress $address = null, ?array $email = null, ?array $phoneNumber = null)
    {
        $this
            ->setAddress($address)
            ->setEmail($email)
     ...
     * Set Address value
     * @param \Travelport\Util\StructType\TypeStructuredAddress $address
     * @return \Travelport\Util\StructType\AgencyInformation
     */
    ...
    public static function validateEmailForArrayConstraintFromSetEmail(?array $values = []): string
    {
        ...
        foreach ($values as $agencyInformationEmailItem) {
            ...
            if (!$agencyInformationEmailItem instanceof \Travelport\Util\StructType\Email) {
    ...
    public static function validatePhoneNumberForArrayConstraintFromSetPhoneNumber(?array $values = []): string
    {
        ...
        foreach ($values as $agencyInformationPhoneNumberItem) {
            // validation for constraint: itemType
            if (!$agencyInformationPhoneNumberItem instanceof \Travelport\Util\StructType\PhoneNumber) {
