...
class HotelRetrieveRsp extends BaseRsp
{
    ...
    public static function validateHotelReservationForArrayConstraintsFromSetHotelReservation(?array $values = []): string
    {
        ...
        foreach ($values as $hotelRetrieveRspHotelReservationItem) {
            ...
            if (!$hotelRetrieveRspHotelReservationItem instanceof \StructType\HotelReservation) {
     ...
     * @param \StructType\HotelReservation[] $hotelReservation
     * @return \StructType\HotelRetrieveRsp
     */
     ...
     * @return \StructType\HotelRetrieveRsp
     */
    public function addToHotelReservation(\StructType\HotelReservation $item): self
    {
        // validation for constraint: itemType
