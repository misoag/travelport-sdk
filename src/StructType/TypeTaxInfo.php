...
class TypeTaxInfo extends AbstractStructBase
{
     ...
     */
    public function __construct(string $category, string $amount, ?array $taxDetail = null, ?\StructType\IncludedInBase $includedInBase = null, ?string $key = null, ?string $carrierDefinedCategory = null, ?string $segmentRef = null, ?string $flightDetailsRef = null, ?string $couponRef = null, ?bool $taxExempted = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $text = null, ?string $originAirport = null, ?string $destinationAirport = null, ?string $countryCode = null, ?string $fareInfoRef = null)
    {
        $this
    ...
    public static function validateTaxDetailForArrayConstraintsFromSetTaxDetail(?array $values = []): string
    {
        ...
        foreach ($values as $typeTaxInfoTaxDetailItem) {
            ...
            if (!$typeTaxInfoTaxDetailItem instanceof \StructType\TaxDetail) {
     ...
     * @return \StructType\TypeTaxInfo
     */
    public function addToTaxDetail(\StructType\TaxDetail $item): self
    {
        // validation for constraint: itemType
