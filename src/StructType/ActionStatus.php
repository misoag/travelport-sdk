...
class ActionStatus extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: Remark
     * @var \StructType\Remark|null
     */
    protected ?\StructType\Remark $Remark = null;
    /**
     * The TicketDate
     * Meta information extracted from the WSDL
     ...
     */
    public function __construct(string $type, ?\StructType\Remark $remark = null, ?string $ticketDate = null, ?string $key = null, ?string $providerReservationInfoRef = null, ?string $queueCategory = null, ?string $airportCode = null, ?string $pseudoCityCode = null, ?string $accountCode = null, ?string $providerCode = null, ?string $supplierCode = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setType($type)
            ->setRemark($remark)
     ...
     * Set Type value
     * @param string $type
     * @return \StructType\ActionStatus
     */
     ...
     */
    public function getRemark(): ?\StructType\Remark
    {
        return $this->Remark;
    }
    /**
     ...
     * @return \StructType\ActionStatus
     */
    public function setRemark(?\StructType\Remark $remark = null): self
    {
        $this->Remark = $remark;
