...
class SSRInfo extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - ref: SSR
     * @var \StructType\SSR|null
     */
    protected ?\StructType\SSR $SSR = null;
    /**
     ...
     */
    public function __construct(?\StructType\SSR $sSR = null, ?array $bookingTravelerRef = null)
    {
        $this
            ->setSSR($sSR)
    ...
    /**
     * Get SSR value
     * @return \StructType\SSR|null
     */
    public function getSSR(): ?\StructType\SSR
    {
        return $this->SSR;
    }
    /**
     * Set SSR value
     * @param \StructType\SSR $sSR
     * @return \StructType\SSRInfo
     */
    public function setSSR(?\StructType\SSR $sSR = null): self
    {
        $this->SSR = $sSR;
