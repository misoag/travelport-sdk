...
class TypeStructuredAddress extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: State
     * @var \StructType\State|null
     */
    protected ?\StructType\State $State = null;
    /**
     * The PostalCode
     * Meta information extracted from the WSDL
     ...
     */
    public function __construct(?string $addressName = null, ?array $street = null, ?string $city = null, ?\StructType\State $state = null, ?string $postalCode = null, ?string $country = null, ?array $providerReservationInfoRef = null, ?string $key = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * @param string $addressName
     * @return \StructType\TypeStructuredAddress
     */
    ...
    /**
     * Get State value
     * @return \StructType\State|null
     */
    public function getState(): ?\StructType\State
    {
        return $this->State;
    }
    /**
     ...
     * @return \StructType\TypeStructuredAddress
     */
    public function setState(?\StructType\State $state = null): self
    {
        $this->State = $state;
    ...
    public static function validateProviderReservationInfoRefForArrayConstraintsFromSetProviderReservationInfoRef(?array $values = []): string
    {
        ...
        foreach ($values as $typeStructuredAddressProviderReservationInfoRefItem) {
            // validation for constraint: itemType
            if (!$typeStructuredAddressProviderReservationInfoRefItem instanceof \StructType\ProviderReservationInfoRef) {
