...
class TypeVoucherInformation extends AbstractStructBase
{
     ...
     * @uses \EnumType\TypeVoucherType::valueIsValid()
     * @uses \EnumType\TypeVoucherType::getValidValues()
     * @throws InvalidArgumentException
     * @param string $voucherType
     * @return \StructType\TypeVoucherInformation
     */
    public function setVoucherType(string $voucherType): self
    {
        // validation for constraint: enumeration
        if (!\EnumType\TypeVoucherType::valueIsValid($voucherType)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeVoucherType', is_array($voucherType) ? implode(', ', $voucherType) : var_export($voucherType, true), implode(', ', \EnumType\TypeVoucherType::getValidValues())), __LINE__);
        }
