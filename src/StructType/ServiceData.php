...
class ServiceData extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: SeatAttributes
     * @var \StructType\SeatAttributes|null
     */
    protected ?\StructType\SeatAttributes $SeatAttributes = null;
    /**
     * The CabinClass
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: CabinClass
     * @var \StructType\CabinClass|null
     */
    protected ?\StructType\CabinClass $CabinClass = null;
    /**
     * The SSRRef
     * Meta information extracted from the WSDL
     ...
     * - maxOccurs: 999
     * - minOccurs: 0
     * @var \StructType\TypeKeyBasedReference[]
     */
     ...
     * @param \StructType\SeatAttributes $seatAttributes
     * @param \StructType\CabinClass $cabinClass
     * @param \StructType\TypeKeyBasedReference[] $sSRRef
     * @param string $data
     ...
     */
    public function __construct(?\StructType\SeatAttributes $seatAttributes = null, ?\StructType\CabinClass $cabinClass = null, ?array $sSRRef = null, ?string $data = null, ?string $airSegmentRef = null, ?string $bookingTravelerRef = null, ?bool $stopOver = false, ?string $travelerType = null, ?string $eMDSummaryRef = null, ?string $eMDCouponRef = null)
    {
        $this
     ...
     * @return \StructType\SeatAttributes|null
     */
    public function getSeatAttributes(): ?\StructType\SeatAttributes
    {
     ...
     */
    public function setSeatAttributes(?\StructType\SeatAttributes $seatAttributes = null): self
    {
     ...
     */
    public function getCabinClass(): ?\StructType\CabinClass
    {
     ...
     * @return \StructType\ServiceData
     */
    public function setCabinClass(?\StructType\CabinClass $cabinClass = null): self
    {
    ...
    /**
     * Get SSRRef value
     * @return \StructType\TypeKeyBasedReference[]
     */
    ...
    public static function validateSSRRefForArrayConstraintsFromSetSSRRef(?array $values = []): string
    {
        ...
        foreach ($values as $serviceDataSSRRefItem) {
            ...
            if (!$serviceDataSSRRefItem instanceof \StructType\TypeKeyBasedReference) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The SSRRef property can only contain items of type \StructType\TypeKeyBasedReference, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \StructType\TypeKeyBasedReference $item
     * @return \StructType\ServiceData
     */
    public function addToSSRRef(\StructType\TypeKeyBasedReference $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\TypeKeyBasedReference) {
            throw new InvalidArgumentException(sprintf('The SSRRef property can only contain items of type \StructType\TypeKeyBasedReference, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
