...
class HotelKeywordRsp extends BaseRsp
{
     ...
     */
    public function __construct(?\StructType\MarketingInformation $marketingInformation = null, ?array $keyword = null)
    {
        $this
     ...
     * @param \StructType\MarketingInformation $marketingInformation
     * @return \StructType\HotelKeywordRsp
     */
    ...
    public static function validateKeywordForArrayConstraintsFromSetKeyword(?array $values = []): string
    {
        ...
        foreach ($values as $hotelKeywordRspKeywordItem) {
            ...
            if (!$hotelKeywordRspKeywordItem instanceof \StructType\Keyword) {
