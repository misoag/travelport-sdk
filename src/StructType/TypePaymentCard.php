...
class TypePaymentCard extends AbstractStructBase
{
     ...
     */
    protected ?\StructType\TypeStructuredAddress $BillingAddress = null;
    /**
     * The Type
     * Meta information extracted from the WSDL
     ...
     * @param \StructType\TypeStructuredAddress $billingAddress
     * @param string $type
     * @param string $number
     * @param int $expDate
     * @param string $name
     ...
     */
    public function __construct(?\StructType\PhoneNumber $phoneNumber = null, ?\StructType\TypeStructuredAddress $billingAddress = null, ?string $type = null, ?string $number = null, ?int $expDate = null, ?string $name = null, ?string $cVV = null, ?string $approvalCode = null)
    {
        $this
     ...
     * @param \StructType\PhoneNumber $phoneNumber
     * @return \StructType\TypePaymentCard
     */
     ...
     */
    public function getBillingAddress(): ?\StructType\TypeStructuredAddress
    {
     ...
     * @return \StructType\TypePaymentCard
     */
    public function setBillingAddress(?\StructType\TypeStructuredAddress $billingAddress = null): self
    {
