...
class TravelerInformation extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\EmergencyContact|null
     */
    protected ?\StructType\EmergencyContact $EmergencyContact = null;
    /**
     * The HomeAirport
     * Meta information extracted from the WSDL
     ...
     * @param \StructType\EmergencyContact $emergencyContact
     * @param string $homeAirport
     * @param string $visaExpirationDate
     */
    public function __construct(string $bookingTravelerRef, ?\StructType\EmergencyContact $emergencyContact = null, ?string $homeAirport = null, ?string $visaExpirationDate = null)
    {
        $this
     ...
     * @return \StructType\EmergencyContact|null
     */
    public function getEmergencyContact(): ?\StructType\EmergencyContact
    {
     ...
     * @return \StructType\TravelerInformation
     */
    public function setEmergencyContact(?\StructType\EmergencyContact $emergencyContact = null): self
    {
