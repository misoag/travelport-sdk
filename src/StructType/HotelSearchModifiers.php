...
class HotelSearchModifiers extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\PermittedChains|null
     */
    protected ?\StructType\PermittedChains $PermittedChains = null;
    /**
     * The ProhibitedChains
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\ProhibitedChains|null
     */
    protected ?\StructType\ProhibitedChains $ProhibitedChains = null;
    /**
     ...
     * - minOccurs: 0
     * - ref: SearchPriority
     * @var \StructType\SearchPriority|null
     */
    protected ?\StructType\SearchPriority $SearchPriority = null;
    /**
     * The HotelBedding
     * Meta information extracted from the WSDL
     * - maxOccurs: 4
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\Amenities|null
     */
    protected ?\StructType\Amenities $Amenities = null;
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\HotelTransportation|null
     */
    protected ?\StructType\HotelTransportation $HotelTransportation = null;
    /**
     * The BookingGuestInformation
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * - ref: BookingGuestInformation
     * @var \StructType\BookingGuestInformation|null
     */
    protected ?\StructType\BookingGuestInformation $BookingGuestInformation = null;
    /**
     * The NumberOfAdults
     * Meta information extracted from the WSDL
     ...
     * @param \StructType\PermittedChains $permittedChains
     * @param \StructType\ProhibitedChains $prohibitedChains
     ...
     * @param \StructType\HotelRating[] $hotelRating
     * @param \StructType\SearchPriority $searchPriority
     ...
     * @param \StructType\HotelTransportation $hotelTransportation
     * @param \StructType\BookingGuestInformation $bookingGuestInformation
     ...
     */
    public function __construct(?\StructType\PermittedChains $permittedChains = null, ?\StructType\ProhibitedChains $prohibitedChains = null, ?\StructType\PermittedProviders $permittedProviders = null, ?array $loyaltyCard = null, ?string $hotelName = null, ?array $corporateDiscountID = null, ?array $rateCategory = null, ?array $hotelRating = null, ?\StructType\SearchPriority $searchPriority = null, ?array $hotelBedding = null, ?\StructType\Amenities $amenities = null, ?\StructType\NumberOfChildren $numberOfChildren = null, ?\StructType\HotelTransportation $hotelTransportation = null, ?\StructType\BookingGuestInformation $bookingGuestInformation = null, ?int $numberOfAdults = null, ?int $numberOfRooms = null, ?bool $isRelaxed = null, ?string $preferredCurrency = null, ?bool $availableHotelsOnly = null, ?int $maxWait = null, ?bool $aggregateResults = false, ?bool $returnPropertyDescription = false, ?int $numOfRatePlans = null, ?bool $returnAmenities = false)
    {
        $this
     ...
     * @return \StructType\PermittedChains|null
     */
    public function getPermittedChains(): ?\StructType\PermittedChains
    {
     ...
     * @param \StructType\PermittedChains $permittedChains
     * @return \StructType\HotelSearchModifiers
     */
    public function setPermittedChains(?\StructType\PermittedChains $permittedChains = null): self
    {
     ...
     * @return \StructType\ProhibitedChains|null
     */
    public function getProhibitedChains(): ?\StructType\ProhibitedChains
    {
     ...
     * @return \StructType\HotelSearchModifiers
     */
    public function setProhibitedChains(?\StructType\ProhibitedChains $prohibitedChains = null): self
    {
    ...
    public static function validateLoyaltyCardForArrayConstraintsFromSetLoyaltyCard(?array $values = []): string
    {
        ...
        foreach ($values as $hotelSearchModifiersLoyaltyCardItem) {
            ...
            if (!$hotelSearchModifiersLoyaltyCardItem instanceof \StructType\LoyaltyCard) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The LoyaltyCard property can only contain items of type \StructType\LoyaltyCard, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \StructType\LoyaltyCard $item
     * @return \StructType\HotelSearchModifiers
     */
    public function addToLoyaltyCard(\StructType\LoyaltyCard $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\LoyaltyCard) {
            throw new InvalidArgumentException(sprintf('The LoyaltyCard property can only contain items of type \StructType\LoyaltyCard, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(4)
    ...
    public static function validateCorporateDiscountIDForArrayConstraintsFromSetCorporateDiscountID(?array $values = []): string
    {
        ...
        foreach ($values as $hotelSearchModifiersCorporateDiscountIDItem) {
            // validation for constraint: itemType
            if (!$hotelSearchModifiersCorporateDiscountIDItem instanceof \StructType\CorporateDiscountID) {
    ...
    public static function validateHotelRatingForArrayConstraintsFromSetHotelRating(?array $values = []): string
    {
        ...
        foreach ($values as $hotelSearchModifiersHotelRatingItem) {
            // validation for constraint: itemType
            if (!$hotelSearchModifiersHotelRatingItem instanceof \StructType\HotelRating) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The HotelRating property can only contain items of type \StructType\HotelRating, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \StructType\HotelRating $item
     * @return \StructType\HotelSearchModifiers
     */
    public function addToHotelRating(\StructType\HotelRating $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\HotelRating) {
            throw new InvalidArgumentException(sprintf('The HotelRating property can only contain items of type \StructType\HotelRating, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \StructType\SearchPriority|null
     */
    public function getSearchPriority(): ?\StructType\SearchPriority
    {
     ...
     * @return \StructType\HotelSearchModifiers
     */
    public function setSearchPriority(?\StructType\SearchPriority $searchPriority = null): self
    {
    ...
    public static function validateHotelBeddingForArrayConstraintsFromSetHotelBedding(?array $values = []): string
    {
        ...
        foreach ($values as $hotelSearchModifiersHotelBeddingItem) {
            // validation for constraint: itemType
            if (!$hotelSearchModifiersHotelBeddingItem instanceof \StructType\HotelBedding) {
     ...
     */
    public function getAmenities(): ?\StructType\Amenities
    {
     ...
     * @return \StructType\HotelSearchModifiers
     */
    public function setAmenities(?\StructType\Amenities $amenities = null): self
    {
     ...
     * @return \StructType\HotelTransportation|null
     */
    public function getHotelTransportation(): ?\StructType\HotelTransportation
    {
     ...
     * @return \StructType\HotelSearchModifiers
     */
    public function setHotelTransportation(?\StructType\HotelTransportation $hotelTransportation = null): self
    {
     ...
     * @return \StructType\BookingGuestInformation|null
     */
    public function getBookingGuestInformation(): ?\StructType\BookingGuestInformation
    {
     ...
     * @return \StructType\HotelSearchModifiers
     */
    public function setBookingGuestInformation(?\StructType\BookingGuestInformation $bookingGuestInformation = null): self
    {
