...
class TypeErrorInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: Auxdata
     * @var \StructType\Auxdata|null
     */
    protected ?\StructType\Auxdata $Auxdata = null;
    /**
     * The StackTrace
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \StructType\Auxdata $auxdata
     * @param string $stackTrace
     */
    public function __construct(?string $code = null, ?string $service = null, ?string $type = null, ?string $description = null, ?string $transactionId = null, ?string $traceId = null, ?string $commandHistory = null, ?\StructType\Auxdata $auxdata = null, ?string $stackTrace = null)
    {
        $this
            ->setCode($code)
            ->setService($service)
     ...
     * Set Code value
     * @param string $code
     * @return \StructType\TypeErrorInfo
     */
    ...
    /**
     * Get Auxdata value
     * @return \StructType\Auxdata|null
     */
    public function getAuxdata(): ?\StructType\Auxdata
    {
        return $this->Auxdata;
    }
    /**
     ...
     * @return \StructType\TypeErrorInfo
     */
    public function setAuxdata(?\StructType\Auxdata $auxdata = null): self
    {
