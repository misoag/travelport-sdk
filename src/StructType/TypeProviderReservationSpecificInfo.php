...
class TypeProviderReservationSpecificInfo extends AbstractStructBase
{
     ...
     * @var \StructType\ProviderReservationInfoRef|null
     */
    protected ?\StructType\ProviderReservationInfoRef $ProviderReservationInfoRef = null;
    /**
     ...
     * @param \StructType\OperatedBy[] $operatedBy
     ...
     */
    public function __construct(?array $operatedBy = null, ?\StructType\ProviderReservationInfoRef $providerReservationInfoRef = null, ?bool $providerReservationLevel = null, ?bool $reservationLevel = null)
    {
        $this
    ...
    /**
     * This method is responsible for validating the values passed to the setOperatedBy method
     ...
     */
    public static function validateOperatedByForArrayConstraintsFromSetOperatedBy(?array $values = []): string
    {
        if (!is_array($values)) {
            return '';
        }
        ...
        foreach ($values as $typeProviderReservationSpecificInfoOperatedByItem) {
            ...
            if (!$typeProviderReservationSpecificInfoOperatedByItem instanceof \StructType\OperatedBy) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The OperatedBy property can only contain items of type \StructType\OperatedBy, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @param \StructType\OperatedBy[] $operatedBy
     * @return \StructType\TypeProviderReservationSpecificInfo
     */
    public function setOperatedBy(?array $operatedBy = null): self
    {
        // validation for constraint: array
        if ('' !== ($operatedByArrayErrorMessage = self::validateOperatedByForArrayConstraintsFromSetOperatedBy($operatedBy))) {
     ...
     * @throws InvalidArgumentException
     * @param \StructType\OperatedBy $item
     * @return \StructType\TypeProviderReservationSpecificInfo
     */
    public function addToOperatedBy(\StructType\OperatedBy $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\OperatedBy) {
            throw new InvalidArgumentException(sprintf('The OperatedBy property can only contain items of type \StructType\OperatedBy, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \StructType\ProviderReservationInfoRef|null
     */
    public function getProviderReservationInfoRef(): ?\StructType\ProviderReservationInfoRef
    {
     ...
     * @return \StructType\TypeProviderReservationSpecificInfo
     */
    public function setProviderReservationInfoRef(?\StructType\ProviderReservationInfoRef $providerReservationInfoRef = null): self
    {
