...
class HotelDetailsModifiers extends AbstractStructBase
{
     ...
     * @param int $maxWait
     */
    public function __construct(?\StructType\PermittedProviders $permittedProviders = null, ?array $loyaltyCard = null, ?array $corporateDiscountID = null, ?\StructType\HotelStay $hotelStay = null, ?\StructType\NumberOfChildren $numberOfChildren = null, ?array $hotelBedding = null, ?array $rateCategory = null, ?\StructType\BookingGuestInformation $bookingGuestInformation = null, ?int $numberOfAdults = null, ?string $rateRuleDetail = null, ?int $numberOfRooms = 1, ?string $key = null, ?string $preferredCurrency = null, ?int $totalOccupants = null, ?bool $processAllNegoRatesInd = false, ?int $maxWait = null)
    {
        $this
     ...
     * @param \StructType\PermittedProviders $permittedProviders
     * @return \StructType\HotelDetailsModifiers
     */
    ...
    public static function validateLoyaltyCardForArrayConstraintsFromSetLoyaltyCard(?array $values = []): string
    {
        ...
        foreach ($values as $hotelDetailsModifiersLoyaltyCardItem) {
            ...
            if (!$hotelDetailsModifiersLoyaltyCardItem instanceof \StructType\LoyaltyCard) {
    ...
    public static function validateCorporateDiscountIDForArrayConstraintsFromSetCorporateDiscountID(?array $values = []): string
    {
        ...
        foreach ($values as $hotelDetailsModifiersCorporateDiscountIDItem) {
            // validation for constraint: itemType
            if (!$hotelDetailsModifiersCorporateDiscountIDItem instanceof \StructType\CorporateDiscountID) {
    ...
    public static function validateHotelBeddingForArrayConstraintsFromSetHotelBedding(?array $values = []): string
    {
        ...
        foreach ($values as $hotelDetailsModifiersHotelBeddingItem) {
            // validation for constraint: itemType
            if (!$hotelDetailsModifiersHotelBeddingItem instanceof \StructType\HotelBedding) {
     ...
     * @uses \EnumType\TypeRateRuleDetail::valueIsValid()
     * @uses \EnumType\TypeRateRuleDetail::getValidValues()
     * @throws InvalidArgumentException
     * @param string $rateRuleDetail
     * @return \StructType\HotelDetailsModifiers
     */
    public function setRateRuleDetail(?string $rateRuleDetail = null): self
    {
        ...
        if (!\EnumType\TypeRateRuleDetail::valueIsValid($rateRuleDetail)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeRateRuleDetail', is_array($rateRuleDetail) ? implode(', ', $rateRuleDetail) : var_export($rateRuleDetail, true), implode(', ', \EnumType\TypeRateRuleDetail::getValidValues())), __LINE__);
        }
