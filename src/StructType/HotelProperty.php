...
class HotelProperty extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\TypeUnstructuredAddress|null
     */
    protected ?\StructType\TypeUnstructuredAddress $PropertyAddress = null;
    /**
     * The PhoneNumber
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     ...
     * @var \StructType\MarketingMessage|null
     */
    protected ?\StructType\MarketingMessage $MarketingMessage = null;
    /**
     * The HotelLocation
     * Meta information extracted from the WSDL
     ...
     * @param \StructType\TypeUnstructuredAddress $propertyAddress
     ...
     * @param \StructType\MarketingMessage $marketingMessage
     ...
     */
    public function __construct(string $hotelChain, string $hotelCode, ?\StructType\TypeUnstructuredAddress $propertyAddress = null, ?array $phoneNumber = null, ?\StructType\CoordinateLocation $coordinateLocation = null, ?\StructType\Distance $distance = null, ?array $hotelRating = null, ?\StructType\Amenities $amenities = null, ?\StructType\MarketingMessage $marketingMessage = null, ?string $hotelLocation = null, ?string $name = null, ?string $vendorLocationKey = null, ?int $hotelTransportation = null, ?string $reserveRequirement = null, ?string $participationLevel = null, ?string $availability = null, ?string $key = null, ?bool $preferredOption = null, ?bool $moreRates = null, ?string $moreRatesToken = null, ?string $netTransCommissionInd = null, ?int $numOfRatePlans = null)
    {
        $this
     ...
     * @return \StructType\TypeUnstructuredAddress|null
     */
    public function getPropertyAddress(): ?\StructType\TypeUnstructuredAddress
    {
     ...
     * @return \StructType\HotelProperty
     */
    public function setPropertyAddress(?\StructType\TypeUnstructuredAddress $propertyAddress = null): self
    {
    ...
    public static function validatePhoneNumberForArrayConstraintsFromSetPhoneNumber(?array $values = []): string
    {
        ...
        foreach ($values as $hotelPropertyPhoneNumberItem) {
            ...
            if (!$hotelPropertyPhoneNumberItem instanceof \StructType\PhoneNumber) {
    ...
    public static function validateHotelRatingForArrayConstraintsFromSetHotelRating(?array $values = []): string
    {
        ...
        foreach ($values as $hotelPropertyHotelRatingItem) {
            // validation for constraint: itemType
            if (!$hotelPropertyHotelRatingItem instanceof \StructType\HotelRating) {
     ...
     * @return \StructType\MarketingMessage|null
     */
    public function getMarketingMessage(): ?\StructType\MarketingMessage
    {
     ...
     * @return \StructType\HotelProperty
     */
    public function setMarketingMessage(?\StructType\MarketingMessage $marketingMessage = null): self
    {
     ...
     * @uses \EnumType\TypeReserveRequirement::valueIsValid()
     * @uses \EnumType\TypeReserveRequirement::getValidValues()
     * @throws InvalidArgumentException
     * @param string $reserveRequirement
     * @return \StructType\HotelProperty
     */
    public function setReserveRequirement(?string $reserveRequirement = null): self
    {
        ...
        if (!\EnumType\TypeReserveRequirement::valueIsValid($reserveRequirement)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeReserveRequirement', is_array($reserveRequirement) ? implode(', ', $reserveRequirement) : var_export($reserveRequirement, true), implode(', ', \EnumType\TypeReserveRequirement::getValidValues())), __LINE__);
        }
     ...
     * @uses \EnumType\TypeHotelAvailability::valueIsValid()
     * @uses \EnumType\TypeHotelAvailability::getValidValues()
     * @throws InvalidArgumentException
     * @param string $availability
     * @return \StructType\HotelProperty
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\TypeHotelAvailability::valueIsValid($availability)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeHotelAvailability', is_array($availability) ? implode(', ', $availability) : var_export($availability, true), implode(', ', \EnumType\TypeHotelAvailability::getValidValues())), __LINE__);
        }
     ...
     * @uses \EnumType\TypeNetTransCommission::valueIsValid()
     * @uses \EnumType\TypeNetTransCommission::getValidValues()
     * @throws InvalidArgumentException
     * @param string $netTransCommissionInd
     * @return \StructType\HotelProperty
     */
    ...
    {
        // validation for constraint: enumeration
        if (!\EnumType\TypeNetTransCommission::valueIsValid($netTransCommissionInd)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeNetTransCommission', is_array($netTransCommissionInd) ? implode(', ', $netTransCommissionInd) : var_export($netTransCommissionInd, true), implode(', ', \EnumType\TypeNetTransCommission::getValidValues())), __LINE__);
        }
