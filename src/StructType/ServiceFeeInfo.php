...
class ServiceFeeInfo extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * - ref: FormOfPayment
     * @var \StructType\FormOfPayment|null
     */
    protected ?\StructType\FormOfPayment $FormOfPayment = null;
    /**
     ...
     * @var \StructType\ServiceFeeTaxInfo[]
     */
     ...
     * - minOccurs: 0
     * - ref: CreditCardAuth
     * @var \StructType\CreditCardAuth|null
     */
    protected ?\StructType\CreditCardAuth $CreditCardAuth = null;
    /**
     * The Payment
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     ...
     * @param \StructType\ServiceFeeTaxInfo[] $serviceFeeTaxInfo
     * @param \StructType\CreditCardAuth $creditCardAuth
     ...
     */
    public function __construct(?\StructType\FormOfPayment $formOfPayment = null, ?array $serviceFeeTaxInfo = null, ?\StructType\CreditCardAuth $creditCardAuth = null, ?\StructType\Payment $payment = null, ?string $status = null, ?string $description = null, ?string $key = null, ?string $confirmation = null, ?string $ticketNumber = null, ?string $bookingTravelerRef = null, ?string $providerReservationInfoRef = null, ?string $passiveProviderReservationInfoRef = null, ?string $totalAmount = null, ?string $baseAmount = null, ?string $taxes = null, ?string $bookingTravelerName = null, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
     ...
     * @return \StructType\FormOfPayment|null
     */
    public function getFormOfPayment(): ?\StructType\FormOfPayment
    {
     ...
     * @param \StructType\FormOfPayment $formOfPayment
     * @return \StructType\ServiceFeeInfo
     */
    public function setFormOfPayment(?\StructType\FormOfPayment $formOfPayment = null): self
    {
     ...
     * @return \StructType\ServiceFeeTaxInfo[]
     */
    ...
    public static function validateServiceFeeTaxInfoForArrayConstraintsFromSetServiceFeeTaxInfo(?array $values = []): string
    {
        ...
        foreach ($values as $serviceFeeInfoServiceFeeTaxInfoItem) {
            ...
            if (!$serviceFeeInfoServiceFeeTaxInfoItem instanceof \StructType\ServiceFeeTaxInfo) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ServiceFeeTaxInfo property can only contain items of type \StructType\ServiceFeeTaxInfo, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \StructType\ServiceFeeTaxInfo $item
     * @return \StructType\ServiceFeeInfo
     */
    public function addToServiceFeeTaxInfo(\StructType\ServiceFeeTaxInfo $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\ServiceFeeTaxInfo) {
            throw new InvalidArgumentException(sprintf('The ServiceFeeTaxInfo property can only contain items of type \StructType\ServiceFeeTaxInfo, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @return \StructType\CreditCardAuth|null
     */
    public function getCreditCardAuth(): ?\StructType\CreditCardAuth
    {
     ...
     * @return \StructType\ServiceFeeInfo
     */
    public function setCreditCardAuth(?\StructType\CreditCardAuth $creditCardAuth = null): self
    {
    ...
    /**
     * Set Status value
     * @uses \EnumType\TypeStatus::valueIsValid()
     * @uses \EnumType\TypeStatus::getValidValues()
     * @throws InvalidArgumentException
     * @param string $status
     * @return \StructType\ServiceFeeInfo
     */
    public function setStatus(?string $status = null): self
    {
        ...
        if (!\EnumType\TypeStatus::valueIsValid($status)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeStatus', is_array($status) ? implode(', ', $status) : var_export($status, true), implode(', ', \EnumType\TypeStatus::getValidValues())), __LINE__);
        }
        $this->Status = $status;
