...
class Guarantee extends AbstractStructBase
{
     ...
     * @var \StructType\OtherGuaranteeInfo|null
     */
    protected ?\StructType\OtherGuaranteeInfo $OtherGuaranteeInfo = null;
    /**
     * The Key
     * Meta information extracted from the WSDL
     ...
     * @param \StructType\OtherGuaranteeInfo $otherGuaranteeInfo
     * @param string $key
     ...
     */
    public function __construct(string $type, ?\StructType\CreditCard $creditCard = null, ?\StructType\OtherGuaranteeInfo $otherGuaranteeInfo = null, ?string $key = null, ?string $reuseFOP = null, ?string $externalReference = null, ?bool $reusable = false, ?string $elStat = null, ?bool $keyOverride = null)
    {
        $this
            ->setType($type)
     ...
     * @return \StructType\OtherGuaranteeInfo|null
     */
    public function getOtherGuaranteeInfo(): ?\StructType\OtherGuaranteeInfo
    {
     ...
     * @return \StructType\Guarantee
     */
    public function setOtherGuaranteeInfo(?\StructType\OtherGuaranteeInfo $otherGuaranteeInfo = null): self
    {
        // validation for constraint: choice(CreditCard, OtherGuaranteeInfo)
