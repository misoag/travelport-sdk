...
class HotelRulesReq extends BaseReq
{
     ...
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * @var \StructType\HotelRulesLookup|null
     */
    protected ?\StructType\HotelRulesLookup $HotelRulesLookup = null;
    /**
     ...
     * @param \StructType\HotelRulesLookup $hotelRulesLookup
     */
    public function __construct(?string $hotelReservationLocatorCode = null, ?\StructType\HotelRulesLookup $hotelRulesLookup = null)
    {
        $this
     ...
     * @param string $hotelReservationLocatorCode
     * @return \StructType\HotelRulesReq
     */
     ...
     * @return \StructType\HotelRulesLookup|null
     */
    public function getHotelRulesLookup(): ?\StructType\HotelRulesLookup
    {
     ...
     * @return \StructType\HotelRulesReq
     */
    public function setHotelRulesLookup(?\StructType\HotelRulesLookup $hotelRulesLookup = null): self
    {
        // validation for constraint: choice(HotelReservationLocatorCode, HotelRulesLookup)
