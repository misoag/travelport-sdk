...
class BaseCoreReq extends AbstractStructBase
{
     ...
     * @var \StructType\BillingPointOfSaleInfo|null
     */
    protected ?\StructType\BillingPointOfSaleInfo $BillingPointOfSaleInfo = null;
    /**
     * The AgentIDOverride
     * Meta information extracted from the WSDL
     * - maxOccurs: 999
     * - minOccurs: 0
     * - ref: AgentIDOverride
     * @var \StructType\AgentIDOverride[]
     */
     ...
     * @param \StructType\BillingPointOfSaleInfo $billingPointOfSaleInfo
     * @param \StructType\AgentIDOverride[] $agentIDOverride
     ...
     */
    public function __construct(?\StructType\BillingPointOfSaleInfo $billingPointOfSaleInfo = null, ?array $agentIDOverride = null, ?string $terminalSessionInfo = null, ?string $traceId = null, ?string $tokenId = null, ?string $authorizedBy = null, ?string $targetBranch = null, ?string $overrideLogging = null, ?string $languageCode = null)
    {
        $this
     ...
     * @return \StructType\BillingPointOfSaleInfo|null
     */
    public function getBillingPointOfSaleInfo(): ?\StructType\BillingPointOfSaleInfo
    {
     ...
     * @param \StructType\BillingPointOfSaleInfo $billingPointOfSaleInfo
     * @return \StructType\BaseCoreReq
     */
    public function setBillingPointOfSaleInfo(?\StructType\BillingPointOfSaleInfo $billingPointOfSaleInfo = null): self
    {
     ...
     * @return \StructType\AgentIDOverride[]
     */
    ...
    public static function validateAgentIDOverrideForArrayConstraintsFromSetAgentIDOverride(?array $values = []): string
    {
        ...
        foreach ($values as $baseCoreReqAgentIDOverrideItem) {
            ...
            if (!$baseCoreReqAgentIDOverrideItem instanceof \StructType\AgentIDOverride) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AgentIDOverride property can only contain items of type \StructType\AgentIDOverride, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \StructType\AgentIDOverride $item
     * @return \StructType\BaseCoreReq
     */
    public function addToAgentIDOverride(\StructType\AgentIDOverride $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\AgentIDOverride) {
            throw new InvalidArgumentException(sprintf('The AgentIDOverride property can only contain items of type \StructType\AgentIDOverride, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: maxOccurs(999)
     ...
     * @uses \EnumType\TypeLoggingLevel::valueIsValid()
     * @uses \EnumType\TypeLoggingLevel::getValidValues()
     * @throws InvalidArgumentException
     * @param string $overrideLogging
     * @return \StructType\BaseCoreReq
     */
    public function setOverrideLogging(?string $overrideLogging = null): self
    {
        ...
        if (!\EnumType\TypeLoggingLevel::valueIsValid($overrideLogging)) {
            throw new InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\TypeLoggingLevel', is_array($overrideLogging) ? implode(', ', $overrideLogging) : var_export($overrideLogging, true), implode(', ', \EnumType\TypeLoggingLevel::getValidValues())), __LINE__);
        }
